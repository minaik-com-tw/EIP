<%@ Page Title="" Language="C#" MasterPageFile="~/_site/layout/ie_Edge.master" AutoEventWireup="true" CodeFile="LeicaEdit.aspx.cs" Inherits="Leica.LeicaEdit" StylesheetTheme="Edge" Culture="Auto" UICulture="Auto" Debug="true" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="leica" style="margin: 10px; width: 1200px">
        ...
        <div style="text-align: left;margin:5px 0px 5px 0">
        ...
        <div id="approve" style="border-spacing:4px; margin:5px 0px 5px 0px" >
            
            <div class="tr"  >
                <div class="th" style="width:40%"   ><%=getStr("supervisor") %></div>
                <div class="td" style="border:0" >
                    <asp:TextBox ID="txt_supervisor" runat="server" Text="" CssClass="Muser" ReadOnly="true"></asp:TextBox>
                </div> 
            </div>
            <div class="tr"  >
                <div class="th" style="width:40%" ><%=getStr("manager") %></div>
                <div class="td" style="border:0" >
                    <asp:TextBox ID="txt_manager" runat="server" Text="" CssClass="Muser" ReadOnly="true"></asp:TextBox>
                </div>

            </div>
        </div>
        <div>
            <div class="tb1" style="border:0;margin:5px 0 5px 0 " >
                <div class="tr" style="text-align: left">
                    <div class="td" style="border:0" >
                        ...
                        <SmoothEnterpriseWebControlFlowwork:SendRequestButton ID="Btn_SendRequest" runat="server" Text="Submittal" Font-Size="9" OnClick="Btn_SendRequest_Click" Flow="<%# FlowClient1 %>">
                            <Gradient GradientType="Bottom" GradientBegin="" GradientEnd=""></Gradient>
                        </SmoothEnterpriseWebControlFlowwork:SendRequestButton>

                        <SmoothEnterpriseWebControlFlowwork:RemindReviewerButton ID="Btn_RemindReviewer" runat="server" Text="RemindReviewer" Font-Size="9" OnClick="Btn_RemindReviewer_Click" Flow="<%# FlowClient1 %>">
                            <Gradient GradientBegin="" GradientEnd="" GradientType="Bottom" />
                        </SmoothEnterpriseWebControlFlowwork:RemindReviewerButton>

                        <SmoothEnterpriseWebControlFlowwork:StopRequestButton ID="Btn_Stop" runat="server" Text="Stop" Flow="<%# FlowClient1 %>" Font-Size="9" OnClick="Btn_Stop_Click">
                            <Gradient GradientType="Bottom" GradientBegin="" GradientEnd=""></Gradient>
                        </SmoothEnterpriseWebControlFlowwork:StopRequestButton>

                        <SmoothEnterpriseWebControl:InputButton ID="Btn_fail" runat="server" Text="Fail" Font-Size="9" OnClick="Btn_fail_Click">
