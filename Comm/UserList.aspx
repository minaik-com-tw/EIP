<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UserList.aspx.cs" Inherits="Comm_UserList" %>
        ...
        <div style="width: 600px">
            <div>
                <div class="table">
                    ...
                    <div>
                        ...
                        <div class="td">
                            <asp:TextBox ID="txt_name" runat="server" Width="100px" OnTextChanged="txt_name_TextChanged" ></asp:TextBox>
            ...
            <div>
                <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="id,logonid,name"
                    OnPageIndexChanging="GridView1_PageIndexChanging" ForeColor="#333333" GridLines="None" Width="100%">
                    <RowStyle BackColor="#F7F6F3" ForeColor="#333333" Font-Size="12px" />
                    <Columns>
                        <asp:TemplateField HeaderText="">
                            <ItemTemplate>
                                <input type="button" id="getUser" value="選擇" userid="<%#Eval("id").ToString().Trim()%>" username="<%#Eval("name").ToString().Trim() %>"  logonid="<%#Eval("logonid").ToString().Trim() %>" onclick="window.parent.getUser(this);
" />
                            </ItemTemplate>
                            <HeaderTemplate>
                                選擇 
