<%@ page language="C#" masterpagefile="~/_site/layout/Template.master" autoeventwireup="true" inherits="SmoothEnterprise.Web.Application.Calendar.CalendarCategoryEdit, App_Web_calendarcategoryedit.aspx.cdcab7d2" theme="Default" culture="auto" uiculture="auto" meta:resourcekey="PageResource1" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">    
	...
	<script>
		function chg_style(stylevalue)
		{
			...
			stylevalue=stylevalue.replace(re,",");	  
		...
		<tr>
			<td vAlign="top">
				<table>
					...
					<tr>
						<td style="HEIGHT: 26px"><SmoothEnterpriseWebControl:inputtext id="FIELD_category" tabIndex="101" runat="server" Width="280px" BackColor="#F0F0F0"
								CssClass="Normal" Required="True" MaxLength="50" ErrorMessage="請輸入「類別名稱」!!" ButtonClick="True" ButtonIconUrl="" DateSeparator="Slash" DateType="YYYYMMDD" FocusColor="" FormatType="None" HiddenMode="False" HTMLMode="Advance" IsValid="True" meta:resourcekey="FIELD_categoryResource1" OnClickMore="" Personalize="False" ><Gradient GradientType="Top" GradientBegin="" GradientEnd=""></Gradient>
					...
					<tr>
						<td><!--
							...
							<table cellpadding="0" cellspacing="0">
								<tr>
									<td>
										<SmoothEnterpriseWebControl:InputSelect id="InputSelect_Style" runat="server"  Required="True" ItemAll-Value="%"
											backcolor="#F0F0F0" cssClass="Normal" onchange="chg_style(this.value);" ItemNoneDisplayed="True" ButtonClick="True" ButtonIconUrl="/lib/img/icon-downarrow.gif" Editable="False" ErrorMessage="" FadeSpeed="NoFade" IsValid="True" ItemAll-GroupText="" ItemAll-IconUrl="" ItemAll-RowHeight="18" ItemAll-Selected="False" ItemAll-Text="%" ItemNone-GroupText="" ItemNone-IconUrl="" ItemNone-RowHeight="18" ItemNone-Selected="False" ItemNone-Text="" ListPosition="Vertical" meta:resourcekey="InputSelect_StyleResource1" Mode="Single" TextBoxStyle="ThreeDStyle" Value="">
											<Items>
												...
												<SmoothEnterpriseWebControl:SelectItem BorderStyle="Solid" BorderWidth="1px" Gradient-GradientEnd="204, 120, 120, 255"
													...
													BorderColor="#8989FF" IconUrl="" Text="Style G" GroupText="" ID="selectItem5g" IsValid="True" CookieID=""
													ErrorMessage="" style="FILTER:progid:DXImageTransform.Microsoft.gradient(gradienttype=0,startcolorstr=#55eeeeff, endcolorstr=#557878ff);background-color:#dedeff;border-color:#8989ff;border-width:1px;border-style:Solid;" meta:resourcekey="selectItem5gResource1" runat="server"></SmoothEnterpriseWebControl:SelectItem>
											</Items>
	...
	<script>
		var selectobj = document.getElementById("InputSelect_Style");
		if (selectobj.value!="") chg_style(selectobj.value);
	</script>
</asp:Content>
