<%@ page language="C#" masterpagefile="~/_site/layout/Template.master" autoeventwireup="true" inherits="SmoothEnterprise.Web.Application.Calendar.CalendarSourceAdd, App_Web_calendarsourceadd.aspx.cdcab7d2" theme="Default" culture="auto" uiculture="auto" meta:resourcekey="PageResource1" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">    
	...
	<table Class="Normal" border="0">
		<tr>
			<td vAlign="top">
				<table> <!--	<tr><td id="LABEL_id" runat="server" class=normalbold >Id</td></tr><tr><td><SmoothEnterpriseWebControl:InputText id="FIELD_id" runat="server"  BackColor="#F0F0F0" CssClass="Normal" ErrorMessage="請輸入「Id」!!" tabIndex="100" MaxLength="0"><Gradient GradientType="Top" GradientBegin="" GradientEnd=""></Gradient></SmoothEnterpriseWebControl:inputtext></td></tr>-->
					<tr>
						<td Class="NormalBold">
						...
						<td>
							<table cellSpacing="0" cellPadding="0">
								...
								<tr>
									...
									<td><SmoothEnterpriseWebControl:inputtext id="FIELD_fielddata" tabIndex="106" runat="server" Width="140px" BackColor="#F0F0F0"
					...
					<tr>
						<td Class="NormalBold">
						    <asp:Label ID="LABEL_criteria" runat="server" Text="限制條件 (:SID is reserved for filtering keyword)" meta:resourcekey="LABEL_criteriaResource1"></asp:Label></td>
					</tr>
					<tr>
					...
					<tr>
						<td><SmoothEnterpriseWebControl:inputselect id="FIELD_displaystyle" runat="server"  cssClass="Normal" backcolor="#F0F0F0"
					...
					<tr>
						<td Class="NormalBold">
						    <asp:Label ID="LABEL_linkurl" runat="server" Text="連結網址 (:ID is the keyword)" meta:resourcekey="LABEL_linkurlResource1"></asp:Label></td>
					</tr>
					<tr>
					...
					<tr>
						<td style="HEIGHT: 26px"><SmoothEnterpriseWebControlEnterprise:SelectCode id="FIELD_cstype" runat="server" cssClass="Normal" backcolor="White" ItemNoneDisplayed="True"
					...
					<tr>
						<td Class="NormalBold" id="LABEL_isdefault" runat="server"></td>
					</tr>
					<tr>
						<td style="HEIGHT: 17px"><SmoothEnterpriseWebControl:CHECKBOXLIST id="FIELD_isdefault" runat="server" cssClass="Normal" Font-Bold="True" meta:resourcekey="FIELD_isdefaultResource1" Value="Y" Width="300px">
		...
		<tr>
			<td><SmoothEnterpriseWebControl:inputbutton id="BUTTON_save" runat="server" Font-Names="Arial" Font-Size="12px" BorderColor="#606060"
				...
				<SmoothEnterpriseWebControl:inputbutton id="BUTTON_savenext" runat="server" Font-Names="Arial" Font-Size="12px" BorderColor="#606060"
					BorderWidth="1px" BorderStyle="Solid" BackColor="#C8C8C8" CssClass="NormalBold" Gradient-GradientType="Bottom"
					Font-Bold="True" Text="儲存後繼續操作" OnClick="BUTTON_save_Click" meta:resourcekey="BUTTON_savenextResource1" RunAtCient="False">
                    <Gradient GradientBegin="" GradientEnd="" GradientType="Bottom" />
                </SmoothEnterpriseWebControl:inputbutton>&nbsp;
