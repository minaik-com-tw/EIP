		...
		<tr>
			<td>
				...
				<SmoothEnterpriseWebControl:InputButton id="BUTTON_delete" runat="server" BackColor="#C8C8C8" cssClass="NormalBold" Font-Bold="True"
					Font-Size="12px" Font-Names="Arial" BorderStyle="Solid" BorderWidth="1px" BorderColor="#606060" Text="刪除" Width="80px" OnClick="BUTTON_delete_Click" meta:resourcekey="BUTTON_deleteResource1" RunAtCient="False">
