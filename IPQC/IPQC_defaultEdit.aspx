<%@ Page Language="C#" MasterPageFile="~/_site/layout/Template.master" AutoEventWireup="true" CodeFile="IPQC_defaultEdit.aspx.cs" Inherits="IPQC.IPQC_defaultEdit" StylesheetTheme="Default" Culture="Auto" UICulture="Auto" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <SmoothEnterpriseWebControlEnterprise:Descriptor ID="ContentDescriptor" runat="server" Details="The desciption for this program"
        Caption="IPQC_default Edit Page" Width="100%" CssClass="Normal" Gradient="None" Height="40%" PaddingSpace="5px">
            ...
            <td valign="top">
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            <SmoothEnterpriseWebControl:InputText ID="FIELD_SEQ" runat="server" BackColor="#F0F0F0" CssClass="Normal" ErrorMessage="Please Input「Parameter」!!" MaxLength="50">
                                <Gradient GradientBegin="" GradientEnd="" GradientType="Top" />
    ...
    <table border="0" class="Normal">
        <tr>
            <td>
				...
				<SmoothEnterpriseWebControl:InputButton ID="BUTTON_delete" runat="server" Text="刪除" Width="80px" BackColor="#C8C8C8" BorderColor="#606060" BorderStyle="Solid" BorderWidth="1px" CssClass="NormalBold" Font-Bold="True" Font-Names="Arial" Font-Size="12px" OnClick="BUTTON_delete_Click">
                    <Gradient GradientBegin="136, 136, 136" GradientEnd="White" GradientType="Bottom" />
                </SmoothEnterpriseWebControl:InputButton>
            </td>
        </tr>
