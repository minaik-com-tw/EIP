<%@ Page Language="C#" MasterPageFile="~/_site/layout/Template.master" AutoEventWireup="true" CodeFile="IPQCEdit.aspx.cs" Inherits="IPQC.IPQCEdit" StylesheetTheme="Default" Culture="Auto" UICulture="Auto" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <header>
        <SmoothEnterpriseWebControlEnterprise:Descriptor ID="ContentDescriptor" runat="server" Details="The desciption for this program"
            Caption="IPQC Edit Page" Width="100%" CssClass="Normal" Gradient="None" Height="40%" PaddingSpace="5px">
        ...
        <script type="text/javascript" language="javascript">
            $(function () {
                ...
                $("#ctl00_ContentPlaceHolder1_FIELD_Description").change(function () { Description(this); })
                $("#ctl00_ContentPlaceHolder1_FIELD_Dimension").change(function () { Description(this) })
                $("#ctl00_ContentPlaceHolder1_FIELD_Appearance").change(function () { Description(this) })
                $("#ctl00_ContentPlaceHolder1_FIELD_Cleanlines").change(function () { Description(this) })
                $("#ctl00_ContentPlaceHolder1_FIELD_Reliability").change(function(){Description(this)})
                  
            });
            function check() {
                var result = false;
                if (checkFIELDsheetNO("#<%=this.FIELD_sheet_NO.ClientID%>") &&
                ...
                checkFIELD_Dimension("#<%=this.FIELD_Dimension.ClientID%>") &&
                checkFIELD_Appearance("#<%=this.FIELD_Appearance.ClientID%>") &&
                checkFIELD_Cleanlines("#<%=this.FIELD_Cleanlines.ClientID%>") &&
                checkFIELD_Reliability("#<%=this.FIELD_Reliability.ClientID%>")&&--%>

                    checkFIELD_Judgement("#<%=this.FIELD_Judgement.ClientID%>") &&
                    checkFIELD_QA_Judgement_commit("#<%=this.FIELD_QA_Judgement_commit.ClientID%>")) //&&checkFIELD_QA_Judgement_commit("#<%=this.FIELD_Judgement.ClientID%>"))*/
                    result = true;
                return result;
            }
            function addfile(id) {
            ...
            function checkFIELD_Reliability(field_id) {
                var field = $(field_id);
                if ($.trim(field.val()) == "") {
                    alert("請寫入可靠度敘述");
                    return false;
            ...
            function checkFIELD_Cleanlines(field_id) {
                var field = $(field_id);
                if ($.trim(field.val()) == "") {
                    alert("請寫入清潔度敘述");
                    return false;
            ...
            function checkFIELD_Appearance(field_id) {
                var field = $(field_id);
                if ($.trim(field.val()) == "") {
                    alert("請寫入尺寸敘述");
                    return false;
            ...
            function checkFIELD_Dimension(field_id) {
                var field = $(field_id);
                if ($.trim(field.val()) == "") {
                    alert("請寫入外觀敘述");
                    return false;
            ...
            <div class="div_table all">
                <div class="div_tr">
                    ...
                    <div class="div_td col ">
                        ...
                        <asp:CheckBoxList ID="check_Dimension_file" runat="server" Font-Size="X-Small" RepeatColumns="3"></asp:CheckBoxList>
                    </div>
                </div>
                <div class="div_tr">
                    ...
                    <div class="div_td col ">
                        ...
                        <SmoothEnterpriseWebControl:InputText ID="FIELD_Appearance" runat="server" BackColor="#F0F0F0" Width="95%" CssClass="Normal" ErrorMessage="Please Input「Appearance」!!" MaxLength="500" TextMode="MultiLine" Height="50px" Style="text-align: left">
                    ...
                    <div class="div_td col ">
                        ...
                        <asp:CheckBoxList ID="check_Appearance_file" runat="server" Font-Size="X-Small" RepeatColumns="3"></asp:CheckBoxList>
                    </div>
                </div>
                <div class="div_tr">
                    ...
                    <div class="div_td col ">
                        ...
                        <SmoothEnterpriseWebControl:InputText ID="FIELD_Cleanlines" runat="server" BackColor="#F0F0F0" CssClass="Normal" ErrorMessage="Please Input「Cleanlines」!!" MaxLength="500" TextMode="MultiLine" Height="50px" Width="95%" Style="text-align: left">
                            <Gradient GradientBegin="" GradientEnd="" GradientType="Top" />
                            <ErrorStyle BorderStyle="NotSet" CssClass="" />
                        </SmoothEnterpriseWebControl:InputText>
                    ...
                    <div class="div_td col ">
                        ...
                        <asp:CheckBoxList ID="check_Cleanlines_file" runat="server" Font-Size="X-Small" RepeatColumns="3"></asp:CheckBoxList>
                ...
                <div class="div_tr">
                    ...
                    <div class="div_td col ">
                        ...
                        <SmoothEnterpriseWebControl:InputText ID="FIELD_Reliability" runat="server" BackColor="#F0F0F0"
                            CssClass="Normal" ErrorMessage="Please Input「Reliability」!!" MaxLength="500" TextMode="MultiLine"
                    ...
                    <div class="div_td col">
                        ...
                        <asp:CheckBoxList ID="check_Reliability_file" runat="server" Font-Size="X-Small" RepeatColumns="3"></asp:CheckBoxList>
                ...
                <tr>
                    <td>
                        ...
                        <SmoothEnterpriseWebControlFlowwork:FlowFeedbackViewer ID="FlowFeedbackViewer1" runat="server"
                            BorderColor="Silver" BorderStyle="Solid" BorderWidth="1px" CssClass="Normal" OnOnLoadHistory="FlowFeedbackViewer1_OnLoadHistory"
                            Font-Size="11px">
                            <Columns>
                                ...
                                <SmoothEnterpriseWebControlFlowwork:FlowFeedbackColumn FieldName="ReviewerPhoto"></SmoothEnterpriseWebControlFlowwork:FlowFeedbackColumn>
                                ...
                                <SmoothEnterpriseWebControlFlowwork:FlowFeedbackColumn FieldName="ResultIcon"></SmoothEnterpriseWebControlFlowwork:FlowFeedbackColumn>
                            </Columns>
        ...
        <div style="margin: 20px 0px">
            <table border="0" class="Normal">
                ...
                <SmoothEnterpriseWebControlFlowwork:SendRequestButton ID="BUTTON_SendRequest" runat="server"
                    ...
                    CssClass="NormalBold" Flow="<%# FlowClient1 %>" Font-Bold="True" Font-Names="Arial" OnClick="BUTTON_SendRequest_Click"
                    Font-Size="12px" gradient-gradienttype="Bottom" Width="120px" Height="22px">
                ...
                <SmoothEnterpriseWebControlFlowwork:StopRequestButton ID="BUTTON_StopRequest" runat="server"
                    BackColor="#C8C8C8" BorderColor="#606060" BorderStyle="Solid" BorderWidth="1px" OnClick="BUTTON_StopRequest_Click"
                    CssClass="NormalBold" Flow="<%# FlowClient1 %>" Font-Bold="True" Font-Names="Arial"
                    Font-Size="12px" gradient-gradienttype="Bottom" Width="120px" Height="22px">
                    <Gradient GradientType="Bottom" GradientBegin="" GradientEnd=""></Gradient>
                </SmoothEnterpriseWebControlFlowwork:StopRequestButton>&nbsp;<SmoothEnterpriseWebControlFlowwork:RemindReviewerButton
                    ...
                    Font-Names="Arial" Font-Size="12px" Gradient-GradientType="Bottom" Height="22px" OnClick="BUTTON_RemindReviewer_Click"
                    Width="120px" Flow="<%# FlowClient1 %>">
