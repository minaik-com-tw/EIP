<%@ Page Title="" Language="C#" MasterPageFile="~/_site/layout/ie7.master" AutoEventWireup="true" CodeFile="FlowEdit.aspx.cs" Inherits="Maintain.FlowEdit" StylesheetTheme="Default" Culture="Auto"
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="master" class="div_table" style="text-align: center; width: 60%; padding: 2px 2px; border: 1px outset #446d4e">
        ...
        <div style="width: 100%; margin: 20px 10px;">
            <asp:Button ID="Btn_Update" runat="server" Text="修改" OnClientClick="return check()" OnClick="Btn_Update_Click" CssClass="sys_btn " />
            <asp:Button ID="Cancel" runat="server" OnClientClick="return back()" Text="回上頁" CssClass="sys_btn" />
        </div>
