<%@ page language="C#" masterpagefile="~/_site/layout/Template.master" autoeventwireup="true" inherits="SmoothEnterprise.Web.Application.Content.ContentTypeDelete, App_Web_contenttypedelete.aspx.cdcab7d2" title="刪除檔案內容類型" theme="Default" culture="auto" uiculture="auto" meta:resourcekey="PageResource1" %>
...
<Gradient GradientType="Top" GradientBegin="" GradientEnd=""></Gradient></SmoothEnterpriseWebControl:inputtext></td>
					...
					<tr>
						<td Class="Normal"><SmoothEnterpriseWebControl:InputText id="FIELD_fileext" runat="server" CssClass="PanelWhite" ReadOnly="True" Personalize="False" ButtonClick="True" ButtonIconUrl="" DateSeparator="Slash" DateType="YYYYMMDD" ErrorMessage="" FocusColor="" FormatType="None" HiddenMode="False" HTMLMode="Advance" IsValid="True" meta:resourcekey="FIELD_fileextResource1" OnClickMore="" Required="False">
<ErrorStyle BorderStyle="NotSet"></ErrorStyle>
<Gradient GradientType="Top" GradientBegin="" GradientEnd=""></Gradient></SmoothEnterpriseWebControl:inputtext></td>
					</tr>
					<tr>
					...
					<tr>
						<td Class="Normal"><SmoothEnterpriseWebControl:InputText id="FIELD_iconurl" runat="server" CssClass="PanelWhite" ReadOnly="True" Personalize="False" ButtonClick="True" ButtonIconUrl="" DateSeparator="Slash" DateType="YYYYMMDD" ErrorMessage="" FocusColor="" FormatType="None" HiddenMode="False" HTMLMode="Advance" IsValid="True" meta:resourcekey="FIELD_iconurlResource1" OnClickMore="" Required="False">
<ErrorStyle BorderStyle="NotSet"></ErrorStyle>
<Gradient GradientType="Top" GradientBegin="" GradientEnd=""></Gradient></SmoothEnterpriseWebControl:inputtext></td>
					</tr>
					<tr>
