<%@ page language="C#" masterpagefile="~/_site/layout/Template.master" autoeventwireup="true" inherits="SmoothEnterprise.Web.Application.Content.AuthorityFile, App_Web_authorityfile.aspx.cdcab7d2" title="檔案及目錄內容授權維護" theme="Default" culture="auto" uiculture="auto" meta:resourcekey="PageResource1" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">    
		...
		<tr vAlign="top">
			<td>
				<table class="panelblue" border="0">
					...
					<tr Class="NormalBold">
						<td><SmoothEnterpriseWebControl:CheckBoxList id="CHECK_everyone" runat="server" Width="100px" cssClass="Normal" ListDirection="Horizontal" meta:resourcekey="CHECK_everyoneResource1" Value="">
	...
	<table border="0">
		...
		<tr>
			<td><SmoothEnterpriseWebControl:inputselect id="QUERY_group" runat="server"  cssClass="Normal" ItemAllDisplayed="True"
					backcolor="#F0F0F0" Personalize="True" ButtonClick="True" ButtonIconUrl="/lib/img/icon-downarrow.gif" Editable="False" ErrorMessage="" FadeSpeed="NoFade" IsValid="True" ItemAll-GroupText="" ItemAll-IconUrl="" ItemAll-RowHeight="18" ItemAll-Selected="False" ItemAll-Text="" ItemNone-GroupText="" ItemNone-IconUrl="" ItemNone-RowHeight="18" ItemNone-Selected="False" ItemNone-Text="" ListPosition="Vertical" meta:resourcekey="QUERY_groupResource1" Mode="Single" TextBoxStyle="ThreeDStyle" Value=""><Gradient GradientType="Top" GradientBegin="" GradientEnd=""></Gradient>
                <ErrorStyle BorderStyle="NotSet" CssClass="" />
            </SmoothEnterpriseWebControl:InputSelect></td>
			<td><SmoothEnterpriseWebControl:inputselect id="QUERY_roleuser" runat="server"  cssClass="Normal" ItemAllDisplayed="True"
					backcolor="#F0F0F0" Personalize="True" Value="R" ButtonClick="True" ButtonIconUrl="/lib/img/icon-downarrow.gif" Editable="False" ErrorMessage="" FadeSpeed="NoFade" IsValid="True" ItemAll-GroupText="" ItemAll-IconUrl="" ItemAll-RowHeight="18" ItemAll-Selected="False" ItemAll-Text="" ItemNone-GroupText="" ItemNone-IconUrl="" ItemNone-RowHeight="18" ItemNone-Selected="False" ItemNone-Text="" ListPosition="Vertical" meta:resourcekey="QUERY_roleuserResource1" Mode="Single" TextBoxStyle="ThreeDStyle">
					<Items>
	...
	<table border="0">
		<tr>
			<td><SmoothEnterpriseWebControl:inputbutton id="BUTTON_save" runat="server" Width="80px" Font-Names="Arial" Font-Size="12px"
