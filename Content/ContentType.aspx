<%@ page language="C#" masterpagefile="~/_site/layout/Template.master" autoeventwireup="true" inherits="SmoothEnterprise.Web.Application.Content.ContentType, App_Web_contenttype.aspx.cdcab7d2" title="檔案內容類型維護" theme="Default" culture="auto" uiculture="auto" meta:resourcekey="PageResource1" %>
			...
			<td>
				<SmoothEnterpriseWebControl:DataList id="DataList1" runat="server" BorderColor="Black" EnableCustom="True"
					...
					<Columns>
						...
						<SmoothEnterpriseWebControl:DataColumn DataType="ViewText" Caption="內容類型" DataName="name" Sortable="True" ID="DataList1_contenttypename" DataStyle-BorderStyle="NotSet" HeaderStyle-BorderStyle="NotSet" runat="server" meta:resourcekey="DataList1_contenttypenameResource1"></SmoothEnterpriseWebControl:DataColumn>
						<SmoothEnterpriseWebControl:DataColumn DataType="ViewText" Caption="預設檔案附屬類型" DataName="fileext" Sortable="True" ID="DataList1_fileext" DataStyle-BorderStyle="NotSet" HeaderStyle-BorderStyle="NotSet" runat="server" meta:resourcekey="DataList1_fileextResource1"></SmoothEnterpriseWebControl:DataColumn>
						<SmoothEnterpriseWebControl:DataColumn DataType="ViewText" Caption="內容圖示位址" DataName="iconurl" Sortable="True" ID="DataList1_iconurl" DataStyle-BorderStyle="NotSet" HeaderStyle-BorderStyle="NotSet" runat="server" meta:resourcekey="DataList1_iconurlResource1"></SmoothEnterpriseWebControl:DataColumn>
						...
						<SmoothEnterpriseWebControl:DataColumn Visible="False" DataType="ViewText" Caption="自動同步" DataAlign="Center" DataName="autosync"
						...
						<SmoothEnterpriseWebControl:DataColumn DataType="ViewText" Caption="修改人員" DataName="modifyname" Sortable="True" ID="DataList1_modifyuid" DataStyle-BorderStyle="NotSet" HeaderStyle-BorderStyle="NotSet" runat="server" meta:resourcekey="DataList1_modifyuidResource1"></SmoothEnterpriseWebControl:DataColumn>
						<SmoothEnterpriseWebControl:DataColumn DataType="ViewText" Caption="資料修改時間" DataName="modifydate" Sortable="True" ID="DataList1_modifydate" DataStyle-BorderStyle="NotSet" HeaderStyle-BorderStyle="NotSet" runat="server" meta:resourcekey="DataList1_modifydateResource1"></SmoothEnterpriseWebControl:DataColumn>
					</Columns>
