<%@ page language="C#" masterpagefile="~/_site/layout/Template.master" autoeventwireup="true" inherits="SmoothEnterprise.Web.Application.Portal.TipsAdd, App_Web_tipsadd.aspx.cdcab7d2" theme="Default" culture="auto" uiculture="auto" meta:resourcekey="PageResource1" %>
	...
	<table border="0" Class="Normal">
		<tr>
			<td valign="top"><table>
					...
					<tr>
						<td>
                            <SmoothEnterpriseWebControlEnterprise:SelectContent ID="FIELD_cid" runat="server"
                                BackColor="White" CssClass="Normal" ButtonClick="True" ButtonIconUrl="/lib/img/icon-downarrow.gif" Editable="False" ErrorMessage="" FadeSpeed="NoFade" IsValid="True" ItemAll-GroupText="" ItemAll-IconUrl="" ItemAll-RowHeight="18" ItemAll-Selected="False" ItemAll-Text="" ItemNone-GroupText="" ItemNone-IconUrl="" ItemNone-RowHeight="18" ItemNone-Selected="False" ItemNone-Text="" ListPosition="Vertical" meta:resourcekey="FIELD_cidResource1" Mode="Single" TextBoxStyle="ThreeDStyle" Value="5723821d-69f8-42ab-bdb5-5d9b676f3e97">
					...
					<tr>
						<td>
							<SmoothEnterpriseWebControl:InputHTML id="FIELD_tips" runat="server" Width="600px" Height="300px"  backcolor="#F0F0F0"
								cssClass="Normal" Required="True" ErrorMessage="" Gradient="Left" imgSrc="" IsValid="True" meta:resourcekey="FIELD_tipsResource1" Mode="Advance" Value="">
                                <ErrorStyle BorderStyle="NotSet" CssClass="" />
