...
//20130527 小量生產/工程試作 預設CHANGE
    ...
    <table cellpadding="0" cellspacing="0" style="width: 1000px; border-collapse: collapse">
        ...
        <tr>
            <td align="center" colspan="2">&nbsp;<input type="textbox" autocomplete="off" id="e_title" name="e_title" value="工程試作單" style="border-right: 1px; border-top: 1px; font-weight: bold; font-size: 12pt; border-left: 1px; width: 154px; color: black; border-bottom: 1px; text-align: center;"></td>
        </tr>
        <tr>
            <td align="left" style="width: 306px; height: 24px"></td>
                ...
                <table width="100%">
                    ...
                    <tr>
                        ...
                        <td style="width: 285px; height: 26px">
                            <SmoothEnterpriseWebControl:InputText ID="FIELD_expect_date" runat="server" BackColor="White" CssClass="Normal" ErrorMessage="Please Input「Expect_date」!!" MaxLength="0" FormatType="Date">
                                <Gradient GradientBegin="" GradientEnd="" GradientType="Top" />
                                <ErrorStyle BorderStyle="NotSet" CssClass="" />
                            </SmoothEnterpriseWebControl:InputText></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td style="width: 139px; height: 27px">
                            <asp:TextBox ID="order_no" runat="server" autocomplete="off" Style="border-left-color: gainsboro; border-bottom-color: gainsboro; border-top-style: solid; border-top-color: gainsboro; border-right-style: solid; border-left-style: solid; background-color: whitesmoke; border-right-color: gainsboro; border-bottom-style: solid"
                        ...
                        <td style="width: 285px; height: 27px">
                            <asp:TextBox ID="oduction_explain" runat="server" autocomplete="off" Style="border-left-color: gainsboro; border-bottom-color: gainsboro; border-top-style: solid; border-top-color: gainsboro; border-right-style: solid; border-left-style: solid; background-color: whitesmoke; border-right-color: gainsboro; border-bottom-style: solid"
                                Width="200px"></asp:TextBox></td>
                    </tr>
                    <tr>
                        ...
                        <td colspan="3">
                            <asp:TextBox ID="remark" runat="server" autocomplete="off" Style="border-left-color: gainsboro; border-bottom-color: gainsboro; border-top-style: solid; border-top-color: gainsboro; border-right-style: solid; border-left-style: solid; background-color: whitesmoke; border-right-color: gainsboro; border-bottom-style: solid"
                                Width="643px"></asp:TextBox></td>
                    </tr>
                    <tr>
                        <td style="width: 154px;">
                            <asp:Label ID="Label2" runat="server" CssClass="NormalBold" Font-Size="Small" ForeColor="Red"
                        ...
                        <td>
                            <asp:Label ID="Label40" runat="server" CssClass="NormalBold" Font-Size="Small" ForeColor="WhiteSmoke"
                                Height="10px" Text="*" Width="6px"></asp:Label><asp:Label ID="Label41" runat="server"
                                    CssClass="NormalBold" Font-Names="新細明體" Font-Size="10pt" meta:resourcekey="Label8a"
                                    Text="試&nbsp;模&nbsp;目&nbsp;的"></asp:Label></td>
                        <td>
                            <asp:DropDownList ID="FEILD_obj" runat="server">
                    ...
                    <tr>
                        ...
                        <td colspan="2" style="height: 25px; text-align: right">
                            ...
                            <input id="Button2" onclick="getData2()" style="font-weight: bold; font-size: 12px; color: #000000"
                                type="button" value="重新設定" />&nbsp;
                        </td>
                    </tr>
                </table>
                        ...
                        <tr subid="EditZone" bgcolor="#FFFFFF" onmouseout="this.bgColor='#FFFFFF';" onmouseover="this.bgColor='#a9a9a9';" onfocus="this.bgColor='#a9a9a9';">
                            ...
                            <td style="width: 14px; text-align: center;">
                                <button id="btnDel" name="btnDel">
                                    <img src="Image/delete.png" height="15px" width="15px"></button>
                        </tr>
                    </tbody>
                </table>
            ...
            <td style="width: 83%">
                ...
                <table width="100%">
                    ...
                    <tr>
                        ...
                        <td style="width: 138px; height: 26px">&nbsp;</td>
                        <td style="width: 280px; height: 26px"></td>
                    </tr>
                    <tr>
                        <td style="width: 137px; height: 26px">
                    ...
                    <tr>
                        <td style="width: 137px; height: 33px; vertical-align: top;"></td>
                        <td colspan="3" style="height: 33px"></td>
                    </tr>
                </table>
                <table width="100%">
                    <tr>
                            ...
                            <table>
                                ...
                                <tbody id="tbd2">
                                    <tr subid="EditZone2" bgcolor="#FFFFFF" onfocus="this.bgColor='#a9a9a9';">
                                        ...
                                        <td style="width: 100px">
                                            <button id="btnAdd2" name="btnAdd2">
                                                <img src="Image/add.png" height="15px" width="15px"></button>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
    ...
    <table border="0" class="Normal">
        <tr>
            <td>
				...
				<SmoothEnterpriseWebControl:InputButton ID="BUTTON_savenext" runat="server" Text="儲存後繼續操作" BackColor="#C8C8C8" BorderColor="#606060" BorderStyle="Solid" BorderWidth="1px" CssClass="NormalBold" Font-Bold="True" Font-Names="Arial" Font-Size="12px" OnClick="BUTTON_save_Click" Visible="False">
                    <Gradient GradientBegin="136, 136, 136" GradientEnd="White" GradientType="Bottom" />
                </SmoothEnterpriseWebControl:InputButton>&nbsp;
