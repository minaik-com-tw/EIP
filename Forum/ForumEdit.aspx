<%@ page language="C#" masterpagefile="~/_site/layout/Template.master" autoeventwireup="true" inherits="SmoothEnterprise.Web.Application.Forum.ForumEdit, App_Web_forumedit.aspx.cdcab7d2" title="編輯討論區" theme="Default" culture="auto" uiculture="auto" meta:resourcekey="PageResource1" %>
	...
	<table border="0" Class="Normal">
		<tr>
			<td>
				...
				<SmoothEnterpriseWebControl:InputButton id="BUTTON_grant" runat="server" Width="80px" Font-Names="Arial" Font-Size="12px"
					BorderColor="#606060" BorderWidth="1px" BorderStyle="Solid" BackColor="#C8C8C8" cssClass="NormalBold" Font-Bold="True"
					Text="授權" OnClick="BUTTON_grant_Click" meta:resourcekey="BUTTON_grantResource1" RunAtCient="False">
