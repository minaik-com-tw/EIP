<%@ Page Language="C#" MasterPageFile="~/_site/layout/Template.master" AutoEventWireup="true" CodeFile="CXMT310Edit.aspx.cs" Inherits="ERP_CXMT310.CXMT310Edit" StylesheetTheme="Default" Culture="Auto" UICulture="Auto"%>
...
　　　　        str = '<SmoothEnterpriseWebControl:InputFile runat="server" onchange="addfile()" BackColor="#F0F0F0" CssClass="Normal" Width="400px"> <Gradient GradientBegin="" GradientEnd="" GradientType="Top" /></SmoothEnterpriseWebControl:InputFile><br />';
　　　　        document.getElementById('uploadfiles').insertAdjacentHTML("beforeEnd",str)
    ...
    <SmoothEnterpriseWebControlEnterprise:Descriptor ID="ContentDescriptor" runat="server" Details="The desciption for this program"
		Caption="CXMT310 Edit Page" Width="100%" CssClass="Normal" Gradient="None" Height="40%" PaddingSpace="5px">
    ...
    <table cellpadding="0" cellspacing="0" style="width: 1285px; height: 70px">
        <tr>
            <td align="center" colspan="2" style="width: 100%; height: 23px">
                <asp:Label ID="FIELD_companyname" runat="server" CssClass="NormalBold" Font-Size="Medium" meta:resourcekey="Label1Resource1"
                    Text="銘異科技股份有限公司" Width="500px"></asp:Label></td>
        </tr>
        <tr>
        ...
        <tr>
            <td style="width: 357px; height: 21px">
                ...
                <asp:Label ID="FIELD_no" runat="server" CssClass="NormalBold" ForeColor="DimGray" Height="5px" Width="93px"></asp:Label>&nbsp;
                <asp:Label ID="sadfa" runat="server" CssClass="NormalBold" Font-Names="新細明體"
                    Font-Size="9pt" meta:resourcekey="Label34Resource1" Text="Ver"></asp:Label>
                        ...
                        <td style="width: 83%; height: 15px; text-align: right">
                            <table style="width: 100%">
                                ...
                                <tr style="font-size: 10pt">
                                    <td id="table1_1" colspan="4" rowspan="6" style="text-align: left; height: auto;">
                                        <table style="width: 100%">
                                            <tr>
                                                                ...
                                                                <table border="0" cellpadding="0" cellspacing="0" style="width: 100%; height: 89%">
                                                                    <tr>
                                                                        <td colspan="4" style="width: 100%; height: 20px; background-color: #ffcc66">
                                                                            <asp:Label ID="Label3" runat="server" Font-Size="11pt" Text="基本資料" Font-Bold="True"></asp:Label></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td style="width: 73px; background-color: gainsboro;">
                                                                            <asp:Label ID="Label5" runat="server" Font-Size="10pt" Text="ERP單號" Font-Bold="True" Width="90px"></asp:Label>
                                                                        </td>
                                                                        <td style="width: 151px;">
                                                                            <asp:Label ID="FIELD_oqa01" runat="server" CssClass="NormalBold" Font-Bold="False"
                                                                                Font-Size="10pt" ForeColor="DimGray" Height="5px" Style="text-align: left"
                                                                                Width="79px"></asp:Label></td>
                                                                        <td style="width: 85px; background-color: gainsboro;">
                                                                            <asp:Label ID="Label20" runat="server" Font-Size="10pt" Text="客戶" Font-Bold="True" Width="59px"></asp:Label></td>
                                                                    ...
                                                                    <tr>
                                                                        <td style="width: 73px; background-color: gainsboro;">
                                                                            <asp:Label ID="Label6" runat="server" Font-Size="10pt" Text="類別" Font-Bold="True" Width="90px"></asp:Label></td>
                                                                        <td style="width: 151px;">
                                                                            <asp:Label ID="FIELD_oaydesc" runat="server" CssClass="NormalBold" Font-Bold="False"
                                                                                Font-Size="10pt" ForeColor="DimGray" Height="5px" Style="text-align: left"
                                                                                Width="79px"></asp:Label></td>
                                                                        <td style="width: 85px; background-color: gainsboro;">
                                                                            <asp:Label ID="Label21" runat="server" Font-Size="10pt" Text="業務人員" Font-Bold="True" Width="74px"></asp:Label></td>
                                                                        <td style="width: 206px;">
                                                                    ...
                                                                    <tr>
                                                                        <td style="width: 73px; background-color: gainsboro;">
                                                                            <asp:Label ID="Label7" runat="server" Font-Size="10pt" Text="估價日期" Font-Bold="True" Width="90px"></asp:Label></td>
                                                                        <td style="width: 151px">
                                                                            <asp:Label ID="FIELD_oqa02" runat="server" CssClass="NormalBold" ForeColor="DimGray"
                                                                                Height="5px" Style="text-align: left" Text="920101" Width="79px" Font-Bold="False" Font-Size="10pt"></asp:Label></td>
                                                                        <td style="width: 85px; background-color: gainsboro;">
                                                                            <asp:Label ID="Label22" runat="server" Font-Size="10pt" Text="部門" Font-Bold="True" Width="59px"></asp:Label></td>
                                                                        <td style="width: 206px">
                                                                            <asp:Label ID="FIELD_gem02_0" runat="server" CssClass="NormalBold" ForeColor="DimGray"
                                                                                Height="5px" Style="text-align: left" Width="81px" Font-Bold="False" Font-Size="10pt"></asp:Label></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td style="width: 73px; background-color: gainsboro;">
                                                                            <asp:Label ID="Label8" runat="server" Font-Size="10pt" Text="產品編號" Font-Bold="True" Width="90px"></asp:Label></td>
                                                                        <td style="width: 151px">
                                                                            <asp:Label ID="FIELD_oqa03" runat="server" CssClass="NormalBold" Font-Bold="False"
                                                                                Font-Size="10pt" ForeColor="DimGray" Height="5px" Style="text-align: left"
                                                                                Width="79px"></asp:Label></td>
                                                                        <td style="width: 85px; background-color: gainsboro;">
                                                                            <asp:Label ID="Label17" runat="server" Font-Size="10pt" Text="有效日期" Font-Bold="True" Width="59px"></asp:Label></td>
                                                                        <td style="width: 206px">
                                                                    ...
                                                                    <tr>
                                                                        <td style="width: 73px; background-color: gainsboro;">
                                                                            <asp:Label ID="Label15" runat="server" Font-Size="10pt" Text="品名" Font-Bold="True" Width="90px"></asp:Label></td>
                                                                        <td colspan="3">
                                                                    ...
                                                                    <tr>
                                                                        <td style="width: 73px; background-color: gainsboro;">
                                                                            <asp:Label ID="Label19" runat="server" Font-Size="10pt" Text="規格" Font-Bold="True" Width="90px"></asp:Label></td>
                                                                        <td colspan="3">
                                                ...
                                                <td style="width: 50%; height: 239px;"><table border="0" style="border-right: goldenrod 1px solid; border-top: goldenrod 1px solid;
                                                        border-left: goldenrod 1px solid; width: 100%; border-bottom: goldenrod 1px solid;
                                                        height: 100%">
                                                    <tr>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td style="width: 117px">
                                                                        <asp:Label ID="FIELD_oqa10" runat="server" CssClass="NormalBold" Font-Bold="False"
                                                                            Font-Size="10pt" ForeColor="Red" Height="5px" Style="text-align: left"
                                                                            Width="79px"></asp:Label></td>
                                                                    <td style="width: 65px; background-color: gainsboro;">
                                                                    ...
                                                                    <td colspan="3">
                                                                        <asp:Label ID="FIELD_oah02_" runat="server" CssClass="NormalBold"
                                                                                Font-Bold="False" Font-Size="10pt" ForeColor="DimGray" Height="5px" Style="text-align: left" Width="100%"></asp:Label></td>
                                                                </tr>
                                                                <tr>
                                                                    <td style="width: 65px; background-color: gainsboro;">
                                                                    ...
                                                                    <td style="width: 117px">
                                                                        <asp:Label ID="FIELD_ta_oqa171" runat="server" CssClass="NormalBold" Font-Bold="False"
                                                                            Font-Size="10pt" ForeColor="DimGray" Height="5px" Style="text-align: left"
                                                                            Width="45px"></asp:Label><asp:Label ID="FIELD_ta_oqa223" runat="server" CssClass="NormalBold"
                                                                                Font-Bold="False" Font-Size="10pt" ForeColor="DimGray" Height="5px" Style="text-align: left" Width="52px"></asp:Label></td>
                                                                    <td style="width: 65px; background-color: gainsboro;">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td style="width: 65px; background-color: gainsboro;">
                                                                        <asp:Label ID="Label36" runat="server" Font-Bold="True" Font-Size="10pt" Text="原幣總售價"
                                                                            Width="90px"></asp:Label></td>
                                                                    <td style="width: 119px;">
                                                                        <asp:Label ID="FIELD_sum" runat="server" CssClass="NormalBold" Font-Bold="False" Font-Size="10pt"
                                                                            ForeColor="Red" Height="5px" Style="text-align: left" Width="79px"></asp:Label></td>
                                                                    <td style="width: 65px; background-color: gainsboro;">
                                                                        <asp:Label ID="Label40" runat="server" Font-Bold="True" Font-Size="10pt" Text="本幣總售價"
                                                                            Width="90px"></asp:Label></td>
                                                                    <td style="width: 119px;">
                                                                        <asp:Label ID="FIELD_sum1" runat="server" CssClass="NormalBold" Font-Bold="False" Font-Size="10pt"
                                                                            ForeColor="Red" Height="5px" Style="text-align: left" Width="79px"></asp:Label></td>
                                                                </tr>
                                                                <tr>
                                                                    <td style="width: 65px; background-color: gainsboro;">
                                                                    ...
                                                                    <td style="width: 119px">
                                                                        <asp:Label ID="FIELD_ta_oqa033" runat="server" CssClass="NormalBold" Font-Bold="False"
                                                                            Font-Size="10pt" ForeColor="DimGray" Height="5px" Style="text-align: left"
                                                                            Width="40px"></asp:Label><asp:Label ID="FIELD_ta_oqa034" runat="server" CssClass="NormalBold"
                                                                                Font-Bold="False" Font-Size="10pt" ForeColor="DimGray" Height="5px" Style="text-align: left" Width="60px"></asp:Label></td>
                                                                </tr>
                                                                <tr>
                                                                    <td style="width: 65px; background-color: gainsboro;">
                                                                    ...
                                                                    <td style="width: 119px;">
                                                                        <asp:Label ID="FIELD_ta_oqa063" runat="server" CssClass="NormalBold" Font-Bold="False"
                                                                            Font-Size="10pt" ForeColor="DimGray" Height="5px" Style="text-align: left"
                                                                            Width="40px"></asp:Label><asp:Label ID="FIELD_ta_oqa064" runat="server" CssClass="NormalBold"
                                                                                Font-Bold="False" Font-Size="10pt" ForeColor="DimGray" Height="5px" Style="text-align: left" Width="60px"></asp:Label></td>
                                                                </tr>
                                                                <tr>
                                                                    <td style="width: 65px; background-color: gainsboro;">
                                                                    ...
                                                                    <td style="width: 119px">
                                                                        <asp:Label ID="FIELD_ta_oqa073" runat="server" CssClass="NormalBold" Font-Bold="False"
                                                                            Font-Size="10pt" ForeColor="DimGray" Height="5px" Style="text-align: left"
                                                                            Width="40px"></asp:Label><asp:Label ID="FIELD_ta_oqa074" runat="server" CssClass="NormalBold"
                                                                                Font-Bold="False" Font-Size="10pt" ForeColor="DimGray" Height="5px" Style="text-align: left" Width="60px"></asp:Label></td>
                                                                </tr>
                                                            </table>
                                                        </td>
                                                        ...
                                                        <tr>
                                                            <td style="width: 100%; height: 57px">
                                                                <table border="0" cellpadding="0" cellspacing="0" style="width: 100%; height: 7px">
                                                                    <tr>
                                                                        <td colspan="4" style="width: 100%; background-color: #ffcc66">
                                        ...
                                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White"
                                            ...
                                            Font-Size="Small" ForeColor="Black" GridLines="Vertical" Height="53px"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="ta_oqb12" HeaderText="MOQ" meta:resourcekey="ta_oqb12" SortExpression="ta_oqb12" />
                                                <asp:BoundField DataField="ta_oqb13" HeaderText="RiskBuy" meta:resourcekey="ta_oqb13" SortExpression="ta_oqb13" />
                                                ...
                                                <asp:BoundField DataField="ta_oqb04" HeaderText="LT" meta:resourcekey="ta_oqb04" SortExpression="ta_oqb04" />
                                                
                                                <asp:BoundField DataField="ta_oqb02" HeaderText="付款條件" meta:resourcekey="ta_oqb02" SortExpression="ta_oqb02" />
                                                <asp:BoundField DataField="ta_oqb03" HeaderText="預估付款日" meta:resourcekey="ta_oqb03" SortExpression="ta_oqb03" />
                                                <asp:BoundField DataField="ta_oqb091" HeaderText="稅別" meta:resourcekey="ta_oqb091" SortExpression="ta_oqb091" />
                                                <asp:BoundField DataField="ta_oqb092" HeaderText="稅率" meta:resourcekey="ta_oqb092" SortExpression="ta_oqb092" />
                                                <asp:BoundField DataField="ta_oqb09" HeaderText="原幣未稅單價" meta:resourcekey="ta_oqb09" SortExpression="ta_oqb09" />
                                                <asp:BoundField DataField="oqb09" HeaderText="原幣成本單價" meta:resourcekey="oqb09" SortExpression="oqb09" />
                                                <asp:BoundField DataField="ta_oqb10" HeaderText="未稅單價" meta:resourcekey="ta_oqb10" SortExpression="ta_oqb10" />
                                                <asp:BoundField DataField="oqb10" HeaderText="成本單價" meta:resourcekey="oqb10" SortExpression="oqb10" />
                                                <asp:BoundField DataField="ta_oqb11" HeaderText="未稅金額" meta:resourcekey="ta_oqb11" SortExpression="ta_oqb11" />
                                        ...
                                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:EIPAConnectionString %>"
                                            SelectCommand="select oqb02,oqb03,oqb031,oqb032,oqb04,oqb05,ta_oqb12,ta_oqb13,oqb07,oqb08,ta_oqb04,ta_oqb02,convert(char, ta_oqb03, 111) ta_oqb03,ta_oqb091,ta_oqb092,ta_oqb093,ta_oqb09,oqb09,ta_oqb10,oqb10,ta_oqb11,oqb11 from cxmt310_in_body  ">
                                        </asp:SqlDataSource>
                                                            </td>
                                                        </tr>
                                                    </table>
                                            ...
                                            SelectCommand="SELECT [oqe04] FROM [CXMT310_IN_OQE]">
                                                                            </asp:SqlDataSource>
                                            ...
                                            SelectCommand="SELECT [tc_oqe04] FROM [CXMT310_IN_TCOQE]"></asp:SqlDataSource>
                                                    ...
                                                    <table style="width: 323px; height: 116px" border="0">
                                                        <tr>
                                                                    ...
                                                                    Text="報價分析"></asp:Label></td>
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td style="width: 80px; height: 21px">
                                                                                        <asp:Label ID="Label18" runat="server" Font-Bold="True" Font-Size="Small" Text="總估價金額" ForeColor="Red" Width="87px"></asp:Label></td>
...
<asp:CheckBoxList id="CheckBoxFile" runat="server" Font-Size="X-Small">
                    ...
                    <SmoothEnterpriseWebControl:InputFile ID="attach1" onchange="addfile()" runat="server" BackColor="#F0F0F0" CssClass="Normal" Width="400px">
                    <Gradient GradientBegin="" GradientEnd="" GradientType="Top" />
                    </SmoothEnterpriseWebControl:InputFile></p></td>
                                </tr>
                            </table>
                            <table style="font-family: Times New Roman" width="100%">
                                <tr>
                                    <td colspan="4" style="vertical-align: top; height: 44px; text-align: left">
                                    </td>
                                </tr>
                            </table>
                        </td>
    ...
    <br />
    <br />
    <table border="0" Class="Normal" style="font-family: Times New Roman">
        <tr>
            <td>
		...
		<tr>
			<td>
				<SmoothEnterpriseWebControl:InputButton ID="BUTTON_save" runat="server" Text="儲存" width="80px" BackColor="#C8C8C8" BorderColor="#606060" BorderStyle="Solid" BorderWidth="1px" CssClass="NormalBold" Font-Bold="True" Font-Names="Arial" Font-Size="12px" OnClick="BUTTON_save_Click"><Gradient GradientBegin="136, 136, 136" GradientEnd="White" GradientType="Bottom" /></SmoothEnterpriseWebControl:InputButton>&nbsp;<SmoothEnterpriseWebControlFlowwork:SendRequestButton ID="BUTTON_SendRequest" runat="server"
                    ...
                    ID="BUTTON_ERP" runat="server" BackColor="#C8C8C8" BorderColor="#606060" BorderStyle="Solid"
                    BorderWidth="1px" CssClass="NormalBold" Font-Bold="True" Font-Names="Arial" Font-Size="12px"
                    OnClick="BUTTON_ERP_Click" Text="退回ERP修改" Width="80px">
                    <Gradient GradientBegin="136, 136, 136" GradientEnd="White" GradientType="Bottom" />
