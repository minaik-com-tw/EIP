<%@ page language="C#" masterpagefile="~/_site/layout/Template.master" autoeventwireup="true" inherits="SmoothEnterprise.Web.Application.Calendar.CalendarCategoryDelete, App_Web_calendarcategorydelete.aspx.cdcab7d2" theme="Default" culture="auto" uiculture="auto" meta:resourcekey="PageResource1" %>
	...
	<table border="0" Class="Normal">
		<tr>
			<td valign="top"><table>
					...
					<tr>
						<td Class="Normal"><SmoothEnterpriseWebControl:InputText id="FIELD_category" runat="server" CssClass="PanelWhite" ReadOnly="True" Width="280px" ButtonClick="True" ButtonIconUrl="" DateSeparator="Slash" DateType="YYYYMMDD" ErrorMessage="" FocusColor="" FormatType="None" HiddenMode="False" HTMLMode="Advance" IsValid="True" meta:resourcekey="FIELD_categoryResource1" OnClickMore="" Personalize="False" Required="False"><Gradient GradientType="Top" GradientBegin="" GradientEnd=""></Gradient>
					...
					<tr>
						<td Class="Normal">
							...
							<SmoothEnterpriseWebControl:InputText id="FIELD_eventstyle" runat="server" CssClass="PanelWhite" ReadOnly="True" HiddenMode="True" ButtonClick="True" ButtonIconUrl="" DateSeparator="Slash" DateType="YYYYMMDD" ErrorMessage="" FocusColor="" FormatType="None" HTMLMode="Advance" IsValid="True" meta:resourcekey="FIELD_eventstyleResource1" OnClickMore="" Personalize="False" Required="False"><Gradient GradientType="Top" GradientBegin="" GradientEnd=""></Gradient>
                                <ErrorStyle BorderStyle="NotSet" CssClass="" />
                            </SmoothEnterpriseWebControl:inputtext>
							<!--
							<table Class="Normal" width="50" height="50" id="tablestyle" runat="server">
								<tr>
									<td id="tablestyletd" align="center" valign="middle">Abc</td>
								</tr>
							</table>-->
						</td>
					</tr>
