<%@ page language="C#" masterpagefile="~/_site/layout/Template.master" autoeventwireup="true" inherits="SmoothEnterprise.Web.Application.Teamwork.ProjectTaskEdit, App_Web_projecttaskedit.aspx.cdcab7d2" theme="Default" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">    
    ...
    <table border="0" Class="Normal">
        <tr>
                    ...
                    <tr>
                        <td>
                            <SmoothEnterpriseWebControl:InputSelect ID="FIELD_projid" runat="server" ErrorMessage="請輸入「專案」!!"
                                ...
                                OnSelectedIndexChanged="FIELD_projid_SelectedIndexChanged" Required="True">
                    ...
                    <tr>
                        <td>
                            <SmoothEnterpriseWebControl:InputSelect ID="FIELD_projphaseid" runat="server" ErrorMessage="請輸入「專案階段」!!"
                                ItemAll-Value="%" BackColor="#F0F0F0" CssClass="Normal" ItemNoneDisplayed="True"
                                OnSelectedIndexChanged="FIELD_projphaseid_SelectedIndexChanged" Required="True">
                    ...
                    <tr>
                        <td>
                            <SmoothEnterpriseWebControl:InputSelect ID="FIELD_name" runat="server" Width="282px"
                                ...
                                Editable="True" OnSelectedIndexChanged="FIELD_name_SelectedIndexChanged" ButtonClick="True" Mode="Single">
                                <Items>
            ...
            <td valign="top" style="width: 310px; height: 1px">
                <table>
                    <tr>
                        <td>
                    ...
                    <tr>
                        <td nowrap="nowrap">
                            ...
                            <asp:Literal ID="FIELD_attachments_download" runat="server"></asp:Literal>
                            <asp:CheckBox ID="FIELD_attachments_remove" runat="server" CssClass="Normal" Text="Remove Attachment" /></td>
                    </tr>
                    <tr>
                        <td>
