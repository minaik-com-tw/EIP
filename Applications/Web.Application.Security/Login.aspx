<%@ page language="C#" masterpagefile="~/_site/layout/Template.master" autoeventwireup="true" inherits="SmoothEnterprise.Web.Application.Security.Login, App_Web_login.aspx.cdcab7d2" title="SmoothEnterprise.NET Login" stylesheettheme="Default" culture="auto" uiculture="auto" meta:resourcekey="PageResource1" %>
                ...
                <table style="border-right: #d3d9f0 1px solid; border-top: #d3d9f0 1px solid; filter: progid:DXImageTransform.Microsoft.gradient(gradienttype=0,startcolorstr=#00DBE2FF, endcolorstr=#ddffffff);
                    ...
                    <tr valign="top">
                        ...
                        <td width="50%">
                            <table id="Table1" style="color: #2d387b" cellspacing="5" cellpadding="0" width="100%"
                                ...
                                <tr>
                                    <td class="NormalBold">
                                        <asp:Label ID="LABEL_userid" runat="server" Text="請輸入您的登入帳號" meta:resourcekey="LABEL_useridResource1"></asp:Label></td>
                                </tr>
                                <tr>
                                    <td>
                                ...
                                <tr>
                                    <td class="NormalBold">
                                        <asp:Label ID="LABEL_userpwd" runat="server" Text="帳號密碼" meta:resourcekey="LABEL_userpwdResource1"></asp:Label></td>
                                </tr>
                                <tr>
                                    <td>
                        ...
                        <td id="TD_regstyle1" align="center" width="1%" runat="server">
                            <img src="img/img-or1.gif" align="absMiddle" vspace="15" border="0"><br>
                        ...
                        <td id="TD_regstyle2" width="50%" runat="server">
                            <table class="Normal" id="Table2" style="color: #2d387b" cellspacing="5" cellpadding="0"
                                ...
                                <tr>
                                    <td class="Normal">
                                        <img src="img/bullet-brect.gif" align="absMiddle" border="0">&nbsp;<asp:Label ID="LABEL_newuser"
                                            runat="server" Text="For new user :" meta:resourcekey="LABEL_newuserResource1"></asp:Label></td>
                                </tr>
                                <tr>
                                    <td background="/lib/img/bg-mask.gif" height="1">
                                    </td>
                                ...
                                <tr>
                                    <td style="font-size: 11px; line-height: 16px; font-family: Tahoma">
                                        <asp:Label ID="LABEL_register" runat="server" Text="如果您尚未登錄帳號，請按註冊按鈕來完成申請：" meta:resourcekey="LABEL_registerResource1"></asp:Label></td>
                                </tr>
                                <tr>
                    ...
                    <tr id="deniedinfo" runat="server">
                        ...
                        <td style="padding-right: 5px; padding-left: 5px; padding-bottom: 5px; padding-top: 5px;
                            background-color: #ccccff" colspan="3">
