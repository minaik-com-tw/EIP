...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">    
	...
	<table Class="Normal" id="TABLE1" border="0" runat="server">
		<tr Class="NormalBold">
					...
					<tr>
						<td><SmoothEnterpriseWebControl:inputtext id="FIELD_logonid" runat="server" BackColor="#F0F0F0" CssClass="Normal" MaxLength="50"
                            ...
                            <ErrorStyle BorderStyle="NotSet" CssClass="" />
								...
								ControlToValidate="FIELD_logonid" Display="None" meta:resourcekey="V_FIELD_logonidResource1"></asp:customvalidator><SmoothEnterpriseWebControl:inputtext id="FIELD_ologonid" runat="server" BackColor="#F0F0F0" Width="0px" CssClass="Normal"
								MaxLength="50" ErrorMessage="Please Input「Logon Id」!!" HiddenMode="True" ReadOnly="True" ButtonClick="True" ButtonIconUrl="" DateSeparator="Slash" DateType="YYYYMMDD" FocusColor="" FormatType="None" HTMLMode="Advance" IsValid="True" meta:resourcekey="FIELD_ologonidResource1" OnClickMore="" Personalize="False" Required="False"><Gradient GradientType="Top" GradientBegin="" GradientEnd=""></Gradient>
                                    <ErrorStyle BorderStyle="NotSet" CssClass="" />
			...
			<td width="1" height="1" id="TD_line" runat="server"><FONT face="新細明體"></FONT><span style="BORDER-RIGHT: 1px inset; BORDER-TOP: 1px inset; FONT-SIZE: 16px; MARGIN: 0px 3px; BORDER-LEFT: 1px inset; WIDTH: 1px; BORDER-BOTTOM: 1px inset; HEIGHT: 100%"
					clear="all"></span></td>
			<td vAlign="top" id="TD_photo" runat="server">
				<table Class="Normal" border="0">
					<tr Class="NormalBold">
						<td><asp:Label ID="LABEL_photo" runat="server" Text="圖片" meta:resourcekey="LABEL_photoResource1"></asp:Label></td>
					</tr>
					<tr Class="NormalBold">
		...
		<tr>
			<td><SmoothEnterpriseWebControl:inputbutton id="BUTTON_save" runat="server" BorderColor="#606060" BorderWidth="1px" BorderStyle="Solid"
				...
				<SmoothEnterpriseWebControl:inputbutton id="BUTTON_changepwd" runat="server" BorderColor="#606060" BorderWidth="1px" BorderStyle="Solid"
					Font-Names="Arial" Font-Size="12px" BackColor="#C8C8C8" CssClass="NormalBold" Gradient-GradientType="Bottom"
					Text="變更密碼" Font-Bold="True" OnClick="BUTTON_changepwd_Click" meta:resourcekey="BUTTON_changepwdResource1" RunAtCient="False">
					<Gradient GradientEnd="" GradientType="Bottom" GradientBegin=""></Gradient>
