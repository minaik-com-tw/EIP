<%@ page language="C#" masterpagefile="~/_site/layout/Template.master" autoeventwireup="true" inherits="SmoothEnterprise.Web.Application.Manager.IconUrlEdit, App_Web_iconurledit.aspx.cdcab7d2" title="WebForm Edit Page" theme="Default" culture="auto" uiculture="auto" meta:resourcekey="PageResource1" %>
						...
						<tr>
							<td><SmoothEnterpriseWebControl:InputText id="FIELD_category" runat="server"  BackColor="#F0F0F0"
								...
								<asp:CheckBox id="FIELD_cover" runat="server" CssClass="NormalBold" meta:resourcekey="FIELD_coverResource1"></asp:CheckBox><FONT face="新細明體">
									<asp:Label id="LABEL_replace" runat="server" CssClass="NormalBold" meta:resourcekey="LABEL_replaceResource1">取代</asp:Label></FONT>
