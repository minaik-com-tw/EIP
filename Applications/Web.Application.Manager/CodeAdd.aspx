<%@ page language="C#" masterpagefile="~/_site/layout/Template.master" autoeventwireup="true" inherits="SmoothEnterprise.Web.Application.Manager.CodeAdd, App_Web_codeadd.aspx.cdcab7d2" title="WebForm Add Page" theme="Default" culture="auto" uiculture="auto" meta:resourcekey="PageResource1" %>
        ...
        <tr>
            <td valign="top">
                <table>
                    ...
                    <tr>
                        <td>
                            <SmoothEnterpriseWebControl:InputText ID="FIELD_ctype" runat="server" BackColor="#F0F0F0"
                                CssClass="Normal" Required="True" ReadOnly="True" ButtonClick="True" ButtonIconUrl=""
                                DateSeparator="Slash" DateType="YYYYMMDD" ErrorMessage="請輸入「代碼類別」!!" FocusColor=""
                                FormatType="None" HiddenMode="False" HTMLMode="Advance" IsValid="True" meta:resourcekey="FIELD_ctypeResource1"
                    ...
                    <tr>
                        <td>
                            <SmoothEnterpriseWebControl:InputText ID="FIELD_code" TabIndex="101" runat="server"
                                BackColor="#F0F0F0" CssClass="Normal" Required="True" ErrorMessage="請輸入「代碼」!!"
                                MaxLength="2" Personalize="False" ButtonClick="True" ButtonIconUrl="" DateSeparator="Slash"
                                DateType="YYYYMMDD" FocusColor="" FormatType="None" HiddenMode="False" HTMLMode="Advance"
                                IsValid="True" meta:resourcekey="FIELD_codeResource1" OnClickMore="">
                                <Gradient GradientType="Top" GradientBegin="" GradientEnd=""></Gradient>
                    ...
                    <tr>
                        <td>
                            <SmoothEnterpriseWebControl:InputText ID="FIELD_name" TabIndex="102" runat="server"
                                BackColor="#F0F0F0" CssClass="Normal" Required="True" ErrorMessage="請輸入「名稱」!!"
                    ...
                    <tr>
                        <td>
                            <SmoothEnterpriseWebControl:InputText ID="FIELD_seq" TabIndex="104" runat="server"
                                BackColor="#F0F0F0" CssClass="Normal" ErrorMessage="請輸入「順序」!!" MaxLength="2"
                                ButtonClick="True" ButtonIconUrl="" DateSeparator="Slash" DateType="YYYYMMDD"
                                FocusColor="" FormatType="None" HiddenMode="False" HTMLMode="Advance" IsValid="True"
                    ...
                    <tr>
                        <td>
                            <asp:CheckBox ID="FIELD_isdefault" runat="server" /></td>
                    </tr>
                    <tr>
                        <td class="NormalBold">
                    ...
                    <tr>
                        <td>
                            <asp:CheckBox ID="FIELD_enabled" runat="server" Checked="True" /></td>
                    </tr>
                    <tr>
                        <td class="NormalBold">
                    ...
                    <tr>
                        <td>
                            <SmoothEnterpriseWebControl:InputText ID="FIELD_remark" TabIndex="103" runat="server"
                                Width="240px" BackColor="#F0F0F0" CssClass="Normal" ErrorMessage="請輸入「備註」!!"
                                MaxLength="1073741823" TextMode="MultiLine" ButtonClick="True" ButtonIconUrl=""
                                DateSeparator="Slash" DateType="YYYYMMDD" FocusColor="" FormatType="None" HiddenMode="False"
                                HTMLMode="Advance" IsValid="True" meta:resourcekey="FIELD_remarkResource1" OnClickMore=""
    ...
    <table class="Normal" border="0">
        <tr>
            <td>
                ...
                <SmoothEnterpriseWebControl:InputButton ID="SaveNextButton" runat="server" Font-Names="Arial"
                    Font-Size="12px" BorderColor="#606060" BorderWidth="1px" BorderStyle="Solid"
                    BackColor="#C8C8C8" CssClass="NormalBold" Gradient-GradientType="Bottom" Font-Bold="True"
                    Text="儲存後繼續操作" OnClick="SaveButton_Click" meta:resourcekey="SaveNextButtonResource1"
                    RunAtCient="False">
                    <Gradient GradientBegin="" GradientEnd="" GradientType="Bottom" />
                </SmoothEnterpriseWebControl:InputButton>&nbsp;
