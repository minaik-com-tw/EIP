<%@ page language="C#" masterpagefile="~/_site/layout/Template.master" autoeventwireup="true" inherits="SmoothEnterprise.Web.Application.Mail.MailGroupAdd, App_Web_mailgroupadd.aspx.cdcab7d2" theme="Default" culture="auto" uiculture="auto" meta:resourcekey="PageResource1" %>
        ...
        <tr>
            <td valign="top">
                <table>
                    ...
                    <tr>
                        <td>
                            <SmoothEnterpriseWebControl:InputText ID="FIELD_name" runat="server" BackColor="#F0F0F0"
                                CssClass="Normal" ErrorMessage="請輸入「名稱」!!" TabIndex="100" MaxLength="100" Required="True" ButtonClick="True" ButtonIconUrl="" DateSeparator="Slash" DateType="YYYYMMDD" FocusColor="" FormatType="None" HiddenMode="False" HTMLMode="Advance" IsValid="True" meta:resourcekey="FIELD_nameResource1" OnClickMore="" Personalize="False">
                    ...
                    <tr>
                        <td>
                            <SmoothEnterpriseWebControlEnterprise:SelectCode ID="FIELD_mgcategory" runat="server"
                                BackColor="#F0F0F0" CssClass="Normal" CodeType="mgcategory" TextField="name"
                                ValueField="id" ItemAddDisplayed="True" ItemNoneDisplayed="True" ButtonClick="True" ButtonIconUrl="" Editable="False" ErrorMessage="" FadeSpeed="NoFade" IsValid="True" ItemAddUrl="/lib/app/addcode.aspx?ctype=mgcategory" ItemAll-GroupText="" ItemAll-IconUrl="" ItemAll-RowHeight="18" ItemAll-Selected="False" ItemAll-Text="" ItemNone-GroupText="" ItemNone-IconUrl="" ItemNone-RowHeight="18" ItemNone-Selected="False" ItemNone-Text="" ListPosition="Vertical" meta:resourcekey="FIELD_mgcategoryResource1" Mode="Single" TextBoxStyle="ThreeDStyle" Value="">
                                <Gradient GradientType="Top" GradientBegin="" GradientEnd=""></Gradient>
                                <ErrorStyle BorderStyle="NotSet" CssClass="" />
                    ...
                    <tr>
                        <td>
                            <asp:Label ID="LABEL_subscribe" runat="server" Text="是否允許訂閱" CssClass="NormalBold" meta:resourcekey="LABEL_subscribeResource1"></asp:Label></td>
                    </tr>
                    <tr>
                        <td>
                            <SmoothEnterpriseWebControl:CheckBoxList ID="FIELD_subscribe" runat="server" Width="100px"
                                ...
                                <Items>
                                    <SmoothEnterpriseWebControl:CheckBoxListItem Selected="False" Text="Yes" Description=""
                                        Value="Y" GroupText="" meta:resourcekey="CheckBoxListItem1Resource1"></SmoothEnterpriseWebControl:CheckBoxListItem>
                                </Items>
                    ...
                    <tr>
                        <td>
                            <SmoothEnterpriseWebControl:InputText ID="FIELD_remark" runat="server" Width="240px"
                                ...
                                TabIndex="101" MaxLength="1073741823" Height="100px" ButtonClick="True" ButtonIconUrl="" DateSeparator="Slash" DateType="YYYYMMDD" FocusColor="" FormatType="None" HiddenMode="False" HTMLMode="Advance" IsValid="True" meta:resourcekey="FIELD_remarkResource1" OnClickMore="" Personalize="False" Required="False">
                                <Gradient GradientType="Top" GradientBegin="" GradientEnd=""></Gradient>
                                <ErrorStyle BorderStyle="NotSet" CssClass="" />
                            </SmoothEnterpriseWebControl:InputText></td>
                    </tr>
        ...
        <tr>
            <td>
                ...
                <SmoothEnterpriseWebControl:InputButton ID="BUTTON_savenext" runat="server" Text="儲存後繼續操作"
                    ...
                    OnClick="BUTTON_save_Click" meta:resourcekey="BUTTON_savenextResource1" RunAtCient="False">
                    <Gradient GradientBegin="" GradientEnd="" GradientType="Bottom" />
                </SmoothEnterpriseWebControl:InputButton>&nbsp;
