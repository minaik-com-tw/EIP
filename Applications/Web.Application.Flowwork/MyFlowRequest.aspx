<%@ page language="C#" masterpagefile="~/_site/layout/Template.master" autoeventwireup="true" inherits="SmoothEnterprise.Web.Application.Flowwork.MyFlowRequest, App_Web_myflowrequest.aspx.cdcab7d2" stylesheettheme="Default" culture="Auto" uiculture="Auto" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <SmoothEnterpriseWebControlEnterprise:Descriptor ID="ContentDescriptor" runat="server"
        Details="The desciption for this program" Caption="MyFlowRequest List Page" Width="100%"
        ...
        <tr>
            ...
            <td>
                <SmoothEnterpriseWebControl:InputSelect ID="QUERY_reviewstatus" runat="server" BackColor="#F0F0F0"
                    CssClass="Normal" ItemAllDisplayed="True">
                    <Gradient GradientBegin="" GradientEnd="" GradientType="Top" />
                    <Items>
                        <SmoothEnterpriseWebControl:SelectItem ID="QUERY_reviewstatus_SelectItem1" runat="server"
                            ...
                            Selected="False" Style="filter: ;" Text="審核中" Value="Pending" meta:resourcekey="QUERY_reviewstatus_SelectItem1Resource1" />
                ...
                <SmoothEnterpriseWebControl:DataList ID="DataList1" runat="server" BorderColor="Black"
                    ...
                    <Columns>
                        <SmoothEnterpriseWebControl:DataColumn ID="DataList1_edit" Width="1%" DataAlign="Center"
                            DataType="IconEdit" DataStyle-BorderStyle="NotSet" DataStyle-CssClass="" HeaderStyle-BorderStyle="NotSet"
                            HeaderStyle-CssClass="" meta:resourcekey="DataList1_editResource1" runat="server">
                        </SmoothEnterpriseWebControl:DataColumn>
                        <SmoothEnterpriseWebControl:DataColumn ID="DataList1_id" DataType="ViewText" Caption="Id"
                            DataName="id" Visible="False" Sortable="True" DataStyle-BorderStyle="NotSet"
                            DataStyle-CssClass="" HeaderStyle-BorderStyle="NotSet" HeaderStyle-CssClass=""
                            meta:resourcekey="DataList1_idResource1" runat="server">
                        </SmoothEnterpriseWebControl:DataColumn>
                        <SmoothEnterpriseWebControl:DataColumn ID="DataList1_text" DataType="ViewText" Caption="流程資訊"
                            ...
                            DataStyle-CssClass="" HeaderStyle-BorderStyle="NotSet" HeaderStyle-CssClass=""
                            meta:resourcekey="DataList1_textResource1" runat="server">
                        </SmoothEnterpriseWebControl:DataColumn>
                        <SmoothEnterpriseWebControl:DataColumn ID="DataList1_fid" DataType="ViewText" Caption="審核流程"
                            ...
                            DataStyle-CssClass="" HeaderStyle-BorderStyle="NotSet" HeaderStyle-CssClass=""
                            meta:resourcekey="DataList1_fidResource1" runat="server">
                        </SmoothEnterpriseWebControl:DataColumn>
                        <SmoothEnterpriseWebControl:DataColumn ID="DataList1_fnid" DataType="ViewText" Caption="審核節點"
                            DataName="fnid" Visible="False" Sortable="True" DataStyle-BorderStyle="NotSet"
                            DataStyle-CssClass="" HeaderStyle-BorderStyle="NotSet" HeaderStyle-CssClass=""
                            meta:resourcekey="DataList1_fnidResource1" runat="server">
                        </SmoothEnterpriseWebControl:DataColumn>
                        <SmoothEnterpriseWebControl:DataColumn ID="DataList1_requestuid" DataType="ViewText"
                            Caption="提案人員" DataName="requestuid_name" Visible="false" Sortable="True" DataStyle-BorderStyle="NotSet"
                            DataStyle-CssClass="" HeaderStyle-BorderStyle="NotSet" HeaderStyle-CssClass=""
                            meta:resourcekey="DataList1_requestuidResource1" runat="server">
                        </SmoothEnterpriseWebControl:DataColumn>
                        <SmoothEnterpriseWebControl:DataColumn ID="DataList1_requesturl" DataType="ViewText"
                            ...
                            DataStyle-CssClass="" HeaderStyle-BorderStyle="NotSet" HeaderStyle-CssClass=""
                            meta:resourcekey="DataList1_requesturlResource1" runat="server">
                        </SmoothEnterpriseWebControl:DataColumn>
                        <SmoothEnterpriseWebControl:DataColumn ID="DataList1_initdate" DataType="ViewText"
                            Caption="提案時間" DataName="initdate" Sortable="True" DataStyle-BorderStyle="NotSet"
                        ...
                        <SmoothEnterpriseWebControl:DataColumn ID="DataList1_revieweruid" DataType="ViewText"
                            ...
                            DataStyle-CssClass="" HeaderStyle-BorderStyle="NotSet" HeaderStyle-CssClass=""
                            meta:resourcekey="DataList1_revieweruidResource1" runat="server">
                        </SmoothEnterpriseWebControl:DataColumn>
                        <SmoothEnterpriseWebControl:DataColumn ID="DataList1_reviewerurl" DataType="ViewText"
                            ...
                            DataStyle-CssClass="" HeaderStyle-BorderStyle="NotSet" HeaderStyle-CssClass=""
                            meta:resourcekey="DataList1_reviewerurlResource1" runat="server">
                        </SmoothEnterpriseWebControl:DataColumn>
                        <SmoothEnterpriseWebControl:DataColumn ID="DataList1_receivedate" DataType="ViewText"
                            ...
                            DataStyle-CssClass="" HeaderStyle-BorderStyle="NotSet" HeaderStyle-CssClass=""
                            meta:resourcekey="DataList1_receivedateResource1" runat="server">
                        </SmoothEnterpriseWebControl:DataColumn>
                        ...
                        <SmoothEnterpriseWebControl:DataColumn ID="DataList1_reviewdate" DataType="ViewText"
                            ...
                            DataStyle-CssClass="" HeaderStyle-BorderStyle="NotSet" HeaderStyle-CssClass=""
                            meta:resourcekey="DataList1_reviewdateResource1" runat="server">
                        </SmoothEnterpriseWebControl:DataColumn>
                        <SmoothEnterpriseWebControl:DataColumn ID="DataList1_reviewresult" DataType="ViewText"
                            ...
                            DataStyle-CssClass="" HeaderStyle-BorderStyle="NotSet" HeaderStyle-CssClass=""
                            meta:resourcekey="DataList1_reviewresultResource1" runat="server">
                        </SmoothEnterpriseWebControl:DataColumn>
                        <SmoothEnterpriseWebControl:DataColumn ID="DataList1_resulttype" DataType="ViewText"
                            ...
                            DataStyle-CssClass="" HeaderStyle-BorderStyle="NotSet" HeaderStyle-CssClass=""
                            meta:resourcekey="DataList1_resulttypeResource1" runat="server">
                        </SmoothEnterpriseWebControl:DataColumn>
                        <SmoothEnterpriseWebControl:DataColumn ID="DataList1_priority" DataType="ViewText"
                            Caption="優先順序" DataName="priority" Visible="False" Sortable="True" DataStyle-BorderStyle="NotSet"
                            DataStyle-CssClass="" HeaderStyle-BorderStyle="NotSet" HeaderStyle-CssClass=""
                            meta:resourcekey="DataList1_priorityResource1" runat="server">
                        </SmoothEnterpriseWebControl:DataColumn>
                        <SmoothEnterpriseWebControl:DataColumn ID="DataList1_view" Width="1%" DataAlign="Center"
                            DataType="IconView" DataStyle-BorderStyle="NotSet" DataStyle-CssClass="" HeaderStyle-BorderStyle="NotSet"
                            HeaderStyle-CssClass="" meta:resourcekey="DataList1_viewResource1" runat="server">
                        </SmoothEnterpriseWebControl:DataColumn>
                    </Columns>
