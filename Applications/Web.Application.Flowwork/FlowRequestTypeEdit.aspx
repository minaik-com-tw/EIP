<%@ page language="C#" masterpagefile="~/_site/layout/Template.master" autoeventwireup="true" inherits="SmoothEnterprise.Web.Application.Flowwork.FlowRequestTypeEdit, App_Web_flowrequesttypeedit.aspx.cdcab7d2" title="Untitled Page" theme="Default" culture="auto" uiculture="auto" meta:resourcekey="PageResource1" %>
	...
	<table border="0" Class="Normal">
		<tr>
			<td valign="top"><table>
					...
					<tr Class="Normal">
						<td><SmoothEnterpriseWebControl:InputText id="FIELD_requesttype" runat="server"  BackColor="#F0F0F0"
                        ...
                        </SmoothEnterpriseWebControl:inputtext><FONT face="新細明體">&nbsp;or&nbsp;
					...
					<tr>
						<td>
							<SmoothEnterpriseWebControl:InputSelect id="FIELD_fid" runat="server"  ErrorMessage="請輸入「審核流程」!!" backcolor="#F0F0F0"
								cssClass="Normal" Required="True" ButtonClick="True" ButtonIconUrl="/lib/img/icon-downarrow.gif" Editable="False" FadeSpeed="NoFade" IsValid="True" ItemAll-GroupText="" ItemAll-IconUrl="" ItemAll-RowHeight="18" ItemAll-Selected="False" ItemAll-Text="" ItemNone-GroupText="" ItemNone-IconUrl="" ItemNone-RowHeight="18" ItemNone-Selected="False" ItemNone-Text="" ListPosition="Vertical" meta:resourcekey="FIELD_fidResource1" Mode="Single" TextBoxStyle="ThreeDStyle" Value=""><Gradient GradientType="Top" GradientBegin="" GradientEnd=""></Gradient>
                                <ErrorStyle BorderStyle="NotSet" CssClass="" />
