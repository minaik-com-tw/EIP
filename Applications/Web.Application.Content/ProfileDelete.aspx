<%@ page language="C#" masterpagefile="~/_site/layout/Template.master" autoeventwireup="true" inherits="SmoothEnterprise.Web.Application.Content.ProfileDelete, App_Web_profiledelete.aspx.cdcab7d2" title="刪除檔案內容" theme="Default" culture="auto" uiculture="auto" meta:resourcekey="PageResource1" %>
	...
	<table border="0" Class="Normal">
		<tr>
			<td valign="top"><table>
					...
					<tr>
						<td Class="Normal"><SmoothEnterpriseWebControl:InputText id="FIELD_pathname" runat="server" CssClass="PanelWhite" ReadOnly="True" Width="420px"
								Personalize="False" ButtonClick="True" ButtonIconUrl="" DateSeparator="Slash" DateType="YYYYMMDD" ErrorMessage="" FocusColor="" FormatType="None" HiddenMode="False" HTMLMode="Advance" IsValid="True" meta:resourcekey="FIELD_pathnameResource1" OnClickMore="" Required="False">
...
<Gradient GradientType="Top" GradientBegin="" GradientEnd=""></Gradient></SmoothEnterpriseWebControl:inputtext></td>
					...
					<tr>
						<td Class="Normal"><SmoothEnterpriseWebControl:InputText id="FIELD_description" runat="server" CssClass="PanelWhite" ReadOnly="True" Width="420px"
								Personalize="False" ButtonClick="True" ButtonIconUrl="" DateSeparator="Slash" DateType="YYYYMMDD" ErrorMessage="" FocusColor="" FormatType="None" HiddenMode="False" HTMLMode="Advance" IsValid="True" meta:resourcekey="FIELD_descriptionResource1" OnClickMore="" Required="False">
<ErrorStyle BorderStyle="NotSet"></ErrorStyle>
<Gradient GradientType="Top" GradientBegin="" GradientEnd=""></Gradient></SmoothEnterpriseWebControl:inputtext></td>
					</tr>
					<tr>
					...
					<tr>
						<td Class="Normal"><SmoothEnterpriseWebControl:InputText id="FIELD_remark" runat="server" CssClass="PanelWhite" ReadOnly="True" Width="420px"
...
<Gradient GradientType="Top" GradientBegin="" GradientEnd=""></Gradient></SmoothEnterpriseWebControl:inputtext></td>
	...
	<table cellSpacing="0" cellPadding="0" border="0">
		<tr>
			<td style="height: 20px"><SmoothEnterpriseWebControl:inputbutton id="BUTTON_delete" runat="server" Gradient-GradientType="Bottom" CssClass="NormalBold"
