<%@ page language="C#" masterpagefile="~/_site/layout/Template.master" autoeventwireup="true" inherits="SmoothEnterprise.Web.Application.Forum.PostAdd, App_Web_postadd.aspx.cdcab7d2" title="發表文章" theme="Default" culture="auto" uiculture="auto" meta:resourcekey="PageResource1" %>
		...
		<tr>
			<td valign="top"><table>
					...
					<tr><td Class="NormalBold">
						    <asp:Label ID="LABEL_posticonurl" runat="server" Text="文章圖示" meta:resourcekey="LABEL_posticonurlResource1"></asp:Label></td></tr>
                <tr>
                    <td>
                ...
                <tr>
                    <td Class="NormalBold">
                                <asp:Label ID="LABEL_choose" runat="server" meta:resourcekey="LABEL_chooseResource1"
                                    Text="選項"></asp:Label></td>
                </tr>
                <tr>
                    <td>
                                <asp:CheckBox ID="FIELD_notify" runat="server" Text="Email通知：如果有回覆就通知您" meta:resourcekey="FIELD_notifyResource1" /></td>
                </tr>
                <tr>
                    <td>
                                <asp:CheckBox ID="FIELD_quote" runat="server" Text="引用文章" meta:resourcekey="FIELD_quoteResource1" /></td>
                </tr>
				</table>
			</td>
		</tr>
