...
namespace ShppingFlow.Flowwork {
    
    
    public class Shpping_FlowNode1Reviewer {
        ...
        public virtual SmoothEnterprise.Flowwork.Control.FlowReviewerCollection SelectUser(System.Guid requestuid, object parameter, object arguments) {
            ...
            //ds.Open("SELECT id FROM dguser WHERE logonid = 'nico.huang'");
			ds.Open("SELECT id FROM dguser WHERE logonid = 'cindy.lin'");
