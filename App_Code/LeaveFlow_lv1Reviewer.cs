...
namespace HRl.Flowwork {
    ...
    public class LeaveFlow_lv1Node1Reviewer {
    ...
    public class LeaveFlow_lv1Node2Reviewer {
        ...
        public virtual SmoothEnterprise.Flowwork.Control.FlowReviewerCollection CustomUser(System.Guid requestuid, object parameter, object arguments) {
            ...
            rc.Add(new System.Guid(ht["GPU"].ToString()));    //³¡ªù¥DºÞ
            // Put your code to generate custom reviewers
            // Example :
            // rc.Add(userid);
            // rc.Add(userid,text);
    ...
    public class LeaveFlow_lv1Node3Reviewer {
