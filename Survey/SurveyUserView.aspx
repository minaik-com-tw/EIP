<%@ page language="C#" masterpagefile="~/_site/layout/Template.master" autoeventwireup="true" inherits="SmoothEnterprise.Web.Application.Survey.SurveyUserView, App_Web_surveyuserview.aspx.cdcab7d2" title="WebForm View Page" theme="Default" culture="auto" uiculture="auto" meta:resourcekey="PageResource1" %>
				...
				<table>
					<tr>
						<td Class="NormalBold" id="LABEL_nouse_" runat="server">
							<asp:Label id="LABEL_surveyname" runat="server" Text="調查表編號及名稱" meta:resourcekey="LABEL_surveynameResource1"></asp:Label><FONT face="新細明體">&nbsp;
							</FONT>
	...
	<table Class="Normal" border="0">
		...
		<tr>
			<td>
				...
				<SmoothEnterpriseWebControl:InputButton id="CancelResultButton" runat="server" BackColor="#C8C8C8" BorderStyle="Solid" BorderWidth="1px"
					BorderColor="#606060" Font-Size="12px" Font-Names="Arial" Text="取消完成" Font-Bold="True" cssClass="NormalBold" OnClick="CancelResultButton_Click" meta:resourcekey="CancelResultButtonResource1" RunAtCient="False">
					<Gradient GradientType="Bottom" GradientBegin="" GradientEnd=""></Gradient>
				</SmoothEnterpriseWebControl:InputButton>
