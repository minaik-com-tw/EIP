<%@ Page Language="C#" MasterPageFile="~/_site/layout/Template.master" AutoEventWireup="true" CodeFile="cimi100_NewView.aspx.cs" Inherits="ERP_CIMI100.cimi100_NewView" StylesheetTheme="Default" Culture="Auto" UICulture="Auto"%>
...
<script language="javascript"  type="text/javascript" src="<%=ResolveClientUrl("~/sub.js")%>"></script>
     ...
     function onGridViewRowSelected(rowIdx) {   //當gridview選擇修改時  rowIdx-->選擇列
         ...
         document.getElementById("ctl00_ContentPlaceHolder1_FIELD_idel").value=gdview.rows(rownumber).cells(12).innerText.trim(); 
          ...
          for(var i2=0;i2<splits.length;i2++)
          {
           ...
           document.getElementById("ctl00_ContentPlaceHolder1_FIELD_partno").value=gdview.rows(rownumber).cells(14).innerText.trim(); 
           ...
           $('#f_dwg').val(gdview.rows(rownumber).cells(19).innerText.trim());
            ...
            if(gdview.rows(rownumber).cells(28).innerText=="Y")  document.getElementById("ctl00_ContentPlaceHolder1_FIELD_erp_identical").checked=true;
           ...
           $('#A7').val(gdview.rows(rownumber).cells(43).innerText.trim());
            ...
            $('#TextFacSn2').val(gdview.rows(rownumber).cells(251).innerText.trim());
             ...
             divjs(gdview.rows(rownumber).cells(29).innerText.trim());
     ...
     function divjs(a)
     {
        ...
        //全部隱形div  該項顯示-----------------------------------------------------------------
         ...
         var coding=a;
          ...
          document.getElementById("ctl00_ContentPlaceHolder1_ww31").style.display = 'block';
         //---------------------------------------------------------------------------------------

      }
      
      function divjs_noflow()
      {
         document.getElementById("ctl00_ContentPlaceHolder1_ww31").style.display = 'none';
    ...
    <SmoothEnterpriseWebControlEnterprise:Descriptor ID="ContentDescriptor" runat="server" Details="The desciption for this program"
		Caption="cimi100_New View Page" Width="100%" CssClass="Normal" Gradient="None" Height="40%" PaddingSpace="5px">
                        ...
                        <td style="width: 83%; text-align: left">
                            <table style="width: 104%; height: 1px">
                                ...
                                <tr style="font-size: 10pt">
                                    <td id="table1_1" colspan="4" rowspan="6" style="text-align: left; vertical-align: top;">
                                                                                 ...
                                                                                 <td style="width: 100%; height: 99px; vertical-align: top;">
                                                                                    <table border="0" cellpadding="0" cellspacing="0" style="width: 100%; height: 419px">
                                                                                        ...
                                                                                        <tr style="font-size: 12pt">
                                                                                            <td style="width: 104px; background-color: gainsboro; height: 25px;">
                                                                                        ...
                                                                                        <tr style="font-size: 12pt; color: #ff0033">
                                                                                            <td style="background-color: gainsboro; height: 25px; width: 104px;">
                                                                                            ...
                                                                                            <td style="width: 98px; background-color: gainsboro; height: 25px;">
                                                                                                <span style="color: #ff0033">*</span><asp:Label ID="Label21" runat="server" Font-Bold="True" Font-Size="10pt" Text="HSF"
                                                                                                    Width="74px" ForeColor="#000000"></asp:Label></td>
                                                                                            <td style="width: 210px; height: 25px;">
                                                                                                <asp:UpdatePanel ID="UpdatePanel7" runat="server">
                                                                                                    <ContentTemplate>
                                                                                                        <asp:CheckBox ID="FIELD_HSF" runat="server" /><span style="color: #ff0033"> </span>
                                                                                                    </ContentTemplate>
                                                                                                </asp:UpdatePanel>
                                                                                            </td>
                                                                                        </tr>
                                                                                        ...
                                                                                        <tr style="font-size: 12pt">
                                                                                            <td style="background-color: gainsboro; height: 25px; width: 104px;">
                                                                                                <span style="color: #000000">*</span><asp:Label ID="Label7" runat="server" Font-Bold="True" Font-Size="10pt" Text="副分群碼" meta:resourcekey="Label7Resource1"
                                                                                                    Width="90px"></asp:Label></td>
                                                                                        ...
                                                                                        <tr style="font-size: 12pt">
                                                                                            <td style="height: 25px; background-color: gainsboro; width: 104px;">
                                                                                        ...
                                                                                        <tr style="font-size: 12pt">
                                                                                            <td colspan="4" style="background-color: #ffcc66; height: 20px;">
                                                                                                <asp:Label ID="Label161" runat="server" Font-Bold="True" Font-Size="11pt" Text="編碼資料"  meta:resourcekey="Label161Resource1" ></asp:Label></td>
                                                                                        </tr>
                                                                                        <tr style="font-size: 12pt">
                                                                                            <td colspan="4" style="vertical-align: top; height: 68px">
                                                                                                ...
                                                                                                <table border="0" cellpadding="0" cellspacing="0" style="width: 100%; height: 55px;">
                                                                                                    ...
                                                                                                    Width="115px">
                                                                                                     ...
                                                                                                     <div id="ww31" runat="server" style="text-align: left">
                                                                                                     <table   border="0" cellpadding="0" cellspacing="0" style="width: 100%; height: 24px">
                                                                                                    <tr>
                                                                                                        <td style="width: 100px; height: 25px; background-color: gainsboro">
                                                                                                            <span style="color: #ff0033">*</span><asp:Label ID="Label155" runat="server" Font-Bold="True" Font-Size="10pt" Text="料號"  meta:resourcekey="Label155Resource1"
                                                                                                                Width="90px"></asp:Label></td>
                                                                                                        <td style="width: 493px; height: 25px">
                                                                                                            <asp:UpdatePanel ID="UpdatePanel14" runat="server">
                                                                                                            <ContentTemplate>
                                                                                                             <asp:TextBox ID="FIELD_partno" runat="server" MaxLength="20" Width="201px"></asp:TextBox>
                                                                                                            <asp:Button ID="Button1" runat="server" Text="產生料號"   meta:resourcekey="Button1Resource1" OnClick="Button1_Click1"></asp:Button>&nbsp;<br />
                                                                                                                <asp:Button ID="Button2" runat="server" OnClick="Button2_Click"
                                                                                                                    Text="整批產生料號" Visible="False" />
                                                                                                            </ContentTemplate>
                                                                                                            </asp:UpdatePanel>
                                                                                                           </td>
                                                                                                    </tr>
                                                                                                     <tr>
                                                                                                        <td style="width: 100px; height: 25px; background-color: gainsboro">
                                                                                                            <span style="color: #ff0033"></span>&nbsp;
                                                                                                            <asp:Label ID="Label555" runat="server" Font-Bold="True" Font-Size="10pt" Text="是否同料號"  meta:resourcekey="Label555Resource1"
                                                                                                                Width="80px"></asp:Label></td>
                                                                                                        <td style="width: 493px; height: 25px">
                                                                                                            <asp:UpdatePanel ID="UpdatePanel15" runat="server">
                                                                                                                <ContentTemplate>
                                                                                                                    <asp:CheckBox ID="FIELD_ERP_identical" runat="server" AutoPostBack="True" />
                                                                                                                </ContentTemplate>
                                                                                                            </asp:UpdatePanel>
                                                                                                        </td>
                                                                                                    </tr>
                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            <td>
                                                                                                ...
                                                                                                <input id="cate3_2" name="cate3_2"   style="border-left-color: gainsboro; border-bottom-color: gainsboro;
                                                                                                    ...
                                                                                                    border-left-style: solid; background-color: whitesmoke; border-right-color: gainsboro;
                                                                                                    border-bottom-style: solid" type="textbox" /><br />
                                                                                                <asp:UpdatePanel ID="UpdatePanel21" runat="server">
                                                                                                    <ContentTemplate>
                                                                                                        <asp:Label ID="cate3_check" runat="server" Font-Bold="True" Font-Size="10pt" ForeColor="Red"
                                                                                                            Width="432px"></asp:Label>
                                                                                                    </ContentTemplate>
                                                                                                </asp:UpdatePanel>
                                                                                            </td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                            ...
                                                                                            <td>
                                                                                                ...
                                                                                                <asp:UpdatePanel ID="UpdatePanel20" runat="server">
                                                                                                    <ContentTemplate>
                                                                                                        <asp:Label ID="f_partno_check" runat="server" Font-Bold="True" Font-Size="10pt" ForeColor="Red"
                                                                                                             Width="432px"></asp:Label>
                                                                                                    </ContentTemplate>
                                                                                                </asp:UpdatePanel>
                                                                                            </td>
                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            <td>
                                                                                                &nbsp;<input id="Homemade_code" name="Homemade_code" style="border-left-color: gainsboro;
                                                                                                    ...
                                                                                                    border-right-style: solid; border-left-style: solid; background-color: whitesmoke;
                                                                                                    border-right-color: gainsboro; border-bottom-style: solid" type="textbox" />
                                                                                                <input id="Homemade_code2" name="Homemade_code2"  disabled="disabled" style="border-left-color: gainsboro;
                                                     ...
                                                     <asp:UpdatePanel ID="UpdatePanel22" runat="server">
                                                        <ContentTemplate>
                                                            <SmoothEnterpriseWebControl:InputButton ID="Button_UpdateItem" runat="server" BackColor="#C8C8C8"
                                                                ...
                                                                Font-Bold="True" Font-Names="Arial" Font-Size="12px" OnClick="Button_UpdateItem_Click"
                                                                Text="Update Item" Width="80px">
                                                                <Gradient GradientBegin="136, 136, 136" GradientEnd="White" GradientType="Bottom" />
                                                            </SmoothEnterpriseWebControl:InputButton>&nbsp;
                                                            <br />
                                                            <asp:TextBox ID="TextBox1" runat="server" Width="805px" Wrap="False"></asp:TextBox>
                                                    ...
                                                    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                                        <ContentTemplate>
                                                            ...
                                                            <asp:GridView ID="GridView1" runat="server"
                                                                ...
                                                                BorderWidth="2px" CellPadding="3" DataKeyNames="item,elapsedTicks" DataSourceID="SqlDataSource1"
                                                                Font-Size="10pt" GridLines="None" Height="1px" OnRowCommand="GridView1_RowCommand"
                                                                OnRowDataBound="GridView1_RowDataBound"
                                                                Width="1250px" CellSpacing="1">
                                                                <Columns>
                                                                    ...
                                                                    <asp:ButtonField ButtonType="Image" CommandName="editA" ImageUrl="~/shipment/img/edit.gif" />
                                                                    <asp:ButtonField ButtonType="Image" CommandName="Add" ImageUrl="~/shipment/img/page_copy.png" >
                                                                    <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:ButtonField>
                                                                    ...
                                                                    <asp:BoundField DataField="cate1" HeaderText="cate1" SortExpression="cate1" meta:resourcekey="cate1" >
                                                                        
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="cate2" HeaderText="cate2" SortExpression="cate2" meta:resourcekey="cate2" >
                                                                       
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="cate3" HeaderText="cate3" SortExpression="cate3" meta:resourcekey="cate3" >
                                                                    ...
                                                                    <asp:BoundField DataField="p_plantid" HeaderText="生產廠區" meta:resourcekey="p_plantid"
                                                                        SortExpression="p_plantid" />
                                                                    <asp:BoundField DataField="partno" HeaderText="料號" meta:resourcekey="partno" SortExpression="partno" />
                                                                    <asp:BoundField DataField="component" HeaderText="品名" meta:resourcekey="component"
                                                                        SortExpression="component" />
                                                                    <asp:BoundField DataField="dwg" HeaderText="規格" meta:resourcekey="dwg" SortExpression="dwg" />
                                                                    <asp:BoundField DataField="f_partno" HeaderText="預測料號" meta:resourcekey="f_partno"
                                                                        SortExpression="f_partno" />
                                                                    ...
                                                                    <asp:BoundField DataField="unit" HeaderText="庫存單位" meta:resourcekey="unit" SortExpression="unit">
                                                                    ...
                                                                    <asp:BoundField DataField="source_code" HeaderText="來源碼" meta:resourcekey="source_code"
                                                                        SortExpression="source_code">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    ...
                                                                    <asp:BoundField DataField="Q4" HeaderText="Q4" meta:resourcekey="Q4" SortExpression="Q4" />
                                                                    <asp:BoundField DataField="Q5" HeaderText="Q5" meta:resourcekey="Q5" SortExpression="Q5" />
                                                                    <asp:BoundField DataField="Q6" HeaderText="Q6" meta:resourcekey="Q6" SortExpression="Q6" />
                                                                    ...
                                                                    <asp:BoundField DataField="dname" HeaderText="產品別" meta:resourcekey="dname" SortExpression="name" />
                                                                    <asp:BoundField DataField="imz02" HeaderText="分群碼" meta:resourcekey="imz02" SortExpression="imz02" />
                                                                    <asp:BoundField DataField="ename" HeaderText="交易方式" meta:resourcekey="ename" SortExpression="ename" />
                                                                    <asp:BoundField DataField="cname" HeaderText="副分群碼" meta:resourcekey="cname" SortExpression="cname" />
                                                                    <asp:BoundField DataField="remark" HeaderText="備註" meta:resourcekey="remarka" SortExpression="remark">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" style="width: 802px; height: 1px">
                                    <tr>
                                        ...
                                        <td colspan="3" style="width: 667px" id="uploadfiles">
                                            ...
                                            </SmoothEnterpriseWebControl:InputFile><br />
...
<SmoothEnterpriseWebControlFlowwork:FlowResult ID="FlowResult3" runat="server" Text="退回(退至提案人)  " ResultType="Return" meta:resourcekey="FlowResultResource1"></SmoothEnterpriseWebControlFlowwork:FlowResult>
	...
	<table border="0" Class="Normal">
		<tr>
			<td>
				<SmoothEnterpriseWebControl:InputButton ID="BUTTON_back"  meta:resourcekey="BUTTON_backResource1" runat="server" Text="回上頁" width="80px" BackColor="#C8C8C8" BorderColor="#606060" BorderStyle="Solid" BorderWidth="1px" CssClass="NormalBold" Font-Bold="True" Font-Names="Arial" Font-Size="12px" OnClick="BUTTON_back_Click"><Gradient GradientBegin="136, 136, 136" GradientEnd="White" GradientType="Bottom" /></SmoothEnterpriseWebControl:InputButton>
                <SmoothEnterpriseWebControl:InputButton ID="ExcelButton1"  runat="server" Text="Export Excel" width="80px" BackColor="#C8C8C8" BorderColor="#606060" BorderStyle="Solid" BorderWidth="1px" CssClass="NormalBold" Font-Bold="True" Font-Names="Arial" Font-Size="12px" OnClick="ExcelButton1_Click">
                    <Gradient GradientBegin="136, 136, 136" GradientEnd="White" GradientType="Bottom" />
                </SmoothEnterpriseWebControl:InputButton>
                <SmoothEnterpriseWebControl:InputButton ID="button_txt"  runat="server" Text="txt抛轉" width="80px" BackColor="#C8C8C8" BorderColor="#606060" BorderStyle="Solid" BorderWidth="1px" CssClass="NormalBold" Font-Bold="True" Font-Names="Arial" Font-Size="12px" OnClick="button_txt_Click" Visible="False">
                    <Gradient GradientBegin="136, 136, 136" GradientEnd="White" GradientType="Bottom" />
                </SmoothEnterpriseWebControl:InputButton>
			</td>
		</tr>
    ...
    <asp:Button ID="Button4" runat="server" OnClick="Button4_Click" Text="out xml" Visible="False" />
    <br />
</asp:Content>