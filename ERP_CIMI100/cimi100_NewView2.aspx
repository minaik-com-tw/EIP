<%@ Page Language="C#" MasterPageFile="~/_site/layout/Template.master" AutoEventWireup="true" CodeFile="cimi100_NewView2.aspx.cs" Inherits="ERP_CIMI100.cimi100_NewView" StylesheetTheme="Default" Culture="Auto" UICulture="Auto"%>
...
<script language="javascript"  type="text/javascript" src="<%=ResolveClientUrl("~/sub.js")%>"></script>
    ...
    function jsAddItemToSelect(objSelect, objItemText, objItemValue) {        
        ...
        if (jsSelectIsExitItem(objSelect, objItemValue)) {        
            //alert("?Item的Value值已?存在"+objItemValue);        
        } else {        
         ...
         document.getElementById("ctl00_ContentPlaceHolder1_FIELD_idel").value=gdview.rows(rownumber).cells(12).innerText.trim(); 
          ...
          for(var i2=0;i2<splits.length;i2++)
          {
           ...
           $('#f_dwg').val(gdview.rows(rownumber).cells(19).innerText.trim());
            ...
            document.getElementById("ctl00_ContentPlaceHolder1_FIELD_Group2").value=gdview.rows(rownumber).cells(34).innerText.trim(); 
            document.getElementById("ctl00_ContentPlaceHolder1_FIELD_Coding_Class").value=gdview.rows(rownumber).cells(29).innerText.trim(); 
     ...
     function divjs(a)
     {
        ...
        //全部隱形div  該項顯示-----------------------------------------------------------------
         ...
         document.getElementById("ctl00_ContentPlaceHolder1_ww"+coding).style.display = 'block';
          document.getElementById("ctl00_ContentPlaceHolder1_ww30").style.display = 'block';
         //---------------------------------------------------------------------------------------
      ...
      {
         document.getElementById("ctl00_ContentPlaceHolder1_ww30").style.display = 'none';
                                                ...
                                                <td colspan="2" style="height: 250px">
                                                                                                 ...
                                                                                                 <div id="ww29" runat="server" style="text-align: left">
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        ...
                                                                                                        <td style="width: 493px; height: 25px">
                                                                                                            ...
                                                                                                            <asp:Button ID="Button1" runat="server" Text="產生料號"   meta:resourcekey="Button1Resource1" OnClick="Button1_Click1"></asp:Button>
                                                                                                            </ContentTemplate>
                                                                                                            </asp:UpdatePanel>
                                                                                                           </td>
                                                                                                    </tr>
                                                    ...
                                                    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                                        <ContentTemplate>
                                                            ...
                                                            </SmoothEnterpriseWebControl:InputButton><asp:GridView ID="GridView1" runat="server"
                                                                AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None"
                                                                BorderWidth="1px" CellPadding="4" DataKeyNames="item,elapsedTicks" DataSourceID="SqlDataSource1"
                                                                Font-Size="10pt" ForeColor="Black" GridLines="Horizontal" Height="1px" OnRowCommand="GridView1_RowCommand"
	...
	<table border="0" Class="Normal">
		<tr>
			<td>
                ...
                <SmoothEnterpriseWebControl:InputButton ID="button_txt"  runat="server" Text="txt?轉" width="80px" BackColor="#C8C8C8" BorderColor="#606060" BorderStyle="Solid" BorderWidth="1px" CssClass="NormalBold" Font-Bold="True" Font-Names="Arial" Font-Size="12px" OnClick="button_txt_Click" Visible="False">
                    <Gradient GradientBegin="136, 136, 136" GradientEnd="White" GradientType="Bottom" />
                </SmoothEnterpriseWebControl:InputButton>
			</td>
		</tr>
