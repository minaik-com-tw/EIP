<%@ Page Language="C#" MasterPageFile="~/_site/layout/Template.master" AutoEventWireup="true" CodeFile="cimi100_base.aspx.cs" Inherits="ERP_CIMI100.cimi100_base" StylesheetTheme="Default" Culture="Auto" UICulture="Auto"%>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
	...
	<table border="0">
	    <tr class="NormalBold">
 	 	 	...
 	 	 	<td><asp:Label ID="LABEL_bass_class" runat="server" CssClass="NormalBold" Text="資料分類" meta:resourcekey="LABEL_bass_classResource1"></asp:Label></td>
 	 	 	<td><asp:Label ID="LABEL_bass_no" runat="server" CssClass="NormalBold" Text="名稱" meta:resourcekey="LABEL_bass_noResource1"></asp:Label></td>
