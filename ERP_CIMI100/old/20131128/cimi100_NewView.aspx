                                                                                                    ...
                                                                                                    <tr>
                                                                                                        <td style="width: 106px; background-color: gainsboro; height: 25px;">
                                                                                                            <span style="color: #ff0033">*</span><asp:Label ID="Label44" runat="server" Font-Bold="True" Font-Size="10pt" Text="寬度"  meta:resourcekey="Label44Resource1"
                                                                                                                Width="90px"></asp:Label></td>
                                                                                                        <td style="width: 493px; height: 25px;">
                                                                                                            &nbsp;<asp:TextBox ID="J5" runat="server" MaxLength="2" Width="40px"></asp:TextBox></td>
                                                                                                    </tr>
                                                                                                    <tr>
                                                                                                        <td style="width: 106px; background-color: gainsboro; height: 25px;">
                                                    ...
                                                    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                                        <ContentTemplate>
                                                            ...
                                                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:EIPBConnectionString %>"
                                                                DeleteCommand="DELETE FROM cimi100_new WHERE (item = @item) AND (elapsedTicks = @elapsedTicks)"
