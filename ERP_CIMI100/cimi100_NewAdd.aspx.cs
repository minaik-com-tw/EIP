...
namespace ERP_CIMI100
{
    public partial class cimi100_NewAdd : SmoothEnterprise.Web.Page
    {
        ...
        {
            //  string p = "alert('" + this.FIELD_Coding_Class.Text + "')";
            //  ScriptManager.RegisterClientScriptBlock(UpdatePanel1, typeof(UpdatePanel), "aa1",  p, true);
        ...
        protected void Button_AddItem_Click(object sender, EventArgs e)
        {
            ...
            string sql = "SELECT count(*) rc FROM  eipb.dbo.cimi100_new WHERE elapsedTicks='" + this.PK1.Value.ToString() + "'";
            string rowcount = fs.GetTopfile(sql);
            // string shword = "alert('" + sql + "')";
            // ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "Message", shword, true);
        ...
        void gridviewchange(string aa)  //change girdview
        {
            ...
            SqlDataSource1.SelectCommand =
              ...
              "imz02,c.name cname,d.name dname,e.name ename,remark,tc_imi02,tc_imi021,tc_imi03,tc_imi031  " +
        ...
        private bool FIELD_check()
        {
            ...
            // ScriptManager.RegisterClientScriptBlock(UpdatePanel1, typeof(UpdatePanel), "aa1", " alert('"+this.FIELD_Coding_Class.Text+"');", true);
