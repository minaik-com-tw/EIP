...
public partial class cimi100_baseAdd : SmoothEnterprise.Web.Page
{
	...
	protected void BUTTON_save_Click(object sender, System.EventArgs e)
	{
		if (this.IsValid)
		{
           Response.Write("SELECT * FROM " + db1 + "cimi100_base WHERE class_no='" + this.FIELD_class_no.Text + "' and bass_no='" + this.FIELD_bass_no.Text + "' ");
            ...
            rs2.Open("SELECT * FROM " + db1 + "cimi100_base WHERE class_no='" + this.FIELD_class_no.Text + "' and bass_no='" + this.FIELD_bass_no.Text + "' ");
            if (!rs2.EOF)
            {
            ...
            else
            {
                ...
                try
                {
                    ...
                    rs.Open("SELECT * FROM " + db1 + "cimi100_base WHERE 1=0");
                    rs.Add();
