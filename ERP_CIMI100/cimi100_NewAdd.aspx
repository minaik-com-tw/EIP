ＥＲＰＥＲ<%@ Page Language="C#" MasterPageFile="~/_site/layout/Template.master" AutoEventWireup="true" CodeFile="cimi100_NewAdd.aspx.cs" Inherits="ERP_CIMI100.cimi100_NewAdd" StylesheetTheme="Default" Culture="Auto" UICulture="Auto" EnableEventValidation="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <header>
        ...
        <script type="text/javascript">
            ...
            function onGridViewRowSelected(rowIdx) {   //當gridview選擇修改時  rowIdx-->選擇列
                ...
                //         //document.getElementById("ctl00_ContentPlaceHolder1_FIELD_Group").value=gdview.rows(rownumber).cells(6).innerText.trim(); 
                //        // document.getElementById("ctl00_ContentPlaceHolder1_FIELD_product_class").value=gdview.rows(rownumber).cells(7).innerText.trim(); 
    ...
    <SmoothEnterpriseWebControlEnterprise:Descriptor ID="ContentDescriptor" runat="server" Details="The desciption for this program"
        Caption="cimi100_New Add Page" Width="100%" CssClass="Normal" Gradient="None" Height="40%" PaddingSpace="5px">
        <CaptionStyle Font-Bold="True" CssClass="Medium"></CaptionStyle>
        <DetailsStyle Font-Size="11px" Font-Names="Arial" ForeColor="Gray"></DetailsStyle>
    </SmoothEnterpriseWebControlEnterprise:Descriptor>
    <table cellpadding="0" cellspacing="0" style="vertical-align: top; width: 1285px; height: 70px">
        <tr>
        ...
        <tr>
            <td style="width: 357px; height: 21px"></td>
            <td style="width: 1285px; height: 21px; text-align: right">&nbsp;<asp:Label ID="Label4a" runat="server" CssClass="NormalBold" Font-Names="新細明體"
        ...
        <tr style="font-size: 10pt; font-family: Times New Roman">
            <td align="right" colspan="2" style="width: 100%; height: 29px; text-align: right">
                <table border="1" bordercolor="silver" cellpadding="0" cellspacing="0" style="width: 1285px; border-collapse: collapse; height: auto">
                    <tr>
                        <td style="width: 83%; text-align: left">
                            <table style="width: 104%; height: 1px">
                                ...
                                <tr style="font-size: 10pt">
                                    <td id="table1_1" colspan="4" rowspan="6" style="text-align: left; height: 250px;">
                                        <table style="width: 100%">
                                            <tr>
                                                <td colspan="2" style="height: 250px; vertical-align: top;">
                                                    ...
                                                    <table style="width: 100%; height: 300px;">
                                                        <tr>
                                                            <td style="width: 50%; height: 225px">
                                                                <table border="0" style="border-right: goldenrod 1px solid; border-top: goldenrod 1px solid; border-left: goldenrod 1px solid; width: 100%; border-bottom: goldenrod 1px solid; height: 100%">
                                                                    <tr>
                                                                        <td style="width: 100%; height: 99px; vertical-align: top;">
                                                                            <table border="0" cellpadding="0" cellspacing="0" style="width: 100%; height: 419px">
                                                                                ...
                                                                                <tr style="font-size: 12pt">
                                                                                    <td style="width: 102px; background-color: gainsboro; height: 25px;">
                                                                                    ...
                                                                                    <td style="width: 114px; background-color: gainsboro; height: 25px;">
                                                                                ...
                                                                                <tr>
                                                                                    <td style="background-color: gainsboro; height: 25px; width: 102px;">
                                                                                    ...
                                                                                    <td style="width: 114px; background-color: gainsboro; height: 25px;">
                                                                                        <asp:Label ID="Label21" runat="server" Font-Bold="True" Font-Size="10pt" Text="HSF"
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td style="height: 25px;">
                                                                                        <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                                                                                            <ContentTemplate>
                                                                                                &nbsp;<asp:DropDownList ID="FIELD_Group2" runat="server" meta:resourcekey="FIELD_class_noResource1"
                                                                                    ...
                                                                                    <td style="width: 114px; background-color: gainsboro; height: 25px;">
                                                                                        <asp:Label ID="Label22" runat="server" Font-Bold="True" Font-Size="10pt" Text="IQC"
                                                                                ...
                                                                                <tr>
                                                                                    <td style="height: 25px; background-color: gainsboro; width: 102px;">
                                                                                        <span style="color: #ff0033">*</span><asp:Label ID="Label2" runat="server" Font-Bold="True" Font-Size="10pt" Text="品名" meta:resourcekey="componenta"
                                                                                            Width="90px"></asp:Label></td>
                                                                                    <td style="height: 25px">&nbsp;<input id="component" name="component" style="border-left-color: gainsboro; border-bottom-color: gainsboro; width: 200px; border-top-style: solid; border-top-color: gainsboro; border-right-style: solid; border-left-style: solid; background-color: whitesmoke; border-right-color: gainsboro; border-bottom-style: solid"
                                                                                        type="textbox" /></td>
                                                                                    <td style="width: 114px; height: 25px; background-color: gainsboro">&nbsp;
                                                                                                <asp:Label ID="Label14" runat="server" Font-Bold="True" Font-Size="10pt" Text="客戶別" meta:resourcekey="Label14Resource1"
                                                                                                    Width="90px"></asp:Label></td>
                                                                                    <td style="width: 210px; height: 25px">&nbsp;<input id="Customers_class" name="Customers_class" style="border-left-color: gainsboro; border-bottom-color: gainsboro; width: 83px; border-top-style: solid; border-top-color: gainsboro; border-right-style: solid; border-left-style: solid; background-color: whitesmoke; border-right-color: gainsboro; border-bottom-style: solid"
                                                                                        type="textbox" />
                                                                                        <input id="Customers_class2" name="Customers_class2" disabled="disabled" style="border-left-color: gainsboro; border-bottom-color: gainsboro; width: 100px; border-top-style: solid; border-top-color: gainsboro; border-right-style: solid; border-left-style: solid; background-color: whitesmoke; border-right-color: gainsboro; border-bottom-style: solid"
                                                                                            type="textbox" /></td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td style="background-color: gainsboro; height: 25px; width: 102px;">
                                                                                        <span style="color: #ff0033"></span>&nbsp;
                                                                                                <asp:Label ID="Label10" runat="server" Font-Bold="True" Font-Size="10pt" Text="規格" meta:resourcekey="Label10Resource1"
                                                                                                    Width="90px"></asp:Label></td>
                                                                                    <td style="height: 25px;">&nbsp;<input id="DWG" name="DWG" style="border-left-color: gainsboro; border-bottom-color: gainsboro; width: 198px; border-top-style: solid; border-top-color: gainsboro; border-right-style: solid; border-left-style: solid; background-color: whitesmoke; border-right-color: gainsboro; border-bottom-style: solid"
                                                                                        type="textbox" /></td>
                                                                                    <td style="width: 114px; background-color: gainsboro; height: 25px;">&nbsp;
                                                                                                <asp:Label ID="Label12" runat="server" Font-Bold="True" Font-Size="10pt" Text="機種別" meta:resourcekey="Label12Resource1"
                                                                                                    Width="90px"></asp:Label></td>
                                                                                    <td style="width: 210px; height: 25px;">&nbsp;<input id="Model_class" name="Model_class" style="border-left-color: gainsboro; border-bottom-color: gainsboro; width: 83px; border-top-style: solid; border-top-color: gainsboro; border-right-style: solid; border-left-style: solid; background-color: whitesmoke; border-right-color: gainsboro; border-bottom-style: solid"
                                                                                        type="textbox" />
                                                                                        <input id="Model_class2" name="Model_class2" disabled="disabled" style="border-left-color: gainsboro; border-bottom-color: gainsboro; width: 100px; border-top-style: solid; border-top-color: gainsboro; border-right-style: solid; border-left-style: solid; background-color: whitesmoke; border-right-color: gainsboro; border-bottom-style: solid"
                                                                                            type="textbox" /></td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td style="background-color: gainsboro; height: 25px; width: 102px;">
                                                                                    ...
                                                                                    <td colspan="4" style="vertical-align: top; height: 68px">
                                                                                        ...
                                                                                        <div id="ww1" runat="server" style="text-align: left">
                                                                                            <table border="0" cellpadding="0" cellspacing="0" style="width: 100%; height: 55px;">
                                                                                                <tr>
                                                                                                    ...
                                                                                                    <td style="width: 493px; height: 25px;">&nbsp;<input id="A7" name="A7" style="border-left-color: gainsboro; border-bottom-color: gainsboro; width: 100px; border-top-style: solid; border-top-color: gainsboro; border-right-style: solid; border-left-style: solid; background-color: whitesmoke; border-right-color: gainsboro; border-bottom-style: solid"
                                                                                                        type="textbox" />
                                                                                                        <input id="A7_2" name="A7_2" disabled="disabled" style="border-left-color: gainsboro; border-bottom-color: gainsboro; width: 256px; border-top-style: solid; border-top-color: gainsboro; border-right-style: solid; border-left-style: solid; background-color: whitesmoke; border-right-color: gainsboro; border-bottom-style: solid"
                                                                                                            type="textbox" /></td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td style="width: 95px; background-color: gainsboro; height: 25px;">&nbsp;
                                                                                                            <asp:Label ID="LabelA5" runat="server" Font-Bold="True" Font-Size="10pt" Text="版次(非必填)" meta:resourcekey="LabelA5Resource1"
                                                                                                                Width="90px"></asp:Label></td>
                                                                                                    <td style="width: 493px; height: 25px;">&nbsp;<asp:TextBox ID="A8" runat="server" MaxLength="2" Width="40px"></asp:TextBox></td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td style="width: 95px; background-color: gainsboro; height: 25px;">
                                                                                                        <span style="color: #ff0033">*</span><asp:Label ID="Label19" runat="server" Font-Bold="True" Font-Size="10pt" Text="料別" meta:resourcekey="Label19Resource1"
                                                                                                            Width="85px"></asp:Label></td>
                                                                                                    <td style="width: 493px; height: 25px;">&nbsp;<asp:TextBox ID="A9" runat="server" MaxLength="1" Width="40px"></asp:TextBox></td>
                                                                                                </tr>
                                                                                            </table>
                                                                                        </div>
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td style="width: 100px; background-color: gainsboro; height: 25px;">
                                                                                                        <span style="color: #ff0033">*</span><asp:Label ID="Label23" runat="server" Font-Bold="True" Font-Size="10pt" Text="2包材分類" meta:resourcekey="Label23Resource1"
                                                                                                            Width="90px"></asp:Label></td>
                                                                                                    <td style="width: 493px">&nbsp;<asp:DropDownList ID="B2" runat="server" meta:resourcekey="FIELD_class_noResource1"
                                                                                                        Width="115px">
                                                                                                        <asp:ListItem></asp:ListItem>
                                                                                                    </asp:DropDownList></td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td style="width: 100px; background-color: gainsboro; height: 10px;">
                                                                                                        <span style="color: #ff0033">*</span><asp:Label ID="Label24" runat="server" Font-Bold="True" Font-Size="10pt" Text="是否為硬碟" meta:resourcekey="Label24Resource1"
                                                                                                            Width="90px"></asp:Label></td>
                                                                                                    <td style="width: 493px; height: 10px;">&nbsp;<asp:DropDownList ID="B4" runat="server" meta:resourcekey="FIELD_class_noResource1"
                                                                                                        Width="115px">
                                                                                                        <asp:ListItem></asp:ListItem>
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td style="width: 100px; background-color: gainsboro; height: 25px;">
                                                                                                        <span style="color: #ff0033">*</span><asp:Label ID="Label25" runat="server" Font-Bold="True" Font-Size="10pt" Text="3消耗分類" meta:resourcekey="Label25Resource1"
                                                                                                            Width="90px"></asp:Label></td>
                                                                                                    <td style="width: 493px; height: 25px;">&nbsp;<asp:DropDownList ID="C2" runat="server" meta:resourcekey="FIELD_class_noResource1"
                                                                                                        Width="115px">
                                                                                                        <asp:ListItem></asp:ListItem>
                                                                                                    </asp:DropDownList></td>
                                                                                                </tr>
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td style="width: 100px; background-color: gainsboro; height: 25px;">
                                                                                                        <span style="color: #ff0033">*</span><asp:Label ID="Label26" runat="server" Font-Bold="True" Font-Size="10pt" Text="4客戶圖號" meta:resourcekey="Label26Resource1"
                                                                                                            Width="90px"></asp:Label></td>
                                                                                                    <td style="width: 493px; height: 25px;">&nbsp;<asp:TextBox ID="D2" runat="server" MaxLength="19" Width="180px"></asp:TextBox></td>
                                                                                                </tr>
                                                                                            </table>
                                                                                        </div>
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td style="width: 100px; background-color: gainsboro; height: 25px;">
                                                                                                        <span style="color: #ff0033">*</span><asp:Label ID="Label30" runat="server" Font-Bold="True" Font-Size="10pt" Text="5部門碼" meta:resourcekey="Label30Resource1"
                                                                                                            Width="90px"></asp:Label></td>
                                                                                                    <td style="width: 493px; height: 25px;">&nbsp;<asp:DropDownList ID="E5" runat="server" meta:resourcekey="FIELD_class_noResource1"
                                                                                                        Width="115px">
                                                                                                        <asp:ListItem></asp:ListItem>
                                                                                                    </asp:DropDownList></td>
                                                                                                </tr>
                                                                                        ...
                                                                                        <div id="ww6" runat="server" style="text-align: left">
                                                                                            <table border="0" cellpadding="0" cellspacing="0" style="width: 100%; height: 55px;">
                                                                                                <tr>
                                                                                                    ...
                                                                                                    <td style="width: 493px; height: 25px;">&nbsp;<asp:TextBox ID="F4" runat="server" MaxLength="2" Width="55px"></asp:TextBox></td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td style="width: 100px; background-color: gainsboro; height: 25px;">
                                                                                                        <span style="color: #ff0033">*</span><asp:Label ID="Label33" runat="server" Font-Bold="True" Font-Size="10pt" Text="設變流水碼" meta:resourcekey="Label33Resource1"
                                                                                                            Width="90px"></asp:Label></td>
                                                                                                    <td style="width: 493px; height: 25px;">&nbsp;<asp:TextBox ID="F5" runat="server" MaxLength="2" Width="54px"></asp:TextBox></td>
                                                                                                </tr>
                                                                                            </table>
                                                                                        </div>
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td style="width: 100px; background-color: gainsboro; height: 25px;">
                                                                                                        <span style="color: #ff0033">*</span><asp:Label ID="Label102" runat="server" Font-Bold="True" Font-Size="10pt" Text="7零件別" meta:resourcekey="Label102Resource1"
                                                                                                            Width="90px"></asp:Label></td>
                                                                                                    <td style="width: 493px; height: 25px;">&nbsp;<input id="G3" name="G3" style="border-left-color: gainsboro; border-bottom-color: gainsboro; width: 100px; border-top-style: solid; border-top-color: gainsboro; border-right-style: solid; border-left-style: solid; background-color: whitesmoke; border-right-color: gainsboro; border-bottom-style: solid"
                                                                                                        type="textbox" />
                                                                                                        <input id="G3_2" name="G3_2" disabled="disabled" style="border-left-color: gainsboro; border-bottom-color: gainsboro; width: 256px; border-top-style: solid; border-top-color: gainsboro; border-right-style: solid; border-left-style: solid; background-color: whitesmoke; border-right-color: gainsboro; border-bottom-style: solid"
                                                                                                            type="textbox" /></td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td style="width: 100px; height: 25px; background-color: gainsboro">
                                                                                                        <span style="color: #ff0033">*</span><asp:Label ID="Label34" runat="server" Font-Bold="True" Font-Size="10pt" Text="7版次別" meta:resourcekey="Label34Resource1"
                                                                                                            Width="90px"></asp:Label></td>
                                                                                                    <td style="width: 493px; height: 25px">&nbsp;<asp:TextBox ID="G4" runat="server" MaxLength="1" Width="40px"></asp:TextBox></td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td style="width: 100px; background-color: gainsboro; height: 25px;">
                                                                                                        <span style="color: #ff0033">*</span><asp:Label ID="Label35" runat="server" Font-Bold="True" Font-Size="10pt" Text="料別" meta:resourcekey="Label35Resource1"
                                                                                                            Width="90px"></asp:Label></td>
                                                                                                    <td style="width: 493px; height: 25px;">&nbsp;<asp:TextBox ID="G5" runat="server" MaxLength="1" Width="40px"></asp:TextBox></td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td style="width: 100px; background-color: gainsboro; height: 25px;">
                                                                                                        <span style="color: #ff0033">*</span><asp:Label ID="Label36" runat="server" Font-Bold="True" Font-Size="10pt" Text="套別" meta:resourcekey="Label36Resource1"
                                                                                                            Width="90px"></asp:Label></td>
                                                                                                    <td style="width: 493px; height: 25px;">&nbsp;<asp:TextBox ID="G6" runat="server" MaxLength="1" Width="40px"></asp:TextBox></td>
                                                                                                </tr>
                                                                                            </table>
                                                                                        </div>
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td style="width: 100px; background-color: gainsboro; height: 25px;">
                                                                                                        <span style="color: #ff0033">*</span><asp:Label ID="Label37" runat="server" Font-Bold="True" Font-Size="10pt" Text="8客戶圖號" meta:resourcekey="Label37Resource1"
                                                                                                            Width="90px"></asp:Label></td>
                                                                                                    <td style="width: 493px; height: 25px;">&nbsp;<asp:TextBox ID="H2" runat="server" MaxLength="19" Width="180px"></asp:TextBox></td>
                                                                                                </tr>
                                                                                            </table>
                                                                                        </div>
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td style="width: 100px; background-color: gainsboro; height: 25px;">
                                                                                                        <span style="color: #ff0033">*</span><asp:Label ID="Label38" runat="server" Font-Bold="True" Font-Size="10pt" Text="9原料產品別" meta:resourcekey="Label38Resource1"
                                                                                                            Width="90px"></asp:Label></td>
                                                                                                    <td style="width: 493px; height: 25px;">&nbsp;<asp:DropDownList ID="I5" runat="server" meta:resourcekey="FIELD_class_noResource1"
                                                                                                        Width="115px">
                                                                                                        <asp:ListItem></asp:ListItem>
                                                                                                    </asp:DropDownList></td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td style="width: 100px; background-color: gainsboro; height: 25px;">
                                                                                                        <span style="color: #ff0033">*</span><asp:Label ID="Label39" runat="server" Font-Bold="True" Font-Size="10pt" Text="原料分類" meta:resourcekey="Label39Resource1"
                                                                                                            Width="90px"></asp:Label></td>
                                                                                                    <td style="width: 493px; height: 25px;">&nbsp;<asp:DropDownList ID="I7" runat="server" meta:resourcekey="FIELD_class_noResource1"
                                                                                                        Width="115px">
                                                                                                        <asp:ListItem></asp:ListItem>
                                                                                                    </asp:DropDownList></td>
                                                                                                </tr>
                                                                                        ...
                                                                                        <div id="ww10" runat="server" style="text-align: left">
                                                                                            <table border="0" cellpadding="0" cellspacing="0" style="width: 100%; height: 55px;">
                                                                                                <tr>
                                                                                                    ...
                                                                                                    <td style="width: 493px; height: 25px;">&nbsp;<asp:DropDownList ID="J3" runat="server" meta:resourcekey="FIELD_class_noResource1"
                                                                                                        Width="115px">
                                                                                                        <asp:ListItem></asp:ListItem>
                                                                                                    </asp:DropDownList></td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td style="width: 106px; background-color: gainsboro; height: 25px;">
                                                                                                        <span style="color: #ff0033">*</span><asp:Label ID="Label44" runat="server" Font-Bold="True" Font-Size="10pt" Text="寬度" meta:resourcekey="Label44Resource1"
                                                                                                            Width="90px"></asp:Label></td>
                                                                                                    <td style="width: 493px; height: 25px;">&nbsp;<asp:TextBox ID="J5" runat="server" MaxLength="3" Width="40px"></asp:TextBox></td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td style="width: 106px; background-color: gainsboro; height: 25px;">
                                                                                                        <span style="color: #ff0033">*</span><asp:Label ID="Label45" runat="server" Font-Bold="True" Font-Size="10pt" Text="厚度" meta:resourcekey="Label45Resource1"
                                                                                                            Width="90px"></asp:Label></td>
                                                                                                    <td style="width: 493px; height: 25px;">&nbsp;<asp:TextBox ID="J6" runat="server" MaxLength="4" Width="69px"></asp:TextBox></td>
                                                                                                </tr>
                                                                                            </table>
                                                                                        </div>
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td style="width: 100px; background-color: gainsboro; height: 25px;">
                                                                                                        <span style="color: #ff0033">*</span><asp:Label ID="Label46" runat="server" Font-Bold="True" Font-Size="10pt" Text="11化學分類" meta:resourcekey="Label46Resource1"
                                                                                                            Width="90px"></asp:Label></td>
                                                                                                    <td style="width: 493px; height: 25px;">&nbsp;<asp:DropDownList ID="K4" runat="server" meta:resourcekey="FIELD_class_noResource1"
                                                                                                        Width="115px">
                                                                                                        <asp:ListItem></asp:ListItem>
                                                                                                    </asp:DropDownList></td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td style="width: 100px; background-color: gainsboro; height: 25px;">
                                                                                                        <span style="color: #ff0033">*</span><asp:Label ID="Label47" runat="server" Font-Bold="True" Font-Size="10pt" Text="型號流水碼" meta:resourcekey="Label47Resource1"
                                                                                                            Width="90px"></asp:Label></td>
                                                                                                    <td style="width: 493px; height: 25px;">&nbsp;<asp:TextBox ID="K7" runat="server" MaxLength="1" Width="40px"></asp:TextBox></td>
                                                                                                </tr>
                                                                                            </table>
                                                                                        </div>
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td style="width: 100px; background-color: gainsboro; height: 25px;">
                                                                                                        <span style="color: #ff0033">*</span><asp:Label ID="Label49" runat="server" Font-Bold="True" Font-Size="10pt" Text="12材質區分" meta:resourcekey="Label49Resource1"
                                                                                                            Width="90px"></asp:Label></td>
                                                                                                    <td style="width: 493px; height: 25px;">&nbsp;<asp:DropDownList ID="L3" runat="server" meta:resourcekey="FIELD_class_noResource1"
                                                                                                        Width="115px">
                                                                                                        <asp:ListItem></asp:ListItem>
                                                                                                    </asp:DropDownList></td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td style="width: 100px; background-color: gainsboro; height: 25px;">
                                                                                                        <span style="color: #ff0033">*</span><asp:Label ID="Label50" runat="server" Font-Bold="True" Font-Size="10pt" Text="亮度/型態" meta:resourcekey="Label50Resource1"
                                                                                                            Width="90px"></asp:Label></td>
                                                                                                    <td style="width: 493px; height: 25px;">&nbsp;<asp:DropDownList ID="L4" runat="server" meta:resourcekey="FIELD_class_noResource1"
                                                                                                        Width="115px">
                                                                                                        <asp:ListItem></asp:ListItem>
                                                                                                    </asp:DropDownList></td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td style="width: 100px; background-color: gainsboro; height: 25px;">
                                                                                                        <span style="color: #ff0033">*</span><asp:Label ID="Label51" runat="server" Font-Bold="True" Font-Size="10pt" Text="料厚" meta:resourcekey="Label51Resource1"
                                                                                                            Width="90px"></asp:Label></td>
                                                                                                    <td style="width: 493px; height: 25px;">&nbsp;<asp:TextBox ID="L5" runat="server" MaxLength="4" Width="80px"></asp:TextBox></td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td style="width: 100px; background-color: gainsboro; height: 25px;">
                                                                                                        <span style="color: #ff0033">*</span><asp:Label ID="Label52" runat="server" Font-Bold="True" Font-Size="10pt" Text="料寬" meta:resourcekey="Label52Resource1"
                                                                                                            Width="90px"></asp:Label></td>
                                                                                                    <td style="width: 493px; height: 25px;">&nbsp;<asp:TextBox ID="L6" runat="server" MaxLength="3" Width="62px"></asp:TextBox></td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td style="width: 100px; height: 25px; background-color: gainsboro">
                                                                                                        <span style="color: #ff0033">*</span><asp:Label ID="Label48" runat="server" Font-Bold="True" Font-Size="10pt" Text="硬度" meta:resourcekey="Label48Resource1"
                                                                                                            Width="90px"></asp:Label></td>
                                                                                                    <td style="width: 493px; height: 25px">&nbsp;<asp:TextBox ID="L7" runat="server" MaxLength="2" Width="62px"></asp:TextBox></td>
                                                                                                </tr>
                                                                                            </table>
                                                                                        </div>
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td style="width: 100px; background-color: gainsboro; height: 25px;">
                                                                                                        <span style="color: #ff0033">*</span><asp:Label ID="Label53" runat="server" Font-Bold="True" Font-Size="10pt" Text="13鐵材材質" meta:resourcekey="Label53Resource1"
                                                                                                            Width="90px"></asp:Label></td>
                                                                                                    <td style="width: 493px; height: 25px;">&nbsp;<asp:DropDownList ID="M3" runat="server" meta:resourcekey="FIELD_class_noResource1"
                                                                                                        Width="115px">
                                                                                                        <asp:ListItem></asp:ListItem>
                                                                                                    </asp:DropDownList></td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td style="width: 100px; background-color: gainsboro; height: 25px;">
                                                                                                        <span style="color: #ff0033">*</span><asp:Label ID="Label54" runat="server" Font-Bold="True" Font-Size="10pt" Text="亮型/型態" meta:resourcekey="Label54Resource1"
                                                                                                            Width="90px"></asp:Label></td>
                                                                                                    <td style="width: 493px; height: 25px;">&nbsp;<asp:DropDownList ID="M5" runat="server" meta:resourcekey="FIELD_class_noResource1"
                                                                                                        Width="115px">
                                                                                                        <asp:ListItem></asp:ListItem>
                                                                                                    </asp:DropDownList></td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td style="width: 100px; background-color: gainsboro; height: 25px;">
                                                                                                        <span style="color: #ff0033">*</span><asp:Label ID="Label55" runat="server" Font-Bold="True" Font-Size="10pt" Text="料厚" meta:resourcekey="Label55Resource1"
                                                                                                            Width="90px"></asp:Label></td>
                                                                                                    <td style="width: 493px; height: 25px;">&nbsp;<asp:TextBox ID="M6" runat="server" MaxLength="4" Width="80px"></asp:TextBox></td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td style="width: 100px; background-color: gainsboro; height: 25px;">
                                                                                                        <span style="color: #ff0033">*</span><asp:Label ID="Label56" runat="server" Font-Bold="True" Font-Size="10pt" Text="料寬" meta:resourcekey="Label56Resource1"
                                                                                                            Width="90px"></asp:Label></td>
                                                                                                    <td style="width: 493px; height: 25px;">&nbsp;<asp:TextBox ID="M7" runat="server" MaxLength="3" Width="62px"></asp:TextBox></td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td style="width: 100px; height: 25px; background-color: gainsboro">
                                                                                                        <span style="color: #ff0033">*</span><asp:Label ID="Label57" runat="server" Font-Bold="True" Font-Size="10pt" Text="硬度" meta:resourcekey="Label57Resource1"
                                                                                                            Width="90px"></asp:Label></td>
                                                                                                    <td style="width: 493px; height: 25px">&nbsp;<asp:TextBox ID="M8" runat="server" MaxLength="2" Width="62px"></asp:TextBox></td>
                                                                                                </tr>
                                                                                            </table>
                                                                                        </div>
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td style="width: 100px; background-color: gainsboro; height: 25px;">
                                                                                                        <span style="color: #ff0033">*</span><asp:Label ID="Label58" runat="server" Font-Bold="True" Font-Size="10pt" Text="14鐵材材質" meta:resourcekey="Label58Resource1"
                                                                                                            Width="90px"></asp:Label></td>
                                                                                                    <td style="width: 493px; height: 25px;">&nbsp;<asp:DropDownList ID="N3" runat="server" meta:resourcekey="FIELD_class_noResource1"
                                                                                                        Width="115px">
                                                                                                        <asp:ListItem></asp:ListItem>
                                                                                                    </asp:DropDownList></td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td style="width: 100px; background-color: gainsboro; height: 25px;">
                                                                                                        <span style="color: #ff0033">*</span><asp:Label ID="Label63" runat="server" Font-Bold="True" Font-Size="10pt" Text="膠種" meta:resourcekey="Label63Resource1"
                                                                                                            Width="90px"></asp:Label></td>
                                                                                                    <td style="width: 493px; height: 25px;">&nbsp;<asp:DropDownList ID="N4" runat="server" meta:resourcekey="FIELD_class_noResource1"
                                                                                                        Width="115px">
                                                                                                        <asp:ListItem></asp:ListItem>
                                                                                                    </asp:DropDownList></td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td style="width: 100px; background-color: gainsboro; height: 25px;">
                                                                                                        <span style="color: #ff0033">*</span><asp:Label ID="Label59" runat="server" Font-Bold="True" Font-Size="10pt" Text="亮型/型態" meta:resourcekey="Label59Resource1"
                                                                                                            Width="90px"></asp:Label></td>
                                                                                                    <td style="width: 493px; height: 25px;">&nbsp;<asp:DropDownList ID="N5" runat="server" meta:resourcekey="FIELD_class_noResource1"
                                                                                                        Width="115px">
                                                                                                        <asp:ListItem></asp:ListItem>
                                                                                                    </asp:DropDownList></td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td style="width: 100px; background-color: gainsboro; height: 25px;">
                                                                                                        <span style="color: #ff0033">*</span><asp:Label ID="Label60" runat="server" Font-Bold="True" Font-Size="10pt" Text="料厚" meta:resourcekey="Label60Resource1"
                                                                                                            Width="90px"></asp:Label></td>
                                                                                                    <td style="width: 493px; height: 25px;">&nbsp;<asp:TextBox ID="N6" runat="server" MaxLength="4" Width="80px"></asp:TextBox></td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td style="width: 100px; background-color: gainsboro; height: 25px;">
                                                                                                        <span style="color: #ff0033">*</span><asp:Label ID="Label61" runat="server" Font-Bold="True" Font-Size="10pt" Text="料寬" meta:resourcekey="Label61Resource1"
                                                                                                            Width="90px"></asp:Label></td>
                                                                                                    <td style="width: 493px; height: 25px;">&nbsp;<asp:TextBox ID="N7" runat="server" MaxLength="3" Width="62px"></asp:TextBox></td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td style="width: 100px; height: 25px; background-color: gainsboro">
                                                                                                        <span style="color: #ff0033">*</span><asp:Label ID="Label62" runat="server" Font-Bold="True" Font-Size="10pt" Text="硬度" meta:resourcekey="Label62Resource1"
                                                                                                            Width="90px"></asp:Label></td>
                                                                                                    <td style="width: 493px; height: 25px">&nbsp;<asp:TextBox ID="N8" runat="server" MaxLength="2" Width="62px"></asp:TextBox></td>
                                                                                                </tr>
                                                                                            </table>
                                                                                        </div>
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td style="width: 100px; background-color: gainsboro; height: 25px;">
                                                                                                        <span style="color: #ff0033">*</span><asp:Label ID="Label64" runat="server" Font-Bold="True" Font-Size="10pt" Text="15PET+膠種" meta:resourcekey="Label64Resource1"
                                                                                                            Width="90px"></asp:Label></td>
                                                                                                    <td style="width: 493px; height: 25px;">&nbsp;<asp:DropDownList ID="O3" runat="server" meta:resourcekey="FIELD_class_noResource1"
                                                                                                        Width="115px">
                                                                                                        <asp:ListItem></asp:ListItem>
                                                                                                    </asp:DropDownList></td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td style="width: 100px; background-color: gainsboro; height: 25px;">
                                                                                                        <span style="color: #ff0033">*</span><asp:Label ID="Label65" runat="server" Font-Bold="True" Font-Size="10pt" Text="料寬" meta:resourcekey="Label65Resource1"
                                                                                                            Width="90px"></asp:Label></td>
                                                                                                    <td style="width: 493px; height: 25px;">&nbsp;<asp:TextBox ID="O5" runat="server" MaxLength="3" Width="78px"></asp:TextBox></td>
                                                                                                </tr>
                                                                                            </table>
                                                                                        </div>
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td style="width: 100px; background-color: gainsboro; height: 25px;">
                                                                                                        <span style="color: #ff0033">*</span><asp:Label ID="Label66" runat="server" Font-Bold="True" Font-Size="10pt" Text="16PET+膠種" meta:resourcekey="Label66Resource1"
                                                                                                            Width="90px"></asp:Label></td>
                                                                                                    <td style="width: 493px; height: 25px;">&nbsp;<asp:DropDownList ID="P3" runat="server" meta:resourcekey="FIELD_class_noResource1"
                                                                                                        Width="115px">
                                                                                                        <asp:ListItem></asp:ListItem>
                                                                                                    </asp:DropDownList></td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td style="width: 100px; height: 25px; background-color: gainsboro">
                                                                                                        <span style="color: #ff0033">*</span><asp:Label ID="Label68" runat="server" Font-Bold="True" Font-Size="10pt" Text="料厚" meta:resourcekey="Label68Resource1"
                                                                                                            Width="90px"></asp:Label></td>
                                                                                                    <td style="width: 493px; height: 25px">&nbsp;<asp:TextBox ID="P5" runat="server" MaxLength="4" Width="80px"></asp:TextBox></td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td style="width: 100px; background-color: gainsboro; height: 25px;">
                                                                                                        <span style="color: #ff0033">*</span><asp:Label ID="Label67" runat="server" Font-Bold="True" Font-Size="10pt" Text="料寬" meta:resourcekey="Label67Resource1"
                                                                                                            Width="90px"></asp:Label></td>
                                                                                                    <td style="width: 493px; height: 25px;">&nbsp;<asp:TextBox ID="P6" runat="server" MaxLength="3" Width="62px"></asp:TextBox></td>
                                                                                                </tr>
                                                                                            </table>
                                                                                        </div>
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td style="width: 100px; height: 25px; background-color: gainsboro">
                                                                                                        <span style="color: #ff0033">*</span><asp:Label ID="Label72" runat="server" Font-Bold="True" Font-Size="10pt" Text="機台中分類" meta:resourcekey="Label72Resource1"
                                                                                                            Width="90px"></asp:Label></td>
                                                                                                    <td style="width: 493px; height: 25px">&nbsp;<asp:TextBox ID="Q5" runat="server" MaxLength="2" Width="40px"></asp:TextBox></td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td style="width: 100px; height: 25px; background-color: gainsboro">
                                                                                                        <span style="color: #ff0033">*</span><asp:Label ID="Label101" runat="server" Font-Bold="True" Font-Size="10pt" Text="機台小分類" meta:resourcekey="Label101Resource1"
                                                                                                            Width="90px"></asp:Label></td>
                                                                                                    <td style="width: 493px; height: 25px">&nbsp;<asp:TextBox ID="Q6" runat="server" MaxLength="2" Width="40px"></asp:TextBox></td>
                                                                                                </tr>
                                                                                            </table>
                                                                                        </div>
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td style="width: 100px; background-color: gainsboro; height: 25px;">
                                                                                                        <span style="color: #ff0033">*</span><asp:Label ID="Label5SS" runat="server" Font-Bold="True" Font-Size="10pt" Text="18流水碼(非必填)" meta:resourcekey="Label5SSResource1"
                                                                                                            Width="90px"></asp:Label></td>
                                                                                                    <td style="width: 493px; height: 25px;">&nbsp;<asp:TextBox ID="R4" runat="server" MaxLength="2" Width="62px"></asp:TextBox></td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td style="width: 100px; background-color: gainsboro; height: 25px;">
                                                                                                        <span style="color: #ff0033">*</span><asp:Label ID="Label73" runat="server" Font-Bold="True" Font-Size="10pt" Text="設變流水碼" meta:resourcekey="Label73Resource1"
                                                                                                            Width="90px"></asp:Label></td>
                                                                                                    <td style="width: 493px; height: 25px;">&nbsp;<asp:TextBox ID="R5" runat="server" MaxLength="2" Width="62px"></asp:TextBox></td>
                                                                                                </tr>
                                                                                            </table>
                                                                                        </div>
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td style="width: 100px; background-color: gainsboro; height: 25px;">
                                                                                                        <span style="color: #ff0033">*</span><asp:Label ID="Label74" runat="server" Font-Bold="True" Font-Size="10pt" Text="19零件別" meta:resourcekey="Label74Resource1"
                                                                                                            Width="90px"></asp:Label></td>
                                                                                                    <td style="width: 493px; height: 25px;">&nbsp;<input id="S3" name="S3" style="border-left-color: gainsboro; border-bottom-color: gainsboro; width: 100px; border-top-style: solid; border-top-color: gainsboro; border-right-style: solid; border-left-style: solid; background-color: whitesmoke; border-right-color: gainsboro; border-bottom-style: solid"
                                                                                                        type="textbox" />
                                                                                                        <input id="S3_2" name="S3_2" disabled="disabled" style="border-left-color: gainsboro; border-bottom-color: gainsboro; width: 256px; border-top-style: solid; border-top-color: gainsboro; border-right-style: solid; border-left-style: solid; background-color: whitesmoke; border-right-color: gainsboro; border-bottom-style: solid"
                                                                                                            type="textbox" /></td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td style="width: 100px; background-color: gainsboro; height: 25px;">
                                                                                                        <span style="color: #ff0033">*</span><asp:Label ID="Label75" runat="server" Font-Bold="True" Font-Size="10pt" Text="料別" meta:resourcekey="Label75Resource1"
                                                                                                            Width="90px"></asp:Label></td>
                                                                                                    <td style="width: 493px; height: 25px;">&nbsp;<asp:TextBox ID="S5" runat="server" MaxLength="1" Width="45px"></asp:TextBox></td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td style="width: 100px; height: 25px; background-color: gainsboro">
                                                                                                        <span style="color: #ff0033">*</span><asp:Label ID="Label5s" runat="server" Font-Bold="True" Font-Size="10pt" Text="套別" meta:resourcekey="Label5sResource1"
                                                                                                            Width="90px"></asp:Label></td>
                                                                                                    <td style="width: 493px; height: 25px">&nbsp;<asp:TextBox ID="S6" runat="server" MaxLength="1" Width="45px"></asp:TextBox></td>
                                                                                                </tr>
                                                                                            </table>
                                                                                        </div>
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td style="width: 100px; background-color: gainsboro; height: 25px;">
                                                                                                        <span style="color: #ff0033">*</span><asp:Label ID="Label5SX" runat="server" Font-Bold="True" Font-Size="10pt" Text="20流水碼(非必填)" meta:resourcekey="Label5SXResource1"
                                                                                                            Width="90px"></asp:Label></td>
                                                                                                    <td style="width: 493px; height: 25px;">&nbsp;<asp:TextBox ID="T4" runat="server" MaxLength="2" Width="40px"></asp:TextBox></td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td style="width: 100px; background-color: gainsboro; height: 25px;">
                                                                                                        <span style="color: #ff0033">*</span><asp:Label ID="Label76" runat="server" Font-Bold="True" Font-Size="10pt" Text="設變流水碼" meta:resourcekey="Label76Resource1"
                                                                                                            Width="90px"></asp:Label></td>
                                                                                                    <td style="width: 493px; height: 25px;">&nbsp;<asp:TextBox ID="T5" runat="server" MaxLength="2" Width="40px"></asp:TextBox></td>
                                                                                                </tr>
                                                                                            </table>
                                                                                        </div>
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td style="width: 100px; background-color: gainsboro; height: 25px;">
                                                                                                        <span style="color: #ff0033">*</span><asp:Label ID="Label77" runat="server" Font-Bold="True" Font-Size="10pt" Text="21產品種類" meta:resourcekey="Label77Resource1"
                                                                                                            Width="90px"></asp:Label></td>
                                                                                                    <td style="width: 493px; height: 25px;">&nbsp;<asp:DropDownList ID="U3" runat="server" meta:resourcekey="FIELD_class_noResource1"
                                                                                                        Width="115px">
                                                                                                        <asp:ListItem></asp:ListItem>
                                                                                                    </asp:DropDownList></td>
                                                                                                </tr>
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td style="width: 100px; background-color: gainsboro; height: 25px;">
                                                                                                        <span style="color: #ff0033">*</span><asp:Label ID="Label78" runat="server" Font-Bold="True" Font-Size="10pt" Text="22電子料種類" meta:resourcekey="Label78Resource1"
                                                                                                            Width="90px"></asp:Label></td>
                                                                                                    <td style="width: 493px; height: 25px;">&nbsp;<asp:DropDownList ID="V4" runat="server" meta:resourcekey="FIELD_class_noResource1"
                                                                                                        Width="115px">
                                                                                                        <asp:ListItem></asp:ListItem>
                                                                                                    </asp:DropDownList></td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td style="width: 100px; background-color: gainsboro; height: 25px;">
                                                                                                        <span style="color: #ff0033">*</span><asp:Label ID="Label79" runat="server" Font-Bold="True" Font-Size="10pt" Text="電子類編碼" meta:resourcekey="Label79Resource1"
                                                                                                            Width="90px"></asp:Label></td>
                                                                                                    <td style="width: 493px; height: 25px;">&nbsp;<asp:TextBox ID="V5" runat="server" MaxLength="12" Width="180px"></asp:TextBox></td>
                                                                                                </tr>
                                                                                            </table>
                                                                                        </div>
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td style="width: 100px; background-color: gainsboro; height: 25px;">
                                                                                                        <span style="color: #ff0033">*</span><asp:Label ID="Label80" runat="server" Font-Bold="True" Font-Size="10pt" Text="23客戶圖號" meta:resourcekey="Label80Resource1"
                                                                                                            Width="90px"></asp:Label></td>
                                                                                                    <td style="width: 493px; height: 25px;">&nbsp;<asp:TextBox ID="W2" runat="server" MaxLength="19" Width="180px"></asp:TextBox></td>
                                                                                                </tr>
                                                                                            </table>
                                                                                        </div>
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td style="width: 100px; background-color: gainsboro; height: 25px;">
                                                                                                        <span style="color: #ff0033">*</span><asp:Label ID="Label81" runat="server" Font-Bold="True" Font-Size="10pt" Text="24材質區分" meta:resourcekey="Label81Resource1"
                                                                                                            Width="90px"></asp:Label></td>
                                                                                                    <td style="width: 493px; height: 25px;">&nbsp;<asp:DropDownList ID="X3" runat="server" meta:resourcekey="FIELD_class_noResource1"
                                                                                                        Width="115px">
                                                                                                        <asp:ListItem></asp:ListItem>
                                                                                                    </asp:DropDownList></td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td style="width: 100px; background-color: gainsboro; height: 25px;">
                                                                                                        <span style="color: #ff0033">*</span><asp:Label ID="Label82" runat="server" Font-Bold="True" Font-Size="10pt" Text="亮型/型態" meta:resourcekey="Label82Resource1"
                                                                                                            Width="90px"></asp:Label></td>
                                                                                                    <td style="width: 493px; height: 25px;">&nbsp;<asp:DropDownList ID="X4" runat="server" meta:resourcekey="FIELD_class_noResource1"
                                                                                                        Width="115px">
                                                                                                        <asp:ListItem></asp:ListItem>
                                                                                                    </asp:DropDownList></td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td style="width: 100px; background-color: gainsboro; height: 25px;">
                                                                                                        <span style="color: #ff0033">*</span><asp:Label ID="Label83" runat="server" Font-Bold="True" Font-Size="10pt" Text="料厚" meta:resourcekey="Label83Resource1"
                                                                                                            Width="90px"></asp:Label></td>
                                                                                                    <td style="width: 493px; height: 25px;">&nbsp;<asp:TextBox ID="X5" runat="server" MaxLength="4" Width="80px"></asp:TextBox></td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td style="width: 100px; background-color: gainsboro; height: 25px;">
                                                                                                        <span style="color: #ff0033">*</span><asp:Label ID="Label84" runat="server" Font-Bold="True" Font-Size="10pt" Text="料寬" meta:resourcekey="Label84Resource1"
                                                                                                            Width="90px"></asp:Label></td>
                                                                                                    <td style="width: 493px; height: 25px;">&nbsp;<asp:TextBox ID="X6" runat="server" MaxLength="3" Width="62px"></asp:TextBox></td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td style="width: 100px; height: 25px; background-color: gainsboro">
                                                                                                        <span style="color: #ff0033">*</span><asp:Label ID="Label85" runat="server" Font-Bold="True" Font-Size="10pt" Text="硬度" meta:resourcekey="Label85Resource1"
                                                                                                            Width="90px"></asp:Label></td>
                                                                                                    <td style="width: 493px; height: 25px">&nbsp;<asp:TextBox ID="X7" runat="server" MaxLength="2" Width="62px"></asp:TextBox></td>
                                                                                                </tr>
                                                                                            </table>
                                                                                        </div>
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td style="width: 100px; background-color: gainsboro; height: 25px;">
                                                                                                        <span style="color: #ff0033">*</span><asp:Label ID="Label86" runat="server" Font-Bold="True" Font-Size="10pt" Text="25材質區分" meta:resourcekey="Label86Resource1"
                                                                                                            Width="90px"></asp:Label></td>
                                                                                                    <td style="width: 493px">&nbsp;<asp:DropDownList ID="Y3" runat="server" meta:resourcekey="FIELD_class_noResource1"
                                                                                                        Width="115px">
                                                                                                        <asp:ListItem></asp:ListItem>
                                                                                                    </asp:DropDownList></td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td style="width: 100px; background-color: gainsboro; height: 25px;">
                                                                                                        <span style="color: #ff0033">*</span><asp:Label ID="Label87" runat="server" Font-Bold="True" Font-Size="10pt" Text="亮型/型態" meta:resourcekey="Label87Resource1"
                                                                                                            Width="90px"></asp:Label></td>
                                                                                                    <td style="width: 493px">&nbsp;<asp:DropDownList ID="Y5" runat="server" meta:resourcekey="FIELD_class_noResource1"
                                                                                                        Width="115px">
                                                                                                        <asp:ListItem></asp:ListItem>
                                                                                                    </asp:DropDownList></td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td style="width: 100px; background-color: gainsboro; height: 25px;">
                                                                                                        <span style="color: #ff0033">*</span><asp:Label ID="Label88" runat="server" Font-Bold="True" Font-Size="10pt" Text="料厚" meta:resourcekey="Label88Resource1"
                                                                                                            Width="90px"></asp:Label></td>
                                                                                                    <td style="width: 493px">&nbsp;<asp:TextBox ID="Y6" runat="server" MaxLength="4" Width="80px"></asp:TextBox></td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td style="width: 100px; background-color: gainsboro; height: 25px;">
                                                                                                        <span style="color: #ff0033">*</span><asp:Label ID="Label89" runat="server" Font-Bold="True" Font-Size="10pt" Text="料寬" meta:resourcekey="Label89Resource1"
                                                                                                            Width="90px"></asp:Label></td>
                                                                                                    <td style="width: 493px;">&nbsp;<asp:TextBox ID="Y7" runat="server" MaxLength="3" Width="62px"></asp:TextBox></td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td style="width: 100px; height: 25px; background-color: gainsboro">
                                                                                                        <span style="color: #ff0033">*</span><asp:Label ID="Label90" runat="server" Font-Bold="True" Font-Size="10pt" Text="硬度" meta:resourcekey="Label90Resource1"
                                                                                                            Width="90px"></asp:Label></td>
                                                                                                    <td style="width: 493px;">&nbsp;<asp:TextBox ID="Y8" runat="server" MaxLength="2" Width="62px"></asp:TextBox></td>
                                                                                                </tr>
                                                                                            </table>
                                                                                        </div>
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td style="width: 100px; background-color: gainsboro; height: 25px;">
                                                                                                        <span style="color: #ff0033">*</span><asp:Label ID="Label91" runat="server" Font-Bold="True" Font-Size="10pt" Text="26鐵材材質" meta:resourcekey="Label91Resource1"
                                                                                                            Width="90px"></asp:Label></td>
                                                                                                    <td style="width: 493px; height: 25px;">&nbsp;<asp:DropDownList ID="Z3" runat="server" meta:resourcekey="FIELD_class_noResource1"
                                                                                                        Width="115px">
                                                                                                        <asp:ListItem></asp:ListItem>
                                                                                                    </asp:DropDownList></td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td style="width: 100px; background-color: gainsboro; height: 25px;">
                                                                                                        <span style="color: #ff0033">*</span><asp:Label ID="Label92" runat="server" Font-Bold="True" Font-Size="10pt" Text="膠種" meta:resourcekey="Label92Resource1"
                                                                                                            Width="90px"></asp:Label></td>
                                                                                                    <td style="width: 493px; height: 25px;">&nbsp;<asp:DropDownList ID="Z4" runat="server" meta:resourcekey="FIELD_class_noResource1"
                                                                                                        Width="115px">
                                                                                                        <asp:ListItem></asp:ListItem>
                                                                                                    </asp:DropDownList></td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td style="width: 100px; background-color: gainsboro; height: 25px;">
                                                                                                        <span style="color: #ff0033">*</span><asp:Label ID="Label93" runat="server" Font-Bold="True" Font-Size="10pt" Text="亮型/型態" meta:resourcekey="Label93Resource1"
                                                                                                            Width="90px"></asp:Label></td>
                                                                                                    <td style="width: 493px; height: 25px;">&nbsp;<asp:DropDownList ID="Z5" runat="server" meta:resourcekey="FIELD_class_noResource1"
                                                                                                        Width="115px">
                                                                                                        <asp:ListItem></asp:ListItem>
                                                                                                    </asp:DropDownList></td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td style="width: 100px; background-color: gainsboro; height: 25px;">
                                                                                                        <span style="color: #ff0033">*</span><asp:Label ID="Label94" runat="server" Font-Bold="True" Font-Size="10pt" Text="料厚" meta:resourcekey="Label94Resource1"
                                                                                                            Width="90px"></asp:Label></td>
                                                                                                    <td style="width: 493px; height: 25px;">&nbsp;<asp:TextBox ID="Z6" runat="server" MaxLength="4" Width="80px"></asp:TextBox></td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td style="width: 100px; background-color: gainsboro; height: 25px;">
                                                                                                        <span style="color: #ff0033">*</span><asp:Label ID="Label95" runat="server" Font-Bold="True" Font-Size="10pt" Text="料寬" meta:resourcekey="Label95Resource1"
                                                                                                            Width="90px"></asp:Label></td>
                                                                                                    <td style="width: 493px; height: 25px;">&nbsp;<asp:TextBox ID="Z7" runat="server" MaxLength="3" Width="62px"></asp:TextBox></td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td style="width: 100px; height: 25px; background-color: gainsboro">
                                                                                                        <span style="color: #ff0033">*</span><asp:Label ID="Label96" runat="server" Font-Bold="True" Font-Size="10pt" Text="硬度" meta:resourcekey="Label96Resource1"
                                                                                                            Width="90px"></asp:Label></td>
                                                                                                    <td style="width: 493px; height: 25px">&nbsp;<asp:TextBox ID="Z8" runat="server" MaxLength="2" Width="62px"></asp:TextBox></td>
                                                                                                </tr>
                                                                                            </table>
                                                                                        </div>
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td style="width: 100px; background-color: gainsboro; height: 25px;">
                                                                                                        <span style="color: #ff0033">*</span><asp:Label ID="Label97" runat="server" Font-Bold="True" Font-Size="10pt" Text="27零件別" meta:resourcekey="Label97Resource1"
                                                                                                            Width="90px"></asp:Label></td>
                                                                                                    <td style="width: 493px; height: 25px;">&nbsp;<input id="AA7" name="AA7" style="border-left-color: gainsboro; border-bottom-color: gainsboro; width: 100px; border-top-style: solid; border-top-color: gainsboro; border-right-style: solid; border-left-style: solid; background-color: whitesmoke; border-right-color: gainsboro; border-bottom-style: solid"
                                                                                                        type="textbox" />
                                                                                                        <input id="AA7_2" name="AA7_2" disabled="disabled" style="border-left-color: gainsboro; border-bottom-color: gainsboro; width: 256px; border-top-style: solid; border-top-color: gainsboro; border-right-style: solid; border-left-style: solid; background-color: whitesmoke; border-right-color: gainsboro; border-bottom-style: solid"
                                                                                                            type="textbox" /></td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td style="width: 100px; background-color: gainsboro; height: 25px;">
                                                                                                        <span style="color: #ff0033">*</span><asp:Label ID="Label98" runat="server" Font-Bold="True" Font-Size="10pt" Text="版次" meta:resourcekey="Label98Resource1"
                                                                                                            Width="90px"></asp:Label></td>
                                                                                                    <td style="width: 493px; height: 25px;">&nbsp;<asp:TextBox ID="AA8" runat="server" MaxLength="2" Width="62px"></asp:TextBox></td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td style="width: 100px; background-color: gainsboro; height: 25px;">
                                                                                                        <span style="color: #ff0033">*</span><asp:Label ID="Label99" runat="server" Font-Bold="True" Font-Size="10pt" Text="供應商" meta:resourcekey="Label99Resource1"
                                                                                                            Width="90px"></asp:Label></td>
                                                                                                    <td style="width: 493px; height: 25px;">&nbsp;<asp:TextBox ID="AA9" runat="server" MaxLength="2" Width="61px"></asp:TextBox></td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td style="width: 100px; background-color: gainsboro; height: 25px;">
                                                                                                        <span style="color: #ff0033">*</span><asp:Label ID="Label100" runat="server" Font-Bold="True" Font-Size="10pt" Text="回收" meta:resourcekey="Label100Resource1"
                                                                                                            Width="90px"></asp:Label></td>
                                                                                                    <td style="width: 493px; height: 25px;">&nbsp;<asp:TextBox ID="AA10" runat="server" MaxLength="1" Width="33px"></asp:TextBox></td>
                                                                                                </tr>
                                                                                            </table>
                                                                                        </div>
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td style="width: 100px; background-color: gainsboro; height: 25px;">
                                                                                                        <span style="color: #ff0033">*</span><asp:Label ID="Label103" runat="server" Font-Bold="True" Font-Size="10pt" Text="28塑膠種類" meta:resourcekey="Label103Resource1"
                                                                                                            Width="90px"></asp:Label></td>
                                                                                                    <td style="width: 493px; height: 25px;">&nbsp;<asp:DropDownList ID="AB6" runat="server" meta:resourcekey="FIELD_class_noResource1"
                                                                                                        Width="115px">
                                                                                                        <asp:ListItem></asp:ListItem>
                                                                                                    </asp:DropDownList></td>
                                                                                                </tr>
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td style="width: 100px; background-color: gainsboro; height: 25px;">
                                                                                                        <span style="color: #ff0033">*</span><asp:Label ID="Label105" runat="server" Font-Bold="True" Font-Size="10pt" Text="29包材分類" meta:resourcekey="Label105Resource1"
                                                                                                            Width="90px"></asp:Label></td>
                                                                                                    <td style="width: 493px; height: 25px;">&nbsp;<asp:DropDownList ID="AC2" runat="server" meta:resourcekey="FIELD_class_noResource1"
                                                                                                        Width="115px">
                                                                                                        <asp:ListItem></asp:ListItem>
                                                                                                    </asp:DropDownList></td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td style="width: 100px; background-color: gainsboro; height: 25px;">
                                                                                                        <span style="color: #ff0033">*</span><asp:Label ID="Label106" runat="server" Font-Bold="True" Font-Size="10pt" Text="是否為硬碟" meta:resourcekey="Label106Resource1"
                                                                                                            Width="90px"></asp:Label></td>
                                                                                                    <td style="width: 493px; height: 25px;">&nbsp;<asp:DropDownList ID="AC4" runat="server" meta:resourcekey="FIELD_class_noResource1"
                                                                                                        Width="115px">
                                                                                                        <asp:ListItem></asp:ListItem>
                                                                                                        <asp:ListItem Value="1">Y</asp:ListItem>
                                                                                                        <asp:ListItem Value="2">N</asp:ListItem>
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td style="width: 100px; background-color: gainsboro; height: 25px;">
                                                                                                        <span style="color: #ff0033">*</span><asp:Label ID="Label104" runat="server" Font-Bold="True" Font-Size="10pt" Text="版次" meta:resourcekey="Label104Resource1"
                                                                                                            Width="90px"></asp:Label></td>
                                                                                                    <td style="width: 493px; height: 25px;">&nbsp;<asp:TextBox ID="AC6" runat="server" MaxLength="2" Width="61px"></asp:TextBox></td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td style="width: 100px; background-color: gainsboro; height: 25px;">
                                                                                                        <span style="color: #ff0033">*</span><asp:Label ID="Label107" runat="server" Font-Bold="True" Font-Size="10pt" Text="料別" meta:resourcekey="Label107Resource1"
                                                                                                            Width="90px"></asp:Label></td>
                                                                                                    <td style="width: 493px; height: 25px;">&nbsp;<asp:TextBox ID="AC7" runat="server" MaxLength="1" Width="33px"></asp:TextBox></td>
                                                                                                </tr>
                                                                                            </table>
                                                                                        </div>
                                                                                        <div id="ww30" runat="server" style="text-align: left">
                                                                                            <table border="0" cellpadding="0" cellspacing="0" style="width: 100%; height: 55px;">
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td style="width: 100px; height: 25px; background-color: gainsboro"></td>
                                                                                                    <td style="width: 493px; height: 25px"></td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td style="width: 100px; height: 25px; background-color: gainsboro"></td>
                                                                                                    <td style="width: 493px; height: 25px"></td>
                                                            ...
                                                            <td style="width: 600px; height: 225px">
                                                                <table border="0" style="border-right: goldenrod 1px solid; border-top: goldenrod 1px solid; border-left: goldenrod 1px solid; width: 100%; border-bottom: goldenrod 1px solid; height: 100%">
                                                                    <tr>
                                                                        <td style="width: 50%; height: 100px; vertical-align: top; text-align: right;">
                                                                            <table border="0" cellpadding="0" cellspacing="0" style="width: 100%; height: 370px">
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td>&nbsp;<input id="cate3" name="cate3" style="border-left-color: gainsboro; border-bottom-color: gainsboro; width: 93px; border-top-style: solid; border-top-color: gainsboro; border-right-style: solid; border-left-style: solid; background-color: whitesmoke; border-right-color: gainsboro; border-bottom-style: solid"
                                                                                        type="textbox" />
                                                                                        <input id="cate3_2" name="cate3_2" style="border-left-color: gainsboro; border-bottom-color: gainsboro; width: 207px; border-top-style: solid; border-top-color: gainsboro; border-right-style: solid; border-left-style: solid; background-color: whitesmoke; border-right-color: gainsboro; border-bottom-style: solid"
                                                                                            type="textbox" /></td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td style="height: 20px; background-color: gainsboro">&nbsp;
                                                                                    ...
                                                                                    <td>&nbsp;<input id="f_partno" name="f_partno" style="border-left-color: gainsboro; border-bottom-color: gainsboro; width: 128px; border-top-style: solid; border-top-color: gainsboro; border-right-style: solid; border-left-style: solid; background-color: whitesmoke; border-right-color: gainsboro; border-bottom-style: solid"
                                                                                        type="textbox" />
                                                                                        <input id="f_component" name="f_component" style="border-left-color: gainsboro; border-bottom-color: gainsboro; width: 159px; border-top-style: solid; border-top-color: gainsboro; border-right-style: solid; border-left-style: solid; background-color: whitesmoke; border-right-color: gainsboro; border-bottom-style: solid"
                                                                                            type="textbox" />
                                                                                        <input id="f_dwg" name="f_dwg" style="border-left-color: gainsboro; border-bottom-color: gainsboro; width: 159px; border-top-style: solid; border-top-color: gainsboro; border-right-style: solid; border-left-style: solid; background-color: whitesmoke; border-right-color: gainsboro; border-bottom-style: solid"
                                                                                            type="textbox" />&nbsp;
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    ...
                                                                                    <td>&nbsp;<input id="Homemade_code" name="Homemade_code" style="border-left-color: gainsboro; border-bottom-color: gainsboro; width: 95px; border-top-style: solid; border-top-color: gainsboro; border-right-style: solid; border-left-style: solid; background-color: whitesmoke; border-right-color: gainsboro; border-bottom-style: solid"
                                                                                        type="textbox" />
                                                                                        <input id="Homemade_code2" name="Homemade_code2" disabled="disabled" style="border-left-color: gainsboro; border-bottom-color: gainsboro; width: 327px; border-top-style: solid; border-top-color: gainsboro; border-right-style: solid; border-left-style: solid; background-color: whitesmoke; border-right-color: gainsboro; border-bottom-style: solid"
                                                                                            type="textbox" /></td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td style="height: 20px; background-color: gainsboro">&nbsp;
                                                                                                <asp:Label ID="LabCus" runat="server" Font-Bold="True" Font-Size="10pt" Text="客戶料號"></asp:Label></td>
                                                                                    <td>&nbsp;<input id="TextCusSn" name="TextCusSn" style="border-left-color: gainsboro; border-bottom-color: gainsboro; width: 200px; border-top-style: solid; border-top-color: gainsboro; border-right-style: solid; border-left-style: solid; background-color: whitesmoke; border-right-color: gainsboro; border-bottom-style: solid"
                                                                                        type="textbox" />
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    ...
                                                                                    <td style="height: 22px">&nbsp;<input id="TextCusVer" name="TextCusVer" style="border-left-color: gainsboro; border-bottom-color: gainsboro; width: 200px; border-top-style: solid; border-top-color: gainsboro; border-right-style: solid; border-left-style: solid; background-color: whitesmoke; border-right-color: gainsboro; border-bottom-style: solid"
                                                                                        type="textbox" />
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td style="height: 20px; background-color: gainsboro">&nbsp;&nbsp;<br />
                                                                                        &nbsp;<asp:Label ID="Label114" runat="server" Font-Bold="True" Font-Size="10pt" Text="廠牌/廠牌名稱"></asp:Label></td>
                                                                                    <td>&nbsp;<input id="TextFacSn" name="TextFacSn" style="border-left-color: gainsboro; border-bottom-color: gainsboro; width: 95px; border-top-style: solid; border-top-color: gainsboro; border-right-style: solid; border-left-style: solid; background-color: whitesmoke; border-right-color: gainsboro; border-bottom-style: solid"
                                                                                        type="textbox" /><input id="TextFacSn2" name="TextFacSn2" disabled="disabled" style="border-left-color: gainsboro; border-bottom-color: gainsboro; width: 327px; border-top-style: solid; border-top-color: gainsboro; border-right-style: solid; border-left-style: solid; background-color: whitesmoke; border-right-color: gainsboro; border-bottom-style: solid"
                                                                                            type="textbox" /></td>
                                                                                </tr>
                                                                                <tr>
                                                    ...
                                                    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                                        <ContentTemplate>
                                                            <SmoothEnterpriseWebControl:InputButton ID="Button_AddItem" runat="server" BackColor="#C8C8C8"
                                                                ...
                                                                Width="80px">
                                                                <Gradient GradientBegin="136, 136, 136" GradientEnd="White" GradientType="Bottom" />
                                                            </SmoothEnterpriseWebControl:InputButton><asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="3"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:BoundField DataField="cate1" HeaderText="cate1" SortExpression="cate1">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="cate2" HeaderText="cate2" SortExpression="cate2">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="cate3" HeaderText="cate3" SortExpression="cate3">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="cate3_2" HeaderText="cate3_2" SortExpression="cate3_2">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    ...
                                                                    <asp:BoundField DataField="f_component" HeaderText="f_component" SortExpression="f_component">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="f_dwg" HeaderText="f_dwg" SortExpression="f_dwg">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="unit" HeaderText="庫存單位" SortExpression="unit" meta:resourcekey="unit">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="hsf" HeaderText="HSF" SortExpression="hsf">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="source_code" HeaderText="來源碼" SortExpression="source_code" meta:resourcekey="source_code">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="homemade_code" HeaderText="homemade_code" SortExpression="homemade_code">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="homemade_code2" HeaderText="homemade_code2" SortExpression="homemade_code2">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="technology_code" HeaderText="technology_code" SortExpression="technology_code">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="technology_code2" HeaderText="technology_code2" SortExpression="technology_code2">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="iqc" HeaderText="IQC" SortExpression="iqc">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="erp_identical" HeaderText="erp_identical" SortExpression="erp_identical">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="coding_class" HeaderText="coding_class" SortExpression="coding_class">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="Customers_class" HeaderText="Customers_class" SortExpression="Customers_class">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="Customers_class2" HeaderText="Customers_class2" SortExpression="Customers_class2">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="Model_class" HeaderText="Model_class" SortExpression="Model_class">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="Model_class2" HeaderText="Model_class2" SortExpression="Model_class2">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="group_code2" HeaderText="group_code2" SortExpression="group_code2">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    ...
                                                                    <asp:BoundField DataField="A3_2" HeaderText="A3_2" SortExpression="A3_2">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    ...
                                                                    <asp:BoundField DataField="A5" HeaderText="A5" SortExpression="A5">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="A6" HeaderText="A6" SortExpression="A6">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="A6_2" HeaderText="A6_2" SortExpression="A6_2">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="A7" HeaderText="A7" SortExpression="A7">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="A7_2" HeaderText="A7_2" SortExpression="A7_2">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="A8" HeaderText="A8" SortExpression="A8">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="A9" HeaderText="A9" SortExpression="A9">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    ...
                                                                    <asp:BoundField DataField="B5" HeaderText="B5" SortExpression="B5">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    ...
                                                                    <asp:BoundField DataField="E2_2" HeaderText="E2_2" SortExpression="E2_2">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    ...
                                                                    <asp:BoundField DataField="E3_2" HeaderText="E3_2" SortExpression="E3_2">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    ...
                                                                    <asp:BoundField DataField="E5" HeaderText="E5" SortExpression="E5">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    ...
                                                                    <asp:BoundField DataField="F2_2" HeaderText="F2_2" SortExpression="F2_2">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    ...
                                                                    <asp:BoundField DataField="F3_2" HeaderText="F3_2" SortExpression="F3_2">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    ...
                                                                    <asp:BoundField DataField="G2_2" HeaderText="G2_2" SortExpression="G2_2">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    ...
                                                                    <asp:BoundField DataField="G3_2" HeaderText="G3_2" SortExpression="G3_2">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    ...
                                                                    <asp:BoundField DataField="I5" HeaderText="I5" SortExpression="I5">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="I6" HeaderText="I6" SortExpression="I6">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="I7" HeaderText="I7" SortExpression="I7">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="I8" HeaderText="I8" SortExpression="I8">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="J1" HeaderText="J1" SortExpression="J1">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="J2" HeaderText="J2" SortExpression="J2">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="J3" HeaderText="J3" SortExpression="J3">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="J4" HeaderText="J4" SortExpression="J4">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="J5" HeaderText="J5" SortExpression="J5">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="J6" HeaderText="J6" SortExpression="J6">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="K1" HeaderText="K1" SortExpression="K1">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="K2" HeaderText="K2" SortExpression="K2">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="K3" HeaderText="K3" SortExpression="K3">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="K4" HeaderText="K4" SortExpression="K4">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="K5" HeaderText="K5" SortExpression="K5">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="K6" HeaderText="K6" SortExpression="K6">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="K7" HeaderText="K7" SortExpression="K7">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    ...
                                                                    <asp:BoundField DataField="N5" HeaderText="N5" SortExpression="N5">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    ...
                                                                    <asp:BoundField DataField="N8" HeaderText="N8" SortExpression="N8">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    ...
                                                                    <asp:BoundField DataField="O5" HeaderText="O5" SortExpression="O5">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="O6" HeaderText="O6" SortExpression="O6">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    ...
                                                                    <asp:BoundField DataField="R2_2" HeaderText="R2_2" SortExpression="R2_2">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    ...
                                                                    <asp:BoundField DataField="R3_2" HeaderText="R3_2" SortExpression="R3_2">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    ...
                                                                    <asp:BoundField DataField="S2_2" HeaderText="S2_2" SortExpression="S2_2">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    ...
                                                                    <asp:BoundField DataField="S3_2" HeaderText="S3_2" SortExpression="S3_2">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    ...
                                                                    <asp:BoundField DataField="T2_2" HeaderText="T2_2" SortExpression="T2_2">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    ...
                                                                    <asp:BoundField DataField="T3_2" HeaderText="T3_2" SortExpression="T3_2">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    ...
                                                                    <asp:BoundField DataField="U1" HeaderText="U1" SortExpression="U1">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="U2" HeaderText="U2" SortExpression="U2">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="U2_2" HeaderText="U2_2" SortExpression="U2_2">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="U3" HeaderText="U3" SortExpression="U3">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="U4" HeaderText="U4" SortExpression="U4">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="U5" HeaderText="U5" SortExpression="U5">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    ...
                                                                    <asp:BoundField DataField="X5" HeaderText="X5" SortExpression="X5">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="X6" HeaderText="X6" SortExpression="X6">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="X7" HeaderText="X7" SortExpression="X7">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="X8" HeaderText="X8" SortExpression="X8">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="Y1" HeaderText="Y1" SortExpression="Y1">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="Y2" HeaderText="Y2" SortExpression="Y2">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="Y3" HeaderText="Y3" SortExpression="Y3">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="Y4" HeaderText="Y4" SortExpression="Y4">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="Y5" HeaderText="Y5" SortExpression="Y5">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="Y6" HeaderText="Y6" SortExpression="Y6">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="Y7" HeaderText="Y7" SortExpression="Y7">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="Y8" HeaderText="Y8" SortExpression="Y8">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="Y9" HeaderText="Y9" SortExpression="Y9">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="Z1" HeaderText="Z1" SortExpression="Z1">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="Z2" HeaderText="Z2" SortExpression="Z2">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="Z3" HeaderText="Z3" SortExpression="Z3">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="Z4" HeaderText="Z4" SortExpression="Z4">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="Z5" HeaderText="Z5" SortExpression="Z5">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="Z6" HeaderText="Z6" SortExpression="Z6">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="Z7" HeaderText="Z7" SortExpression="Z7">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="Z8" HeaderText="Z8" SortExpression="Z8">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="Z9" HeaderText="Z9" SortExpression="Z9">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="AA1" HeaderText="AA1" SortExpression="AA1">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="AA2" HeaderText="AA2" SortExpression="AA2">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="AA3" HeaderText="AA3" SortExpression="AA3">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="AA3_2" HeaderText="AA3_2" SortExpression="AA3_2">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="AA4" HeaderText="AA4" SortExpression="AA4">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="AA5" HeaderText="AA5" SortExpression="AA5">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="AA6" HeaderText="AA6" SortExpression="AA6">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="AA6_2" HeaderText="AA6_2" SortExpression="AA6_2">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="AA7" HeaderText="AA7" SortExpression="AA7">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="AA7_2" HeaderText="AA7_2" SortExpression="AA7_2">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="AA8" HeaderText="AA8" SortExpression="AA8">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="AA9" HeaderText="AA9" SortExpression="AA9">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="AA10" HeaderText="AA10" SortExpression="AA10">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    ...
                                                                    <asp:BoundField DataField="remark" HeaderText="備註" SortExpression="remark" meta:resourcekey="remarka">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="AB1" HeaderText="AB1" SortExpression="AB1">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="AB2" HeaderText="AB2" SortExpression="AB2">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="AB3" HeaderText="AB3" SortExpression="AB3">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="AB4" HeaderText="AB4" SortExpression="AB4">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="AB5" HeaderText="AB5" SortExpression="AB5">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="AB6" HeaderText="AB6" SortExpression="AB6">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="AB7" HeaderText="AB7" SortExpression="AB7">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="AB8" HeaderText="AB8" SortExpression="AB8">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    ...
                                                                    <asp:BoundField DataField="AC4" HeaderText="AC4" SortExpression="AC4">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="AC5" HeaderText="AC5" SortExpression="AC5">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="AC6" HeaderText="AC6" SortExpression="AC6">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="AC7" HeaderText="AC7" SortExpression="AC7">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>

                                                                    <asp:BoundField DataField="AD1" HeaderText="AD1" SortExpression="AD1">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="AD2" HeaderText="AD2" SortExpression="AD2">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="AD3" HeaderText="AD3" SortExpression="AD3">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="AD4" HeaderText="AD4" SortExpression="AD4">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="AD5" HeaderText="AD5" SortExpression="AD5">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="AD6" HeaderText="AD6" SortExpression="AD6">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="AD7" HeaderText="AD7" SortExpression="AD7">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="AD8" HeaderText="AD8" SortExpression="AD8">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>

                                                                    <asp:BoundField DataField="tc_imi02" HeaderText="tc_imi02" SortExpression="tc_imi02">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="tc_imi021" HeaderText="tc_imi021" SortExpression="tc_imi021">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="tc_imi03" HeaderText="tc_imi03" SortExpression="tc_imi03">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="tc_imi031" HeaderText="tc_imi031" SortExpression="tc_imi031">
                                                                        <HeaderStyle CssClass="hiddencol" />
                                                                        <ItemStyle CssClass="hiddencol" />
                                                                    </asp:BoundField>
                            ...
                            <table style="width: 100%">
                                <tr>
                                    <td colspan="4" style="height: 20px; background-color: slategray; text-align: center">&nbsp;<asp:Image ID="Image31" runat="server" Height="22px" ImageUrl="~/ERP_CXMT310/img/list.png"
                                        Width="23px" />
    ...
    <table border="0" class="Normal">
        <tr>
            <td>
				...
				<SmoothEnterpriseWebControl:InputButton ID="BUTTON_back" meta:resourcekey="BUTTON_backResource1" runat="server" Text="回上頁" Width="80px" BackColor="#C8C8C8" BorderColor="#606060" BorderStyle="Solid" BorderWidth="1px" CssClass="NormalBold" Font-Bold="True" Font-Names="Arial" Font-Size="12px" OnClick="BUTTON_back_Click">
                    <Gradient GradientBegin="136, 136, 136" GradientEnd="White" GradientType="Bottom" />
                </SmoothEnterpriseWebControl:InputButton>
            </td>
        </tr>
