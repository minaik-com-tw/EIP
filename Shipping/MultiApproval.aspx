				...
				<SmoothEnterpriseWebControl:DataList id="DataList1" runat="server" BorderColor="#000000" RowNumber="True" RowAlign="Middle" 
					...
					<Columns>
                        ...
                        <SmoothEnterpriseWebControl:DataColumn ID="DataList1_ERP_Key2" runat="server" DataStyle-BorderStyle="NotSet" DataType="ViewText" HeaderStyle-BorderStyle="NotSet" Caption="出貨單號" DataName="ERP_Key2" Sortable="True" DataStyle-CssClass="" HeaderStyle-CssClass="">
 	 	 	 	 	 	...
 	 	 	 	 	 	<SmoothEnterpriseWebControl:DataColumn ID="DataList1_ETD" DataType="ViewText" Caption="預計開船日" DataName="ETD"   Sortable="True" DataStyle-BorderStyle="NotSet" HeaderStyle-BorderStyle="NotSet" runat="server" ></SmoothEnterpriseWebControl:DataColumn>
 	 	 	 	 	 	<SmoothEnterpriseWebControl:DataColumn ID="DataList1_ATD" DataType="ViewText" Caption="實際開船日" DataName="ATD"   Sortable="True" DataStyle-BorderStyle="NotSet" HeaderStyle-BorderStyle="NotSet" runat="server" ></SmoothEnterpriseWebControl:DataColumn>
 	 	 	 	 	 	<SmoothEnterpriseWebControl:DataColumn ID="DataList1_ETA" DataType="ViewText" Caption="預計到港日" DataName="ETA"   Sortable="True" DataStyle-BorderStyle="NotSet" HeaderStyle-BorderStyle="NotSet" runat="server" ></SmoothEnterpriseWebControl:DataColumn>
 	 	 	 	 	 	<SmoothEnterpriseWebControl:DataColumn ID="DataList1_ATAAS" DataType="ViewText" Caption="實際到港日" DataName="ATAAS"   Sortable="True" DataStyle-BorderStyle="NotSet" HeaderStyle-BorderStyle="NotSet" runat="server" ></SmoothEnterpriseWebControl:DataColumn>
 	 	 	 	 	 	<SmoothEnterpriseWebControl:DataColumn ID="DataList1_ATAC" DataType="ViewText" Caption="實際到貨日(客人)" DataName="ATAC"   Sortable="True" DataStyle-BorderStyle="NotSet" HeaderStyle-BorderStyle="NotSet" runat="server" ></SmoothEnterpriseWebControl:DataColumn>
