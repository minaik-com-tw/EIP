<%@ Page Language="C#" Debug="true" MasterPageFile="~/_site/layout/Template.master" AutoEventWireup="true" CodeFile="ReadFtpXml_Yusen.aspx.cs" Inherits="Shipping_ReadFtpXml_Agi" StylesheetTheme="Default" Culture="Auto" UICulture="Auto" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <SmoothEnterpriseWebControlEnterprise:Descriptor ID="ContentDescriptor" runat="server" Details=" "
		Caption="Åª¨úXML" Width="100%" CssClass="Normal" Gradient="None" Height="40%" PaddingSpace="5px">
