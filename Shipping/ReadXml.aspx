<%@ Page Language="C#" Debug="true" MasterPageFile="~/_site/layout/Template.master" AutoEventWireup="true" CodeFile="ReadXml.aspx.cs" Inherits="Shipping_ReadXml" StylesheetTheme="Default" Culture="Auto" UICulture="Auto" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <SmoothEnterpriseWebControlEnterprise:Descriptor ID="ContentDescriptor" runat="server" Details=" "
		Caption="讀取XML" Width="100%" CssClass="Normal" Gradient="None" Height="40%" PaddingSpace="5px">
