...
namespace IPQC_Ra
{
    public partial class IPQC_RaEdit : IPQC_RaBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            PopupUser1.Text = "2CA1C1C5-D0C2-405C-91D0-F45DDF9AB462";//"02CA2090-C5D0-455B-A671-5D7168D08559"; carol
        ...
        private void setDisplay()
        {
            ...
            Utility.setEnable(false, PopupUser1);
            ...
            switch (Status)
            {
                ...
                default:
                    ...
                    Utility.setEnable(true, PopupUser1);
        ...
        protected void Btn_RemindReviewer_Click(object sender, SmoothEnterprise.Flowwork.UI.WebControl.FlowButtonEventArgs e)
        {
            string rowid = Request.QueryString["rowid"];
            head.GetInfo(rowid);
            SendMail(rowid, PopupUser1.Text, lab_Ra_NO.Text, head.send_dt, "催審");
        ...
        protected void Btn_Stop_Click(object sender, SmoothEnterprise.Flowwork.UI.WebControl.FlowButtonEventArgs e)
        {
            ...
            string rowid = Request.QueryString["rowid"];
            head.GetInfo(rowid);
            SendMail(rowid, PopupUser1.Text, lab_Ra_NO.Text, head.send_dt, "中止");
