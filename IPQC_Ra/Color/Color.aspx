<%@ Page Title="IPQC Informaction List" Language="C#" MasterPageFile="~/_site/layout/Template.master" AutoEventWireup="true" CodeFile="Color.aspx.cs" Inherits="Color.Color" StylesheetTheme="Default" Culture="Auto" UICulture="Auto" Debug="true" %>
        ...
        <div class="div_table">
            <div class="div_tr">
                ...
                <div class="div_td" style="width: 200px">
                    <asp:Button ID="Btn_Query" runat="server"  Text="Query" CssClass="smooth_btn ML" ML_Tag="query" />
            ...
            <td> 
                <SmoothEnterpriseWebControl:DataList ID="DataList1" runat="server" BorderColor="#000000" RowNumber="True" RowAlign="Middle"
                    ...
                    <Columns>
                        ...
                        <SmoothEnterpriseWebControl:DataColumn ID="en" DataType="ViewText" Caption="name" DataName="en"></SmoothEnterpriseWebControl:DataColumn>
                        <SmoothEnterpriseWebControl:DataColumn ID="up" DataType="ViewText" Caption="上限" DataName="up"></SmoothEnterpriseWebControl:DataColumn>
                        <SmoothEnterpriseWebControl:DataColumn ID="down" DataType="ViewText" Caption="下限" DataName="down"></SmoothEnterpriseWebControl:DataColumn> 
                    </Columns>
