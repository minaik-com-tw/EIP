<%@ Page Title="" Language="C#" MasterPageFile="~/_site/layout/Template.master" AutoEventWireup="true" CodeFile="OptionEdit.aspx.cs" Inherits="Option.OptionEdit" StylesheetTheme="Default" Culture="Auto"
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="master" class="div_table" style="text-align: center; width: 60%; padding: 2px 2px; border: 1px outset #446d4e">
        <div class="div_table">
            ...
            <div class="div_tr">
                <div class="div_td th">顯示</div>
                <div class="div_td">
                    <asp:RadioButtonList ID="rbt_display" runat="server" RepeatDirection="Horizontal">
                        <asp:ListItem Value="1">是</asp:ListItem>
                        <asp:ListItem Value="0">否</asp:ListItem>
                    </asp:RadioButtonList>
