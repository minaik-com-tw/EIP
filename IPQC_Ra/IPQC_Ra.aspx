<%@ Page Title="IPQC Informaction List" Language="C#" MasterPageFile="~/_site/layout/ie7.master" AutoEventWireup="true" CodeFile="IPQC_Ra.aspx.cs" Inherits="IPQC_Ra.IPQC_Ra" StylesheetTheme="Default" Culture="Auto" UICulture="Auto" Debug="true" %>
    ...
    <div style="border-bottom: 2px solid #1a245f; padding: 5px 5px; margin: 5px 5px;">
        <div class="table">
            ...
            <div>
                ...
                <div class="td"></div>
                <div class="td">
                    <asp:Button ID="btn_qry" OnClick="Btn_Query_Click" runat="server" ML_Tag="query" Text="Query" CssClass="sysBtn" Width="60" />
                    <asp:Button ID="btn_add" OnClick="Btn_Add_Click" runat="server" Text="Add" ML_Tag="add" CssClass="sysBtn" Width="60" />
                </div>
            </div>
            ...
            <td>
                <SmoothEnterpriseWebControl:DataList ID="DataList1" runat="server" BorderColor="#000000" RowNumber="True" RowAlign="Middle"
                    ...
                    <Columns>
                        ...
                        <SmoothEnterpriseWebControl:DataColumn ID="sample" meta:resourcekey="sample" DataType="ViewText" Caption="Sample Quantity" DataName="Sample" DataAlign="Center" ></SmoothEnterpriseWebControl:DataColumn>
                        ...
                        <SmoothEnterpriseWebControl:DataColumn ID="status2"  DataAlign="Center" meta:resourcekey="status2" Caption="檢驗狀態" DataType="UserDefined"></SmoothEnterpriseWebControl:DataColumn>
                        <SmoothEnterpriseWebControl:DataColumn ID="result" meta:resourcekey="result" DataType="UserDefined" Caption="Inspect Pass" DataName="result"></SmoothEnterpriseWebControl:DataColumn>
                    </Columns>
