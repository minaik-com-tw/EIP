    ...
    public partial class Mail : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                cbo_group.SelectedValue = "Mail";
                cbo_group.Items.Add(new ListItem("Select", ""));
        ...
        private void GVBind(int page)
        {
            using (SqlDataSource Conn = new SqlDataSource())
            {
                ...
                sb.Append(" select m.id,d.dept_nm ,u.name 'UserName',m.mail 'email',m.logonid, u_group from EIPE.DBO.IPQC_Ra_MAIL m ");
        ...
        protected void Btn_Del_Click(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(Del))
            {
                ...
                using (SmoothEnterprise.Database.DataSet rs = new SmoothEnterprise.Database.DataSet(SmoothEnterprise.Database.DataSetType.OpenUpdate))
                {
                    ...
                    {
                        rs.Open("DELETE EIPE.DBO.IPQC_Ra_MAIL WHERE id = '" + Item + "'");
