...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="table">
        ...
        <div class="tr">
            <div class="th" style="background-color: darkgoldenrod">群組:</div>
            <div class="td">
                <asp:DropDownList ID="cbo_group" runat="server" OnSelectedIndexChanged="Dept_SelectedIndexChanged" AutoPostBack="true" />
            </div>
        </div>
        <div class="tr">
            <div class="th" style="background-color: darkgoldenrod">發行報表日:</div>
            <div class="td">
        ...
        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False" CellPadding="0" GridLines="Both"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="">
                    ...
                    <HeaderTemplate>
                        <asp:Button ID="Btn_Add" Text="新增" runat="server" OnClick="Btn_Add_Click" Width="50px" Font-Size="9" />
