    ...
    public partial class IPQC_RaResult : MABase
    {
        ...
        public void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                _startDt = DateTime.Now.AddDays(-14).ToShortDateString();
        ...
        public void Query()
        {
            ...
            sb.Append("  SELECT TOP (300) h.rowid ,l.rowid 'lab_id',h.ra_no,h.equipment,h.tooling_no,h.manufacture_dt,h.received_dt, m.en 'material',sample,h.data_nuit, l.result ");
