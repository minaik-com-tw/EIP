<%@ Page Language="C#" MasterPageFile="~/_site/layout/Template.master" AutoEventWireup="true" CodeFile="ChangePassword.aspx.cs" Inherits="SmoothEnterprise.Web.Application.Security.ChangePassword" StylesheetTheme="Default" Culture="Auto" UICulture="Auto"%>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">    
	...
	<table Class="Normal" border="0" id="TABLE1" runat="server">
        ...
        <tr class="NormalBold">
            <td>
                <SmoothEnterpriseWebControl:inputtext id="AccTxt" runat="server" CssClass="Normal"
					BackColor="#F0F0F0" MaxLength="50" Required="False" ButtonClick="True" ButtonIconUrl="" DateSeparator="Slash" DateType="YYYYMMDD" ErrorMessage="" FocusColor="" FormatType="None" HiddenMode="False" HTMLMode="Advance" IsValid="True" meta:resourcekey="FIELD_pwd_confirmResource1" OnClickMore="" Personalize="False" ReadOnly="True">
                    <ErrorStyle BorderStyle="NotSet" CssClass="" />
