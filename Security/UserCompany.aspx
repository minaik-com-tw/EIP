	    ...
	    <tr class="NormalBold">
 	 	 	...
 	 	 	<td>
                   <asp:Label ID="LABEL_logonid" runat="server" meta:resourcekey="LABEL_logonidResource1"
                       Text="帳號"></asp:Label></td>
 	 	 	<td><asp:Label ID="LABEL_name" runat="server" CssClass="NormalBold" Text="名稱"></asp:Label></td>
 	 	 	<td><asp:Label ID="LABEL_sid" runat="server" CssClass="NormalBold" Text="群組"></asp:Label></td>
 	 	 	<td><asp:Label ID="LABEL_gid" runat="server" CssClass="NormalBold" Text="Gid" Visible="False"></asp:Label></td>
 	 	 	<td><asp:Label ID="LABEL_ustatus" runat="server" CssClass="NormalBold" Text="帳號狀態"></asp:Label></td>
	        <td></td>
	    </tr>
	    <tr>
			...
			<td>
				<SmoothEnterpriseWebControl:DATALIST id="DataList1" runat="server" Font-Names="Arial" Font-Size="12px" BorderColor="Black"
					...
					<Columns>
						...
						<SmoothEnterpriseWebControl:DataColumn Visible="False" DataType="ViewText" Caption="廠別" DataName="comid" Sortable="True"
