<%@ page language="C#" masterpagefile="~/_site/layout/Template.master" autoeventwireup="true" CodeFile="UserCompanyAdd.aspx.cs" inherits="SPC.UserCompanyAdd" StylesheetTheme="Default" Culture="Auto" UICulture="Auto"%>
                                    ...
                                    <table Class="Normal" border="0">
                                        <tr Class="NormalBold">
                                            <td style="height: 16px">
                                                &nbsp;<asp:Label ID="Label1" runat="server" meta:resourcekey="LABEL_gidResource1" Text="廠別"></asp:Label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <asp:DropDownList ID="DdDept" runat="server" Width="154px" AutoPostBack="True" OnSelectedIndexChanged="DdDept_SelectedIndexChanged">
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <SmoothEnterpriseWebControlEnterprise:SelectGroup ID="FIELD_gid" runat="server" BackColor="#F0F0F0"
                                                    ...
                                                    Mode="Single" RootId="" TextBoxStyle="ThreeDStyle" Value="" EnabledHTC="False" Visible="False">
                                                    <Gradient GradientType="Top" GradientBegin="" GradientEnd=""></Gradient>
                                                    <ErrorStyle BorderStyle="NotSet" CssClass="" />
                                        ...
                                        <tr>
                                            <td>
                                                <asp:Label ID="Label2" runat="server" meta:resourcekey="LABEL_gidResource1" Text="員工編號"></asp:Label></td>
                                        </tr>
                                        <tr>
                                            <td>
