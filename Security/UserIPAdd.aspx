<%@ page language="C#" masterpagefile="~/_site/layout/Template.master" autoeventwireup="true" inherits="SmoothEnterprise.Web.Application.Security.UserIPAdd, App_Web_useripadd.aspx.cdcab7d2" title="Untitled Page" theme="Default" culture="auto" uiculture="auto" meta:resourcekey="PageResource1" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">    
	...
	<table Class="Normal" border="0">
		...
		<tr>
			<td>
				<SmoothEnterpriseWebControlEnterprise:PopupUser id="FIELD_uid" runat="server" BackColor="#F0F0F0" Width="100px" CssClass="Normal"
					Required="True" FormatType="InputCombo" OnClickMore="OpenShowModalDialog();"
					ErrorMessage="請輸入「使用者」!!" ValueField="id" FormatValueField="logonid" AuthType="" ButtonClick="True" ButtonIconUrl="" DateSeparator="Slash" DateType="YYYYMMDD" DisplayField="name" DisplayFieldHidden="False" FocusColor="" HiddenMode="False" HTMLMode="Advance" IsValid="True" meta:resourcekey="FIELD_uidResource1" Personalize="False">
		...
		<tr>
			<td><SmoothEnterpriseWebControl:inputtext id="FIELD_bgnip1" runat="server" BackColor="#F0F0F0"
					CssClass="Normal" Required="True" FormatType="Number" Size="1" MaxLength="3" Value="000" ButtonClick="True" ButtonIconUrl="" DateSeparator="Slash" DateType="YYYYMMDD" ErrorMessage="" FocusColor="" HiddenMode="False" HTMLMode="Advance" IsValid="True" meta:resourcekey="FIELD_bgnip1Resource1" OnClickMore="" Personalize="False"><Gradient GradientType="Top" GradientBegin="" GradientEnd=""></Gradient>
                <ErrorStyle BorderStyle="NotSet" CssClass="" />
					...
					<SmoothEnterpriseWebControl:inputtext id="FIELD_bgnip4" runat="server" BackColor="#F0F0F0"
						CssClass="Normal" Required="True" FormatType="Number" Size="1" MaxLength="3" Value="001" ButtonClick="True" ButtonIconUrl="" DateSeparator="Slash" DateType="YYYYMMDD" ErrorMessage="" FocusColor="" HiddenMode="False" HTMLMode="Advance" IsValid="True" meta:resourcekey="FIELD_bgnip4Resource1" OnClickMore="" Personalize="False"><Gradient GradientType="Top" GradientBegin="" GradientEnd=""></Gradient>
                        <ErrorStyle BorderStyle="NotSet" CssClass="" />
			...
			<td><SmoothEnterpriseWebControl:inputtext id="FIELD_endip1" runat="server" BackColor="#F0F0F0"
                ...
                <ErrorStyle BorderStyle="NotSet" CssClass="" />
					...
					<SmoothEnterpriseWebControl:inputtext id="FIELD_endip4" runat="server" BackColor="#F0F0F0"
						CssClass="Normal" Required="True" FormatType="Number" Size="1" MaxLength="3" Value="255" ButtonClick="True" ButtonIconUrl="" DateSeparator="Slash" DateType="YYYYMMDD" ErrorMessage="" FocusColor="" HiddenMode="False" HTMLMode="Advance" IsValid="True" meta:resourcekey="FIELD_endip4Resource1" OnClickMore="" Personalize="False"><Gradient GradientType="Top" GradientBegin="" GradientEnd=""></Gradient>
                        <ErrorStyle BorderStyle="NotSet" CssClass="" />
                    </SmoothEnterpriseWebControl:inputtext></FONT></td>
		</tr>
		<tr Class="NormalBold">
