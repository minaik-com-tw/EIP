<%@ page language="C#" masterpagefile="~/_site/layout/Template.master" autoeventwireup="true" CodeFile="UserCompanyS.aspx.cs" inherits="spc.UserCompany"  title="Untitled Page" theme="Default" culture="auto" uiculture="auto" meta:resourcekey="PageResource1" %>
...
<Gradient GradientType="Top" GradientBegin="" GradientEnd=""></Gradient>
			...
			<TD><SmoothEnterpriseWebControl:inputbutton id="BUTTON_query" runat="server" Font-Names="Arial" Font-Size="12px" BackColor="#C8C8C8"
			...
			<td><SmoothEnterpriseWebControl:inputbutton id="BUTTON_add" runat="server" Font-Names="Arial" Font-Size="12px" BackColor="#C8C8C8"
					BorderWidth="1px" BorderStyle="Solid" BorderColor="#606060" CssClass="NormalBold" Gradient-GradientType="Bottom"
