		...
		<tr>
			<td valign="top">
				<table>
 	 	 	 	 	...
 	 	 	 	 	<tr><td><asp:Label ID="LABEL_PNAME" runat="server" CssClass="NormalBold" Text="管理者"></asp:Label></td></tr><tr><td>
 	 	 	 	 	...
 	 	 	 	 	<tr><td>
                             <asp:Label ID="Label1" runat="server" CssClass="NormalBold" Text="公司別"></asp:Label></td></tr><tr><td>
