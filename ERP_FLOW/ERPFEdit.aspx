<%@ Page Language="C#" MasterPageFile="~/_site/layout/Template.master" AutoEventWireup="true" CodeFile="ERPFEdit.aspx.cs" Inherits="ERP_FLOW.ERPFEdit" StylesheetTheme="Default" Culture="Auto" UICulture="Auto"%>
		...
		<tr>
			<td valign="top">
				<table style="width: 497px">
 	 	 	 	 	...
 	 	 	 	 	<tr><td style="width: 136px"><asp:Label ID="LABEL_NO" runat="server" CssClass="NormalBold" Text="部門代號二/分組"></asp:Label></td></tr><tr><td style="width: 136px"><SmoothEnterpriseWebControl:InputText id="FIELD_NO" runat="server" BackColor="#F0F0F0" CssClass="Normal" ErrorMessage="Please Input「部門代號二」!!" MaxLength="10" Width="215px"  ><Gradient GradientBegin="" GradientEnd="" GradientType="Top" />
                             <ErrorStyle BorderStyle="NotSet" CssClass="" />
                         </SmoothEnterpriseWebControl:InputText>
                             <asp:DropDownList ID="DropDownList1" runat="server" Width="114px" Visible="False">
                             </asp:DropDownList></td></tr>
 	 	 	 	 	<tr><td style="width: 136px"><asp:Label ID="LABEL_PNAME" runat="server" CssClass="NormalBold" Text="管理者姓名" Visible="False"></asp:Label></td></tr><tr><td style="width: 136px"><SmoothEnterpriseWebControl:InputText id="FIELD_PNAME" runat="server" BackColor="#F0F0F0" CssClass="Normal" ErrorMessage="Please Input「管理者姓名」!!" MaxLength="20" Visible="False"  ><Gradient GradientBegin="" GradientEnd="" GradientType="Top" />
                             <ErrorStyle BorderStyle="NotSet" CssClass="" />
                         </SmoothEnterpriseWebControl:InputText></td></tr>
 	 	 	 	 	<tr><td style="width: 136px"><asp:Label ID="LABEL_PID" runat="server" CssClass="NormalBold" Text="管理者ID"></asp:Label></td></tr><tr><td style="width: 136px"><SmoothEnterpriseWebControl:InputText id="FIELD_PID" runat="server" BackColor="#F0F0F0" CssClass="Normal" ErrorMessage="Please Input「管理者ID」!!" MaxLength="0" Width="43px" Visible="False"  ><Gradient GradientBegin="" GradientEnd="" GradientType="Top" />
