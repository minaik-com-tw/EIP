                        ...
                        <td style="height: 20px; background-color: white">
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td colspan="7" id="uploadfiles"><asp:CheckBoxList ID="CheckBoxFile1" runat="server" Font-Size="X-Small" meta:resourcekey="CheckBoxFile1Resource1">
...
<ReplyTemplate>
請輸入簽核意見：<BR /><SmoothEnterpriseWebControl:InputText id="Input_Comment" runat="server" meta:resourcekey="Input_CommentResource1" Width="500px" BackColor="#F0F0F0" CssClass="Normal" OnClickMore="" ButtonIconUrl="" DateSeparator="Slash" DateType="YYYYMMDD" FormatType="None" ButtonClick="True" ErrorMessage="" FocusColor="" HiddenMode="False" HTMLMode="Advance" IsValid="True" Personalize="False" Required="False">
                            <ErrorStyle BorderStyle="NotSet" />
                            <Gradient GradientBegin="" GradientEnd="" GradientType="Top" />
                        </SmoothEnterpriseWebControl:InputText> <SmoothEnterpriseWebControl:InputText id="InputText3" runat="server" meta:resourcekey="InputText3Resource1" BackColor="#F0F0F0" CssClass="Normal" OnClickMore="" ButtonIconUrl="" DateSeparator="Slash" DateType="YYYYMMDD" FormatType="None" ButtonClick="True" ErrorMessage="" FocusColor="" HiddenMode="False" HTMLMode="Advance" IsValid="True" Personalize="False" Required="False" Visible="False">
                            <ErrorStyle BorderStyle="NotSet" />
                            <Gradient GradientBegin="" GradientEnd="" GradientType="Top" />
                        </SmoothEnterpriseWebControl:InputText> <asp:Button id="BUTTON_FlowFeedback" onclick="BUTTON_FlowFeedback_Click" runat="server" Width="80px" CssClass="NormalBold" Text="送出" meta:resourcekey="BUTTON_FlowFeedbackResource1"></asp:Button>
</ReplyTemplate>
                ...
                <SmoothEnterpriseWebControlFlowwork:FlowFeedbackViewer ID="FlowFeedbackViewer1" runat="server"
                    ...
                    Font-Size="11px" OnOnLoadHistory="FlowFeedbackViewer1_OnLoadHistory" meta:resourcekey="FlowFeedbackViewer1Resource1" RequestURL=""><Columns>
